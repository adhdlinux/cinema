...
public enum CoroutineStart {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        public static final /* synthetic */ int[] f40622a = null;
    ...
    public final <R, T> void b(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r2, Continuation<? super T> continuation) {
        int i2 = WhenMappings.f40622a[ordinal()];
        if (i2 == 1) {
            CancellableKt.d(function2, r2, continuation, (Function1) null, 4, (Object) null);
        } else if (i2 == 2) {
