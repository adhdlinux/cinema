...
public class ThreadSafeHeap<T extends ThreadSafeHeapNode & Comparable<? super T>> {
    ...
    private static final AtomicIntegerFieldUpdater f40780b = AtomicIntegerFieldUpdater.newUpdater(ThreadSafeHeap.class, "_size");
