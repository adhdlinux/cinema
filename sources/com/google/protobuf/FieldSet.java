...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap, boolean z2) {
            for (int i2 = 0; i2 < smallSortedMap.getNumArrayEntries(); i2++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(i2), z2);
            }
        ...
        public Object getRepeatedField(T t2, int i2) {
            ...
            return replaceBuilder(getRepeatedFieldAllowBuilders(t2, i2), true);
        }
        ...
        public boolean hasField(T t2) {
            ...
            } else if (this.fields.get(t2) != null) {
                return true;
            } else {
                return false;
            }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z2) {
        ...
        for (int i2 = 0; i2 < smallSortedMap.getNumArrayEntries(); i2++) {
            cloneFieldEntry(newFieldMap, smallSortedMap.getArrayEntryAt(i2), z2);
        }
    ...
    static int computeElementSize(WireFormat.FieldType fieldType, int i2, Object obj) {
    ...
    public static int computeFieldSize(FieldDescriptorLite<?> fieldDescriptorLite, Object obj) {
        ...
        if (fieldDescriptorLite.isPacked()) {
            for (Object computeElementSizeNoTag : (List) obj) {
                i2 += computeElementSizeNoTag(liteType, computeElementSizeNoTag);
            }
        ...
        for (Object computeElementSize : (List) obj) {
            i2 += computeElementSize(liteType, number, computeElementSize);
        }
        return i2;
    }
    ...
    static int getWireFormatForFieldType(WireFormat.FieldType fieldType, boolean z2) {
        if (z2) {
            return 2;
        }
    ...
    static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i2, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
    ...
    public int getSerializedSize() {
        ...
        for (Map.Entry next : this.fields.getOverflowEntries()) {
            i2 += computeFieldSize((FieldDescriptorLite) next.getKey(), next.getValue());
        }
        return i2;
    }
