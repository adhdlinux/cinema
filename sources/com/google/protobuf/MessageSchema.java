...
final class MessageSchema<T> implements Schema<T> {
    ...
    private MessageSchema(int[] iArr, Object[] objArr, int i2, int i3, MessageLite messageLite, boolean z2, boolean z3, int[] iArr2, int i4, int i5, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        boolean z4;
        this.buffer = iArr;
        this.objects = objArr;
    ...
    private <UT, UB> UB filterMapUnknownEnumValues(Object obj, int i2, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema2, Object obj2) {
        ...
        return filterUnknownEnumMap(i2, numberAt, this.mapFieldSchema.forMutableMapData(object), enumFieldVerifier, ub, unknownFieldSchema2, obj2);
    }

    private <K, V, UT, UB> UB filterUnknownEnumMap(int i2, int i3, Map<K, V> map, Internal.EnumVerifier enumVerifier, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema2, Object obj) {
        ...
        while (it2.hasNext()) {
            ...
            if (!enumVerifier.isInRange(((Integer) next.getValue()).intValue())) {
                ...
                try {
                    ...
                    unknownFieldSchema2.addLengthDelimited(ub, i3, newCodedBuilder.build());
                    it2.remove();
    ...
    private boolean isMapInitialized(T t2, int i2, int i3) {
        Map<?, ?> forMapData = this.mapFieldSchema.forMapData(UnsafeUtil.getObject((Object) t2, offset(i2)));
    ...
    private boolean isOneofCaseEqual(T t2, T t3, int i2) {
        long presenceMaskAndOffsetAt = (long) (presenceMaskAndOffsetAt(i2) & 1048575);
        if (UnsafeUtil.getInt((Object) t2, presenceMaskAndOffsetAt) == UnsafeUtil.getInt((Object) t3, presenceMaskAndOffsetAt)) {
            return true;
        }
        return false;
    }
    ...
    private boolean isOneofPresent(T t2, int i2, int i3) {
        if (UnsafeUtil.getInt((Object) t2, (long) (presenceMaskAndOffsetAt(i3) & 1048575)) == i2) {
            return true;
        }
        return false;
    }
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo structuralMessageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        if (fields.length == 0) {
            ...
            i3 = fields[0].getFieldNumber();
            i2 = fields[fields.length - 1].getFieldNumber();
        }
        ...
        while (i7 < fields.length) {
            ...
            storeFieldData(fieldInfo2, iArr2, i8, objArr);
            if (i9 < checkInitialized.length && checkInitialized[i9] == fieldNumber) {
        ...
        return new MessageSchema(iArr2, objArr, i3, i2, structuralMessageInfo.getDefaultInstance(), z2, true, iArr4, checkInitialized.length, checkInitialized.length + iArr.length, newInstanceSchema2, listFieldSchema2, unknownFieldSchema2, extensionSchema2, mapFieldSchema2);
    }
    ...
    private int parseOneofField(T t2, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j2, int i9, ArrayDecoders.Registers registers) throws IOException {
        ...
        Unsafe unsafe = UNSAFE;
        long j4 = (long) (this.buffer[i14 + 2] & 1048575);
        switch (i8) {
            case 51:
                if (i13 == 1) {
                    unsafe.putObject(t3, j3, Double.valueOf(ArrayDecoders.decodeDouble(bArr, i2)));
                    int i15 = i10 + 8;
                    unsafe.putInt(t3, j4, i12);
                    return i15;
                }
                break;
            case 52:
                if (i13 == 5) {
                    unsafe.putObject(t3, j3, Float.valueOf(ArrayDecoders.decodeFloat(bArr, i2)));
                    int i16 = i10 + 4;
                    unsafe.putInt(t3, j4, i12);
                    return i16;
                }
            ...
            case 54:
                if (i13 == 0) {
                    int decodeVarint64 = ArrayDecoders.decodeVarint64(bArr2, i10, registers2);
                    unsafe.putObject(t3, j3, Long.valueOf(registers2.long1));
                    unsafe.putInt(t3, j4, i12);
            ...
            case 62:
                if (i13 == 0) {
                    ...
                    unsafe.putObject(t3, j3, Integer.valueOf(registers2.int1));
                    unsafe.putInt(t3, j4, i12);
            ...
            case 65:
                if (i13 == 1) {
                    unsafe.putObject(t3, j3, Long.valueOf(ArrayDecoders.decodeFixed64(bArr, i2)));
                    int i17 = i10 + 8;
                    unsafe.putInt(t3, j4, i12);
                    return i17;
                }
            ...
            case 64:
                if (i13 == 5) {
                    unsafe.putObject(t3, j3, Integer.valueOf(ArrayDecoders.decodeFixed32(bArr, i2)));
                    int i18 = i10 + 4;
                    unsafe.putInt(t3, j4, i12);
                    return i18;
                }
            ...
            case 58:
                if (i13 == 0) {
                    int decodeVarint642 = ArrayDecoders.decodeVarint64(bArr2, i10, registers2);
                    unsafe.putObject(t3, j3, Boolean.valueOf(registers2.long1 != 0));
                    unsafe.putInt(t3, j4, i12);
            ...
            case 59:
                if (i13 == 2) {
                    ...
                    } else if ((i7 & ENFORCE_UTF8_MASK) == 0 || Utf8.isValidUtf8(bArr2, decodeVarint322, decodeVarint322 + i19)) {
                        unsafe.putObject(t3, j3, new String(bArr2, decodeVarint322, i19, Internal.UTF_8));
                        decodeVarint322 += i19;
                    } else {
            ...
            case 60:
                if (i13 == 2) {
                    Object mutableOneofMessageFieldForMerge = mutableOneofMessageFieldForMerge(t3, i12, i14);
                    int mergeMessageField = ArrayDecoders.mergeMessageField(mutableOneofMessageFieldForMerge, getMessageFieldSchema(i14), bArr, i2, i3, registers);
                    storeOneofMessageField(t3, i12, i14, mutableOneofMessageFieldForMerge);
                    return mergeMessageField;
                }
                break;
            case 61:
                if (i13 == 2) {
                    int decodeBytes = ArrayDecoders.decodeBytes(bArr2, i10, registers2);
                    unsafe.putObject(t3, j3, registers2.object1);
                    unsafe.putInt(t3, j4, i12);
                    return decodeBytes;
                }
                break;
            case 63:
                if (i13 == 0) {
                    int decodeVarint323 = ArrayDecoders.decodeVarint32(bArr2, i10, registers2);
                    ...
                    if (enumFieldVerifier == null || enumFieldVerifier.isInRange(i20)) {
                        unsafe.putObject(t3, j3, Integer.valueOf(i20));
                        unsafe.putInt(t3, j4, i12);
                    } else {
                        getMutableUnknownFields(t2).storeField(i11, Long.valueOf((long) i20));
                    }
            ...
            case 66:
                if (i13 == 0) {
                    int decodeVarint324 = ArrayDecoders.decodeVarint32(bArr2, i10, registers2);
                    unsafe.putObject(t3, j3, Integer.valueOf(CodedInputStream.decodeZigZag32(registers2.int1)));
                    unsafe.putInt(t3, j4, i12);
            ...
            case 67:
                if (i13 == 0) {
                    int decodeVarint643 = ArrayDecoders.decodeVarint64(bArr2, i10, registers2);
                    unsafe.putObject(t3, j3, Long.valueOf(CodedInputStream.decodeZigZag64(registers2.long1)));
                    unsafe.putInt(t3, j4, i12);
            ...
            case 68:
                if (i13 == 3) {
                    Object mutableOneofMessageFieldForMerge2 = mutableOneofMessageFieldForMerge(t3, i12, i14);
                    int mergeGroupField = ArrayDecoders.mergeGroupField(mutableOneofMessageFieldForMerge2, getMessageFieldSchema(i14), bArr, i2, i3, (i11 & -8) | 4, registers);
                    storeOneofMessageField(t3, i12, i14, mutableOneofMessageFieldForMerge2);
    ...
    private int parseRepeatedField(T t2, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, long j2, int i8, long j3, ArrayDecoders.Registers registers) throws IOException {
        ...
        switch (i8) {
            ...
            case 35:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedDoubleList(bArr, i10, protobufList, registers2);
                }
                if (i11 == 1) {
            ...
            case 36:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedFloatList(bArr, i10, protobufList, registers2);
                }
                if (i11 == 5) {
            ...
            case 38:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedVarint64List(bArr, i10, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 43:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedVarint32List(bArr, i10, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 46:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedFixed64List(bArr, i10, protobufList, registers2);
                }
                if (i11 == 1) {
            ...
            case 45:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedFixed32List(bArr, i10, protobufList, registers2);
                }
                if (i11 == 5) {
            ...
            case 42:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedBoolList(bArr, i10, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 26:
                if (i11 == 2) {
                    if ((j2 & 536870912) == 0) {
                        return ArrayDecoders.decodeStringList(i4, bArr, i2, i3, protobufList, registers);
                    }
                    return ArrayDecoders.decodeStringListRequireUtf8(i4, bArr, i2, i3, protobufList, registers);
                }
                break;
            case 27:
                if (i11 == 2) {
                    return ArrayDecoders.decodeMessageList(getMessageFieldSchema(i12), i4, bArr, i2, i3, protobufList, registers);
                }
                break;
            case 28:
                if (i11 == 2) {
            ...
            case 44:
                if (i11 == 2) {
                    i9 = ArrayDecoders.decodePackedVarint32List(bArr, i10, protobufList, registers2);
                } else if (i11 == 0) {
                    i9 = ArrayDecoders.decodeVarint32List(i4, bArr, i2, i3, protobufList, registers);
                }
                SchemaUtil.filterUnknownEnumList((Object) t2, i5, (List<Integer>) protobufList, getEnumFieldVerifier(i12), null, this.unknownFieldSchema);
                return i9;
            case 33:
            case 47:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedSInt32List(bArr, i10, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 48:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedSInt64List(bArr, i10, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 49:
                if (i11 == 3) {
                    return ArrayDecoders.decodeGroupList(getMessageFieldSchema(i12), i4, bArr, i2, i3, protobufList, registers);
                }
                break;
        }
        return i10;
    ...
    private void readString(Object obj, int i2, Reader reader) throws IOException {
        if (isEnforceUtf8(i2)) {
            UnsafeUtil.putObject(obj, offset(i2), (Object) reader.readStringRequireUtf8());
        } else if (this.lite) {
            UnsafeUtil.putObject(obj, offset(i2), (Object) reader.readString());
        } else {
            UnsafeUtil.putObject(obj, offset(i2), (Object) reader.readBytes());
        }
    }
    ...
    private void setOneofPresent(T t2, int i2, int i3) {
        UnsafeUtil.putInt((Object) t2, (long) (presenceMaskAndOffsetAt(i3) & 1048575), i2);
    }
    ...
    public final boolean isInitialized(T t2) {
        ...
        while (i6 < this.checkInitializedCount) {
            ...
            if (isRequired(typeAndOffsetAt) && !isFieldPresent(t2, i7, i3, i2, i10)) {
                return false;
            }
            ...
            if (type != 9 && type != 17) {
                if (type != 27) {
                    if (type == 60 || type == 68) {
                        if (isOneofPresent(t3, numberAt, i7) && !isInitialized(t3, typeAndOffsetAt, getMessageFieldSchema(i7))) {
                            return false;
                        }
                    } else if (type != 49) {
                        if (type == 50 && !isMapInitialized(t3, typeAndOffsetAt, i7)) {
                            return false;
                        }
                    }
                }
                if (!isListInitialized(t3, typeAndOffsetAt, i7)) {
                    return false;
                }
            } else if (isFieldPresent(t2, i7, i3, i2, i10) && !isInitialized(t3, typeAndOffsetAt, getMessageFieldSchema(i7))) {
                return false;
            }
            i6++;
            i4 = i3;
    ...
    public void makeImmutable(T t2) {
        if (isMutable(t2)) {
            ...
            for (int i2 = 0; i2 < length; i2 += 3) {
                ...
                if (isFieldPresent(t2, i2)) {
                    getMessageFieldSchema(i2).makeImmutable(UNSAFE.getObject(t2, offset));
                }
            }
    ...
    private boolean isFieldPresent(T t2, int i2) {
        ...
        if (j2 == 1048575) {
            ...
            if ((UnsafeUtil.getInt((Object) t2, j2) & (1 << (presenceMaskAndOffsetAt >>> 20))) != 0) {
                return true;
            }
            return false;
        }
    ...
    private boolean equals(T t2, T t3, int i2) {
        ...
        switch (type(typeAndOffsetAt)) {
            case 0:
                if (!arePresentForEquals(t2, t3, i2) || Double.doubleToLongBits(UnsafeUtil.getDouble((Object) t2, offset)) != Double.doubleToLongBits(UnsafeUtil.getDouble((Object) t3, offset))) {
                    return false;
                }
                return true;
            case 1:
                if (!arePresentForEquals(t2, t3, i2) || Float.floatToIntBits(UnsafeUtil.getFloat((Object) t2, offset)) != Float.floatToIntBits(UnsafeUtil.getFloat((Object) t3, offset))) {
                    return false;
                }
                return true;
            case 2:
                if (!arePresentForEquals(t2, t3, i2) || UnsafeUtil.getLong((Object) t2, offset) != UnsafeUtil.getLong((Object) t3, offset)) {
                    return false;
                }
                return true;
            case 3:
                ...
                return true;
            case 4:
                if (!arePresentForEquals(t2, t3, i2) || UnsafeUtil.getInt((Object) t2, offset) != UnsafeUtil.getInt((Object) t3, offset)) {
                    return false;
                }
                return true;
            case 5:
            ...
            case 6:
                ...
                return true;
            case 7:
                if (!arePresentForEquals(t2, t3, i2) || UnsafeUtil.getBoolean((Object) t2, offset) != UnsafeUtil.getBoolean((Object) t3, offset)) {
                    return false;
                }
                return true;
            case 8:
                if (!arePresentForEquals(t2, t3, i2) || !SchemaUtil.safeEquals(UnsafeUtil.getObject((Object) t2, offset), UnsafeUtil.getObject((Object) t3, offset))) {
                    return false;
                }
                return true;
            case 9:
            ...
            case 67:
            case 68:
                if (!isOneofCaseEqual(t2, t3, i2) || !SchemaUtil.safeEquals(UnsafeUtil.getObject((Object) t2, offset), UnsafeUtil.getObject((Object) t3, offset))) {
                    return false;
                }
                return true;
            default:
