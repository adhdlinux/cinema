...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(Field field2, int i2, FieldType fieldType, Class<?> cls, Field field3, int i3, boolean z2, boolean z3, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier2, Field field4) {
        this.field = field2;
        this.type = fieldType;
    ...
    public static FieldInfo forField(Field field2, int i2, FieldType fieldType, boolean z2) {
        ...
        if (fieldType2 != FieldType.MESSAGE_LIST && fieldType2 != FieldType.GROUP_LIST) {
            return new FieldInfo(field2, i2, fieldType, (Class<?>) null, (Field) null, 0, false, z2, (OneofInfo) null, (Class<?>) null, (Object) null, (Internal.EnumVerifier) null, (Field) null);
        }
    ...
    public static FieldInfo forOneofMemberField(int i2, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z2, Internal.EnumVerifier enumVerifier2) {
        FieldType fieldType2 = fieldType;
        checkFieldNumber(i2);
        Internal.checkNotNull(fieldType2, "fieldType");
        ...
        if (fieldType.isScalar()) {
            return new FieldInfo((Field) null, i2, fieldType, (Class<?>) null, (Field) null, 0, false, z2, oneofInfo, cls, (Object) null, enumVerifier2, (Field) null);
        }
    ...
    public static FieldInfo forProto2OptionalField(Field field2, int i2, FieldType fieldType, Field field3, int i3, boolean z2, Internal.EnumVerifier enumVerifier2) {
        Field field4 = field3;
        checkFieldNumber(i2);
        Field field5 = field2;
        Internal.checkNotNull(field2, "field");
        ...
        if (field4 == null || isExactlyOneBitSet(i3)) {
            int i4 = i3;
            return new FieldInfo(field2, i2, fieldType, (Class<?>) null, field3, i3, false, z2, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i3);
    }

    public static FieldInfo forProto2RequiredField(Field field2, int i2, FieldType fieldType, Field field3, int i3, boolean z2, Internal.EnumVerifier enumVerifier2) {
        Field field4 = field3;
        checkFieldNumber(i2);
        Field field5 = field2;
        Internal.checkNotNull(field2, "field");
        ...
        if (field4 == null || isExactlyOneBitSet(i3)) {
            int i4 = i3;
            return new FieldInfo(field2, i2, fieldType, (Class<?>) null, field3, i3, true, z2, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i3);
    }
