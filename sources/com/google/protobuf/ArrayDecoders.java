...
final class ArrayDecoders {
    ...
    static int decodeGroupField(Schema schema, byte[] bArr, int i2, int i3, int i4, Registers registers) throws IOException {
        ...
        int mergeGroupField = mergeGroupField(newInstance, schema, bArr, i2, i3, i4, registers);
    ...
    static int mergeGroupField(Object obj, Schema schema, byte[] bArr, int i2, int i3, int i4, Registers registers) throws IOException {
