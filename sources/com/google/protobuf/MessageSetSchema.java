...
final class MessageSetSchema<T> implements Schema<T> {
        ...
        if (tag == WireFormat.MESSAGE_SET_ITEM_TAG) {
            ...
            while (reader.getFieldNumber() != Integer.MAX_VALUE) {
                ...
                if (tag2 == WireFormat.MESSAGE_SET_TYPE_ID_TAG) {
                    ...
                    obj = extensionSchema2.findExtensionByNumber(extensionRegistryLite, this.defaultInstance, i2);
            ...
            if (reader.getTag() == WireFormat.MESSAGE_SET_ITEM_END_TAG) {
                if (byteString != null) {
                    if (obj != null) {
                        ...
                        unknownFieldSchema2.addLengthDelimited(ub, i2, byteString);
                    }
                }
                return true;
            }
    ...
    public int getSerializedSize(T t2) {
        ...
        if (this.hasExtensions) {
            return unknownFieldsSerializedSize + this.extensionSchema.getExtensions(t2).getMessageSetSerializedSize();
        }
    ...
    public int hashCode(T t2) {
        ...
        if (this.hasExtensions) {
            return (hashCode * 53) + this.extensionSchema.getExtensions(t2).hashCode();
        }
        return hashCode;
    }
