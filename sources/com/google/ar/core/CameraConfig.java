...
public class CameraConfig {
    ...
    public enum DepthSensorUsage {
        ...
        static DepthSensorUsage forNumber(int i2) {
            ...
            throw new FatalException(p.b((byte) 52, i2, "Unexpected value for native DepthSensorUsage, value="));
        }
    }
    ...
    public enum FacingDirection {
        ...
        static FacingDirection forNumber(int i2) {
            ...
            throw new FatalException(p.b((byte) 51, i2, "Unexpected value for native FacingDirection, value="));
        }
    }
    ...
    public enum StereoCameraUsage {
        ...
        static StereoCameraUsage forNumber(int i2) {
            ...
            throw new FatalException(p.b((byte) 53, i2, "Unexpected value for native StereoCameraUsage, value="));
        }
    }
