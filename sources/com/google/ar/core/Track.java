...
public class Track {
    ...
    private static native long nativeCreateTrack(long j2);

    private static native void nativeDestroyTrack(long j2, long j3);

    private native void nativeSetId(long j2, long j3, byte[] bArr);

    private native void nativeSetMetadata(long j2, long j3, byte[] bArr);
    ...
    public void finalize() throws Throwable {
        ...
        if (j2 != 0) {
            nativeDestroyTrack(this.nativeSymbolTableHandle, j2);
            this.nativeHandle = 0;
        }
        super.finalize();
    }
