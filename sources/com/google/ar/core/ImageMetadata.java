...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i2, q qVar) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i2);
        qVar.f30348a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            qVar.f30349b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            qVar.f30350c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, qVar.f30348a);
            return;
        }
        throw new IllegalArgumentException(String.format("Invalid ImageMetadata key: %1$d", new Object[]{Integer.valueOf(i2)}));
    }
    ...
    public byte getByte(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 0 && qVar.f30350c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
            return nativeGetByteFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", new Object[]{Integer.valueOf(i2)}));
    }

    public byte[] getByteArray(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public double getDouble(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 4 && qVar.f30350c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public double[] getDoubleArray(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public float getFloat(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 2 && qVar.f30350c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public float[] getFloatArray(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public int getInt(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 1 && qVar.f30350c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public int[] getIntArray(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public long getLong(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 3 && qVar.f30350c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i2), Integer.valueOf(this.sketchEntry.f30349b), Integer.valueOf(this.sketchEntry.f30350c)}));
    }

    public long[] getLongArray(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public Rational getRational(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 5 && qVar.f30350c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
    ...
    public Rational[] getRationalArray(int i2) throws MetadataNotFoundException {
        getMetdataEntry(i2, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f30349b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f30348a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f30348a);
