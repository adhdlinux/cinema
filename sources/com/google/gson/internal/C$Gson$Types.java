...
public final class C$Gson$Types {
    ...
    static final Type[] f30911a = new Type[0];

    /* renamed from: com.google.gson.internal.$Gson$Types$GenericArrayTypeImpl */
    private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {

        /* renamed from: b  reason: collision with root package name */
        private final Type f30912b;

        public GenericArrayTypeImpl(Type type) {
            Objects.requireNonNull(type);
            this.f30912b = C$Gson$Types.b(type);
        }
        ...
        public int hashCode() {
            return this.f30912b.hashCode();
        }

        public String toString() {
            return C$Gson$Types.u(this.f30912b) + HttpUrl.PATH_SEGMENT_ENCODE_SET_URI;
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final Type f30913b;

        /* renamed from: c  reason: collision with root package name */
        private final Type f30914c;

        /* renamed from: d  reason: collision with root package name */
        private final Type[] f30915d;

        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            Type type3;
            Objects.requireNonNull(type2);
            if (type != null || !C$Gson$Types.o(type2)) {
                if (type == null) {
                    type3 = null;
                } else {
                ...
                this.f30913b = type3;
                this.f30914c = C$Gson$Types.b(type2);
                Type[] typeArr2 = (Type[]) typeArr.clone();
                this.f30915d = typeArr2;
                int length = typeArr2.length;
                for (int i2 = 0; i2 < length; i2++) {
                    Objects.requireNonNull(this.f30915d[i2]);
                    C$Gson$Types.c(this.f30915d[i2]);
                    Type[] typeArr3 = this.f30915d;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f30915d.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f30915d) ^ this.f30914c.hashCode()) ^ a(this.f30913b);
        }

        public String toString() {
            int length = this.f30915d.length;
            if (length == 0) {
                return C$Gson$Types.u(this.f30914c);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(C$Gson$Types.u(this.f30914c));
            sb.append("<");
            sb.append(C$Gson$Types.u(this.f30915d[0]));
            for (int i2 = 1; i2 < length; i2++) {
                sb.append(", ");
                sb.append(C$Gson$Types.u(this.f30915d[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                C$Gson$Preconditions.a(typeArr[0] != cls ? false : z4);
                this.f30917c = C$Gson$Types.b(typeArr2[0]);
                this.f30916b = cls;
                return;
            }
            ...
            this.f30917c = null;
            this.f30916b = C$Gson$Types.b(typeArr[0]);
        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f30917c;
            if (type == null) {
                return C$Gson$Types.f30911a;
            }
            return new Type[]{type};
        }

        public Type[] getUpperBounds() {
            return new Type[]{this.f30916b};
        }

        public int hashCode() {
            Type type = this.f30917c;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f30916b.hashCode() + 31);
        }

        public String toString() {
            if (this.f30917c != null) {
                return "? super " + C$Gson$Types.u(this.f30917c);
            } else if (this.f30916b == Object.class) {
                return "?";
            } else {
                return "? extends " + C$Gson$Types.u(this.f30916b);
            }
        }
    }
    ...
    private static java.lang.reflect.Type q(java.lang.reflect.Type r9, java.lang.Class<?> r10, java.lang.reflect.Type r11, java.util.Map<java.lang.reflect.TypeVariable<?>, java.lang.reflect.Type> r12) {
        ...
        L_0x00cb:
            ...
            r1 = r4[r2]
            java.lang.reflect.Type r9 = q(r9, r10, r1, r12)     // Catch:{ all -> 0x00e2 }
            r10 = r4[r2]
            if (r9 == r10) goto L_0x00dc
    ...
    public static WildcardType s(Type type) {
        ...
        return new WildcardTypeImpl(typeArr, f30911a);
    }
