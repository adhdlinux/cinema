...
public final class TypeAdapters {
    public static final TypeAdapter<BigInteger> A = new TypeAdapter<BigInteger>() {
        /* renamed from: a */
        public BigInteger read(JsonReader jsonReader) throws IOException {
            ...
            try {
                return NumberLimits.c(nextString);
    ...
    public static final TypeAdapter<LazilyParsedNumber> B = new TypeAdapter<LazilyParsedNumber>() {
        /* renamed from: a */
    ...
    public static final TypeAdapter<Class> f31077a;

    /* renamed from: b  reason: collision with root package name */
    public static final TypeAdapterFactory f31078b;

    /* renamed from: c  reason: collision with root package name */
    public static final TypeAdapter<BitSet> f31079c;

    /* renamed from: d  reason: collision with root package name */
    public static final TypeAdapterFactory f31080d;

    /* renamed from: e  reason: collision with root package name */
    public static final TypeAdapter<Boolean> f31081e;

    /* renamed from: f  reason: collision with root package name */
    public static final TypeAdapter<Boolean> f31082f = new TypeAdapter<Boolean>() {
        /* renamed from: a */
    ...
    public static final TypeAdapterFactory f31083g;

    /* renamed from: h  reason: collision with root package name */
    public static final TypeAdapter<Number> f31084h;

    /* renamed from: i  reason: collision with root package name */
    public static final TypeAdapterFactory f31085i;

    /* renamed from: j  reason: collision with root package name */
    public static final TypeAdapter<Number> f31086j;

    /* renamed from: k  reason: collision with root package name */
    public static final TypeAdapterFactory f31087k;

    /* renamed from: l  reason: collision with root package name */
    public static final TypeAdapter<Number> f31088l;

    /* renamed from: m  reason: collision with root package name */
    public static final TypeAdapterFactory f31089m;

    /* renamed from: n  reason: collision with root package name */
    public static final TypeAdapter<AtomicInteger> f31090n;

    /* renamed from: o  reason: collision with root package name */
    public static final TypeAdapterFactory f31091o;

    /* renamed from: p  reason: collision with root package name */
    public static final TypeAdapter<AtomicBoolean> f31092p;

    /* renamed from: q  reason: collision with root package name */
    public static final TypeAdapterFactory f31093q;

    /* renamed from: r  reason: collision with root package name */
    public static final TypeAdapter<AtomicIntegerArray> f31094r;

    /* renamed from: s  reason: collision with root package name */
    public static final TypeAdapterFactory f31095s;

    /* renamed from: t  reason: collision with root package name */
    public static final TypeAdapter<Number> f31096t = new TypeAdapter<Number>() {
        /* renamed from: a */
    ...
    public static final TypeAdapter<Number> f31097u = new TypeAdapter<Number>() {
        /* renamed from: a */
        public Number read(JsonReader jsonReader) throws IOException {
            if (jsonReader.peek() != JsonToken.NULL) {
    ...
    public static final TypeAdapter<Number> f31098v = new TypeAdapter<Number>() {
        /* renamed from: a */
        public Number read(JsonReader jsonReader) throws IOException {
            if (jsonReader.peek() != JsonToken.NULL) {
    ...
    public static final TypeAdapter<Character> f31099w;

    /* renamed from: x  reason: collision with root package name */
    public static final TypeAdapterFactory f31100x;

    /* renamed from: y  reason: collision with root package name */
    public static final TypeAdapter<String> f31101y;

    /* renamed from: z  reason: collision with root package name */
    public static final TypeAdapter<BigDecimal> f31102z = new TypeAdapter<BigDecimal>() {
        /* renamed from: a */
    ...
    static /* synthetic */ class AnonymousClass42 {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f31117a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31117a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31117a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f31117a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f31117a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f31117a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.AnonymousClass42.<clinit>():void");
        }
    }
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Map<String, T> f31118a = new HashMap();

        /* renamed from: b  reason: collision with root package name */
        private final Map<String, T> f31119b = new HashMap();

        /* renamed from: c  reason: collision with root package name */
        private final Map<T, String> f31120c = new HashMap();
                ...
                for (Field field : (Field[]) AccessController.doPrivileged(new PrivilegedAction<Field[]>() {
                    ...
                    if (serializedName != null) {
                        ...
                        for (String put : serializedName.alternate()) {
                            this.f31118a.put(put, enumR);
                        }
                    }
                    this.f31118a.put(name, enumR);
                    this.f31119b.put(str, enumR);
                    this.f31120c.put(enumR, name);
                }
        ...
        public T read(JsonReader jsonReader) throws IOException {
            ...
            String nextString = jsonReader.nextString();
            T t2 = (Enum) this.f31118a.get(nextString);
            if (t2 == null) {
                return (Enum) this.f31119b.get(nextString);
            }
            return t2;
        }
        ...
        public void write(JsonWriter jsonWriter, T t2) throws IOException {
            jsonWriter.value(t2 == null ? null : this.f31120c.get(t2));
        }
    }
    ...
    static {
        ...
        f31077a = nullSafe;
        f31078b = b(Class.class, nullSafe);
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i3 = AnonymousClass42.f31117a[peek.ordinal()];
                    boolean z2 = true;
                    if (i3 == 1 || i3 == 2) {
        ...
        f31079c = nullSafe2;
        f31080d = b(BitSet.class, nullSafe2);
        ...
        f31081e = r02;
        f31083g = c(Boolean.TYPE, Boolean.class, r02);
        ...
        f31084h = r03;
        f31085i = c(Byte.TYPE, Byte.class, r03);
        ...
        f31086j = r04;
        f31087k = c(Short.TYPE, Short.class, r04);
        ...
        f31088l = r05;
        f31089m = c(Integer.TYPE, Integer.class, r05);
        ...
        f31090n = nullSafe3;
        f31091o = b(AtomicInteger.class, nullSafe3);
        ...
        f31092p = nullSafe4;
        f31093q = b(AtomicBoolean.class, nullSafe4);
        ...
        f31094r = nullSafe5;
        f31095s = b(AtomicIntegerArray.class, nullSafe5);
        ...
        f31099w = r06;
        f31100x = c(Character.TYPE, Character.class, r06);
        ...
        R = r014;
        S = d(Calendar.class, GregorianCalendar.class, r014);
        ...
        AnonymousClass28 r016 = new TypeAdapter<JsonElement>() {
            private JsonElement b(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i2 = AnonymousClass42.f31117a[jsonToken.ordinal()];
                if (i2 == 1) {
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                ...
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).f();
                }
                JsonToken peek = jsonReader.peek();
                JsonElement c2 = c(jsonReader, peek);
                if (c2 == null) {
                ...
                while (true) {
                    if (jsonReader.hasNext()) {
                        ...
                        JsonElement c3 = c(jsonReader, peek2);
                        if (c3 != null) {
                            z2 = true;
                        } else {
                            z2 = false;
                        ...
                        c2 = (JsonElement) arrayDeque.removeLast();
                    }
                }
            }
            ...
            public void write(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
                if (jsonElement == null || jsonElement.h()) {
                ...
                } else if (jsonElement.g()) {
                    jsonWriter.beginArray();
                    Iterator<JsonElement> it2 = jsonElement.b().iterator();
                    while (it2.hasNext()) {
                    ...
                    jsonWriter.beginObject();
                    for (Map.Entry next : jsonElement.c().l()) {
            ...
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                ...
                return new TypeAdapter<T1>() {
                    public T1 read(JsonReader jsonReader) throws IOException {
                        ...
                        if (read == null || c2.isInstance(read)) {
                            return read;
                        }
                        throw new JsonSyntaxException("Expected a " + c2.getName() + " but was " + read.getClass().getName() + "; at path " + jsonReader.getPreviousPath());
                    }
