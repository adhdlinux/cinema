...
public final class zzs extends zzbz {
    ...
    zzs(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) List list, @SafeParcelable.Param(id = 3) List list2, @SafeParcelable.Param(id = 4) List list3, @SafeParcelable.Param(id = 5) List list4, @SafeParcelable.Param(id = 6) List list5) {
        this.zza = i2;
        this.zzc = list;
        this.zzd = list2;
        this.zze = list3;
