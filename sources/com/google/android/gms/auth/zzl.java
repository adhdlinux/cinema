...
public class zzl {
    ...
    public static Boolean requestGoogleAccountsAccess(Context context) throws GoogleAuthException, IOException {
        ...
        if (zzhs.zze() && zzo(context)) {
            try {
                ...
                zzl(e2, "google accounts access request");
            }
        }
    ...
    @ShowFirstParty
    public static void zze(Context context, String str, long j2) throws GoogleAuthException, IOException {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        zzk(context, 8400000);
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzk, long j2) throws IOException, GoogleAuthException {
        ...
        try {
            ...
            Log.w("GoogleAuthUtil", String.format("SecurityException while bind to auth service: %s", new Object[]{e3.getMessage()}));
    ...
    private static void zzk(Context context, int i2) throws GoogleAuthException {
        try {
