...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    KeyHandle(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) byte[] bArr, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) List list) {
        this.zza = i2;
        this.zzb = bArr;
        try {
    ...
    public final JSONObject zza() {
        ...
        try {
            ...
            if (protocolVersion != null) {
                jSONObject.put(MediationMetaData.KEY_VERSION, protocolVersion.toString());
            }
            if (this.zzd != null) {
