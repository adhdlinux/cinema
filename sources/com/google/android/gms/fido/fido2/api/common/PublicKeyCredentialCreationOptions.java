...
public class PublicKeyCredentialCreationOptions extends RequestOptions {
    ...
    public static final class Builder {
        ...
        public PublicKeyCredentialCreationOptions build() {
            ...
            return new PublicKeyCredentialCreationOptions(publicKeyCredentialRpEntity, publicKeyCredentialUserEntity, bArr, list, d2, list2, authenticatorSelectionCriteria, num, tokenBinding, str, this.zzk);
        }
