...
public final class ResponseInfo {
    ...
    private ResponseInfo(zzdn zzdn) {
        ...
        if (zzdn != null) {
            try {
                ...
                zzbzr.zzh("Could not forward getAdapterResponseInfo to ResponseInfo.", e2);
            }
        }
        zzdn zzdn2 = this.zza;
        if (zzdn2 != null) {
            try {
                ...
                zzbzr.zzh("Could not forward getLoadedAdapterResponse to ResponseInfo.", e3);
            }
        }
    }
    ...
    public String getMediationAdapterClassName() {
        try {
            ...
            zzbzr.zzh("Could not forward getMediationAdapterClassName to ResponseInfo.", e2);
            return null;
        }
    }
    ...
    public Bundle getResponseExtras() {
        try {
            ...
            zzbzr.zzh("Could not forward getResponseExtras to ResponseInfo.", e2);
        }
        return new Bundle();
    }
    ...
    public String getResponseId() {
        try {
            ...
            zzbzr.zzh("Could not forward getResponseId to ResponseInfo.", e2);
            return null;
        }
    }
