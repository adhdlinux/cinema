...
public final class zzc extends AbstractSafeParcelable {
    ...
    public zzc(Intent intent, zzx zzx) {
        this((String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, intent, ObjectWrapper.wrap(zzx).asBinder(), false);
    }
    ...
    public zzc(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) String str2, @SafeParcelable.Param(id = 4) String str3, @SafeParcelable.Param(id = 5) String str4, @SafeParcelable.Param(id = 6) String str5, @SafeParcelable.Param(id = 7) String str6, @SafeParcelable.Param(id = 8) String str7, @SafeParcelable.Param(id = 9) Intent intent, @SafeParcelable.Param(id = 10) IBinder iBinder, @SafeParcelable.Param(id = 11) boolean z2) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzd = str4;
    ...
    public zzc(String str, String str2, String str3, String str4, String str5, String str6, String str7, zzx zzx) {
        this(str, str2, str3, str4, str5, str6, str7, (Intent) null, ObjectWrapper.wrap(zzx).asBinder(), false);
    }
}
