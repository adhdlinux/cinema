...
public class MediaQueueContainerMetadata extends AbstractSafeParcelable {
    ...
    MediaQueueContainerMetadata(@SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) List list, @SafeParcelable.Param(id = 5) List list2, @SafeParcelable.Param(id = 6) double d2) {
        this.zza = i2;
        this.zzb = str;
        this.zzc = list;
        this.zzd = list2;
