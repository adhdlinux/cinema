...
public class MediaQueue {
    ...
    public static abstract class Callback {
        ...
        public void itemsReorderedAtIndexes(List<Integer> list, int i2) {
        }
    ...
    MediaQueue(RemoteMediaClient remoteMediaClient, int i2, int i3) {
    ...
    static /* bridge */ /* synthetic */ void zze(MediaQueue mediaQueue, int i2, int i3) {
        synchronized (mediaQueue.zzn) {
            for (Callback itemsInsertedInRange : mediaQueue.zzn) {
                itemsInsertedInRange.itemsInsertedInRange(i2, i3);
            }
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzg(MediaQueue mediaQueue, List list, int i2) {
        synchronized (mediaQueue.zzn) {
            for (Callback itemsReorderedAtIndexes : mediaQueue.zzn) {
                itemsReorderedAtIndexes.itemsReorderedAtIndexes(list, i2);
            }
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzk(MediaQueue mediaQueue) {
        ...
        for (int i2 = 0; i2 < mediaQueue.zzb.size(); i2++) {
            mediaQueue.zzc.put(((Integer) mediaQueue.zzb.get(i2)).intValue(), i2);
        }
    }
    ...
    public PendingResult<RemoteMediaClient.MediaChannelResult> fetchMoreItemsRelativeToIndex(int i2, int i3, int i4) {
        ...
        return this.zzh.zzh(itemIdAtIndex, i3, i4);
    }
    ...
    public int itemIdAtIndex(int i2) {
        ...
        return ((Integer) this.zzb.get(i2)).intValue();
    }
    ...
    public void setCacheCapacity(int i2) {
        ...
        for (Map.Entry entry : lruCache.snapshot().entrySet()) {
            if (size > i2) {
                int i3 = this.zzc.get(((Integer) entry.getKey()).intValue(), -1);
                if (i3 != -1) {
    ...
    public MediaQueueItem getItemAtIndex(int i2, boolean z2) {
        ...
        int intValue = ((Integer) this.zzb.get(i2)).intValue();
        LruCache lruCache = this.zzd;
        Integer valueOf = Integer.valueOf(intValue);
        MediaQueueItem mediaQueueItem = (MediaQueueItem) lruCache.get(valueOf);
        if (mediaQueueItem == null && z2 && !this.zzf.contains(valueOf)) {
