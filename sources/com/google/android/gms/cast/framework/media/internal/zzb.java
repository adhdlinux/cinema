    ...
    public final boolean zzd(Uri uri) {
        ...
        if (uri2 == null) {
            ...
            if (this.zzb.getWidthInPixels() == 0 || this.zzb.getHeightInPixels() == 0) {
                this.zzd = new zzf(this.zza, 0, 0, false, PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE, 5, 333, 10000, this);
            } else {
                this.zzd = new zzf(this.zza, this.zzb.getWidthInPixels(), this.zzb.getHeightInPixels(), false, PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE, 5, 333, 10000, this);
            }
