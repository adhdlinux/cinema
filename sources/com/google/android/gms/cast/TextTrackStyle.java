...
public final class TextTrackStyle extends AbstractSafeParcelable {
    ...
    private static final String zzc(int i2) {
    ...
    public void fromJson(JSONObject jSONObject) throws JSONException {
        ...
        this.zzc = zzb(jSONObject.optString(ViewProps.FOREGROUND_COLOR));
        this.zzd = zzb(jSONObject.optString(ViewProps.BACKGROUND_COLOR));
        ...
        this.zzj = CastUtils.optStringOrNull(jSONObject, ViewProps.FONT_FAMILY);
    ...
    public void setFontGenericFamily(int i2) {
        if (i2 < 0 || i2 > 6) {
    ...
    public void setWindowCornerRadius(int i2) {
        if (i2 >= 0) {
            this.zzi = i2;
            return;
        }
