...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    GeofencingRequest(@SafeParcelable.Param(id = 1) List list, @InitialTrigger @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) String str2) {
        this.zza = list;
        this.zzb = i2;
        this.zzc = str;
        this.zzd = str2;
