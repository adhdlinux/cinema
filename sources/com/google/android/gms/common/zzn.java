...
final class zzn {
    ...
    static zzx zza(String str, zzj zzj, boolean z2, boolean z3) {
    ...
    static zzx zzb(String str, boolean z2, boolean z3, boolean z4) {
        return zzi(str, z2, false, false, true);
    }

    static zzx zzc(String str, boolean z2, boolean z3, boolean z4) {
        return zzi(str, z2, false, false, false);
    }

    static /* synthetic */ String zzd(boolean z2, String str, zzj zzj) throws Exception {
        boolean z3;
        String str2;
        if (z2 || !zzh(str, zzj, true, false).zza) {
            z3 = false;
        } else {
            z3 = true;
        }
        ...
        return String.format("%s: pkg=%s, sha256=%s, atk=%s, ver=%s", new Object[]{str2, str, Hex.bytesToStringLowercase(zza2.digest(zzj.zzf())), Boolean.valueOf(z2), "12451000.false"});
    }
    ...
    private static zzx zzh(String str, zzj zzj, boolean z2, boolean z3) {
        try {
            ...
            try {
                if (zze.zzh(new zzs(str, zzj, z2, z3), ObjectWrapper.wrap(zzg.getPackageManager()))) {
                    return zzx.zzb();
                }
                return new zzv(new zze(z2, str, zzj), (zzu) null);
    ...
    private static zzx zzi(String str, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        try {
            ...
            try {
                ...
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e2);
                zzx = zzx.zzd("module init: ".concat(String.valueOf(e2.getMessage())), e2);
            }
        } catch (RemoteException e3) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e3);
            zzx = zzx.zzd("module call", e3);
        } catch (Throwable th) {
            StrictMode.setThreadPolicy(allowThreadDiskReads);
            throw th;
        }
