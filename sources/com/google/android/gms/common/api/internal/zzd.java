...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzd3 = (zzd) fragmentActivity.getSupportFragmentManager().i0("SupportLifecycleFragmentImpl");
            if (zzd3 == null || zzd3.isRemoving()) {
                zzd3 = new zzd();
                fragmentActivity.getSupportFragmentManager().n().e(zzd3, "SupportLifecycleFragmentImpl").i();
            }
