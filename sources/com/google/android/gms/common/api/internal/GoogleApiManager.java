...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final void zaL(TaskCompletionSource taskCompletionSource, int i2, GoogleApi googleApi) {
        zacd zaa2;
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i2) {
            ...
            case 2:
                ...
                Iterator it2 = zal2.zab().iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
                    } else {
    ...
    public final Task zar(GoogleApi googleApi, ListenerHolder.ListenerKey listenerKey, int i2) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
    ...
    public final void zaw(GoogleApi googleApi, int i2, BaseImplementation.ApiMethodImpl apiMethodImpl) {
        zae zae2 = new zae(i2, apiMethodImpl);
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(4, new zach(zae2, this.zao.get(), googleApi)));
    }

    public final void zax(GoogleApi googleApi, int i2, TaskApiCall taskApiCall, TaskCompletionSource taskCompletionSource, StatusExceptionMapper statusExceptionMapper) {
        zaL(taskCompletionSource, taskApiCall.zaa(), googleApi);
        zag zag2 = new zag(i2, taskApiCall, taskCompletionSource, statusExceptionMapper);
        Handler handler = this.zat;
