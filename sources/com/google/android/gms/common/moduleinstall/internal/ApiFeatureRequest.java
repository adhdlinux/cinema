...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    public ApiFeatureRequest(@SafeParcelable.Param(id = 1) List list, @SafeParcelable.Param(id = 2) boolean z2, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) String str2) {
    ...
    static ApiFeatureRequest zaa(List list, boolean z2) {
        TreeSet treeSet = new TreeSet(zaa);
        Iterator it2 = list.iterator();
        while (it2.hasNext()) {
            Collections.addAll(treeSet, ((OptionalModuleApi) it2.next()).getOptionalFeatures());
        }
        return new ApiFeatureRequest(new ArrayList(treeSet), z2, (String) null, (String) null);
    }
