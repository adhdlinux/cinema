...
public final class zaaa extends Button {
    ...
    public final void zaa(Resources resources, int i2, int i3) {
        ...
        Drawable r2 = DrawableCompat.r(resources.getDrawable(zab));
        DrawableCompat.o(r2, resources.getColorStateList(R.color.common_google_signin_btn_tint));
        DrawableCompat.p(r2, PorterDuff.Mode.SRC_ATOP);
