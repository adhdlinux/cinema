...
public final class zzam {
    public static int zza(int i2, int i3, String str) {
        ...
        if (i2 < 0) {
            str2 = zzan.zza("%s (%s) must not be negative", "index", Integer.valueOf(i2));
        } else if (i3 < 0) {
            throw new IllegalArgumentException("negative size: " + i3);
        } else {
            str2 = zzan.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i2), Integer.valueOf(i3));
        }
    ...
    public static void zze(int i2, int i3, int i4) {
        ...
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            if (i2 < 0 || i2 > i4) {
                ...
                str = zzan.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2));
            }
