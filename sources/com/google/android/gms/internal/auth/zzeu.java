...
public abstract class zzeu<MessageType extends zzeu<MessageType, BuilderType>, BuilderType extends zzes<MessageType, BuilderType>> extends zzdp<MessageType, BuilderType> {
    ...
    private static zzeu zzj(zzeu zzeu, byte[] bArr, int i2, int i3, zzek zzek) throws zzfa {
        zzeu zzeu2 = (zzeu) zzeu.zzi(4, (Object) null, (Object) null);
        try {
            zzgh zzb2 = zzge.zza().zzb(zzeu2.getClass());
            zzb2.zzg(zzeu2, bArr, 0, i3, new zzds(zzek));
            zzb2.zze(zzeu2);
            if (zzeu2.zza == 0) {
                return zzeu2;
            }
            ...
            if (e4.getCause() instanceof zzfa) {
                throw ((zzfa) e4.getCause());
            }
            zzfa zzfa = new zzfa(e4);
            zzfa.zze(zzeu2);
            throw zzfa;
    ...
    public abstract Object zzi(int i2, Object obj, Object obj2);
}
