...
class zzgu extends AbstractMap {
    ...
    /* synthetic */ zzgu(int i2, zzgt zzgt) {
        this.zza = i2;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i2 <= size) {
            int i3 = (i2 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzgo) this.zzb.get(i3)).zza());
            if (compareTo2 < 0) {
                size = i3 - 1;
    ...
    public final Object zzl(int i2) {
        zzn();
        Object value = ((zzgo) this.zzb.remove(i2)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final int hashCode() {
        ...
        for (int i3 = 0; i3 < zzb2; i3++) {
            i2 += ((zzgo) this.zzb.get(i3)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i3 = this.zza;
        if (size == i3) {
            zzgo zzgo = (zzgo) this.zzb.remove(i3 - 1);
            zzm().put(zzgo.zza(), zzgo.getValue());
        }
        this.zzb.add(i2, new zzgo(this, comparable, obj));
        return null;
    }
