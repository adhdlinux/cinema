...
public final class zzhv implements zzht {
    ...
    static {
        ...
        try {
            ...
            zzh = zza2.zzd("getTokenRefactor__clear_token_timeout_seconds", 20);
            zzi = zza2.zzd("getTokenRefactor__default_task_timeout_seconds", 20);
            ...
            zzl = zza2.zzd("getTokenRefactor__get_token_timeout_seconds", 120);
