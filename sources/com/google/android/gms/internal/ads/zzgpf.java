...
final class zzgpf extends zzgno implements RandomAccess, zzgrd {
    private static final zzgpf zza = new zzgpf(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(zzgpf.zzb, 0, this.zzb, this.zzc, zzgpf.zzc);
            this.zzc = i4;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgpf zzgpf = (zzgpf) obj;
        if (this.zzc != zzgpf.zzc) {
            return false;
        }
        float[] fArr = zzgpf.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgpv zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzgpf(Arrays.copyOf(this.zzb, i2), this.zzc, true);
        }
    ...
    private zzgpf(float[] fArr, int i2, boolean z2) {
        super(z2);
        this.zzb = fArr;
        this.zzc = i2;
    }
