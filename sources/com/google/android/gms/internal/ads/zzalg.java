...
public final class zzalg {
    ...
    private zzalg(int i2, byte[] bArr, Map map, List list, boolean z2, long j2) {
        this.zza = i2;
        this.zzb = bArr;
        this.zzc = map;
    ...
    @Deprecated
    public zzalg(int i2, byte[] bArr, Map map, boolean z2, long j2) {
        this(i2, bArr, map, zza(map), z2, j2);
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public zzalg(int r9, byte[] r10, boolean r11, long r12, java.util.List r14) {
        /*
            r8 = this;
    ...
    @Deprecated
    public zzalg(byte[] bArr, Map map) {
