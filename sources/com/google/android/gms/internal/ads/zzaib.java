...
public final class zzaib implements zzaaw {
    public static final zzabd zza = zzaia.zza;
    private final zzaic zzb = new zzaic((String) null);
    private final zzfa zzc = new zzfa((int) Http2.INITIAL_MAX_FRAME_SIZE);
    private boolean zzd;

    public final int zza(zzaax zzaax, zzabs zzabs) throws IOException {
        int zza2 = zzaax.zza(this.zzc.zzH(), 0, Http2.INITIAL_MAX_FRAME_SIZE);
        if (zza2 == -1) {
            return -1;
        }
        this.zzc.zzF(0);
    ...
    public final void zzb(zzaaz zzaaz) {
        ...
        zzaaz.zzC();
        zzaaz.zzN(new zzabu(-9223372036854775807L, 0));
    }
