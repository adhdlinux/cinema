...
public final class zzauz extends Thread {
    ...
    public zzauz() {
        ...
        this.zzj = ((Integer) zzba.zzc().zzb(zzbbm.zzT)).intValue();
        this.zzk = ((Integer) zzba.zzc().zzb(zzbbm.zzU)).intValue();
        this.zzl = ((Integer) zzba.zzc().zzb(zzbbm.zzV)).intValue();
        this.zze = ((Long) zzbcx.zzf.zze()).intValue();
        this.zzm = (String) zzba.zzc().zzb(zzbbm.zzX);
        this.zzn = ((Boolean) zzba.zzc().zzb(zzbbm.zzY)).booleanValue();
        this.zzo = ((Boolean) zzba.zzc().zzb(zzbbm.zzZ)).booleanValue();
        this.zzp = ((Boolean) zzba.zzc().zzb(zzbbm.zzaa)).booleanValue();
    ...
    public final void run() {
        /*
            r6 = this;
        L_0x0000:
            com.google.android.gms.internal.ads.zzauu r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ all -> 0x00a8 }
        ...
        L_0x002a:
            ...
            if (r0 == 0) goto L_0x00b2
            com.google.android.gms.internal.ads.zzauu r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            android.app.Activity r0 = r0.zza()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            if (r0 != 0) goto L_0x006d
            java.lang.String r0 = "ContentFetchThread: no activity. Sleeping."
            com.google.android.gms.internal.ads.zzbzr.zze(r0)     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x008e:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzbza r2 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x009d:
            ...
            com.google.android.gms.internal.ads.zzauv r0 = new com.google.android.gms.internal.ads.zzauv     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00a8:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzbza r1 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00dc:
            ...
            com.google.android.gms.internal.ads.zzbzr.zze(r1)     // Catch:{ InterruptedException -> 0x00dc }
    ...
    public final zzauy zzb(View view, zzaup zzaup) {
        if (view == null) {
        ...
        if ((view instanceof TextView) && !(view instanceof EditText)) {
            ...
            zzaup.zzk(text.toString(), globalVisibleRect, view.getX(), view.getY(), (float) view.getWidth(), (float) view.getHeight());
            ...
            zzaup.zzh();
            webView.post(new zzaux(this, zzaup, webView, globalVisibleRect));
            ...
            for (int i4 = 0; i4 < viewGroup.getChildCount(); i4++) {
                zzauy zzb2 = zzb(viewGroup.getChildAt(i4), zzaup);
                i2 += zzb2.zza;
                i3 += zzb2.zzb;
            }
            return new zzauy(this, i2, i3);
        }
    }
    ...
    public final void zzc(android.view.View r11) {
        /*
            r10 = this;
            com.google.android.gms.internal.ads.zzaup r9 = new com.google.android.gms.internal.ads.zzaup     // Catch:{ Exception -> 0x0083 }
            ...
            com.google.android.gms.internal.ads.zzauu r0 = com.google.android.gms.ads.internal.zzt.zzb()     // Catch:{ Exception -> 0x0083 }
            ...
            com.google.android.gms.internal.ads.zzbbe r2 = com.google.android.gms.internal.ads.zzbbm.zzW     // Catch:{ Exception -> 0x0083 }
            com.google.android.gms.internal.ads.zzbbk r3 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ Exception -> 0x0083 }
        ...
        L_0x0053:
            return
        L_0x0054:
            com.google.android.gms.internal.ads.zzauy r11 = r10.zzb(r11, r9)     // Catch:{ Exception -> 0x0083 }
        ...
        L_0x0073:
            com.google.android.gms.internal.ads.zzauq r11 = r10.zzd     // Catch:{ Exception -> 0x0083 }
    ...
    /* access modifiers changed from: package-private */
    public final void zzd(zzaup zzaup, WebView webView, String str, boolean z2) {
        zzaup.zzg();
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString("text");
                if (this.zzn || TextUtils.isEmpty(webView.getTitle())) {
                    zzaup.zzl(optString, z2, webView.getX(), webView.getY(), (float) webView.getWidth(), (float) webView.getHeight());
                } else {
                    String title = webView.getTitle();
                    zzaup.zzl(title + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + optString, z2, webView.getX(), webView.getY(), (float) webView.getWidth(), (float) webView.getHeight());
                }
            }
            if (zzaup.zzo()) {
                this.zzd.zzc(zzaup);
