...
final class zzrg {
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    static /* bridge */ /* synthetic */ void zza(com.google.android.gms.internal.ads.zzrg r9, android.os.Message r10) {
        /*
            int r0 = r10.what
            r1 = 0
    ...
    private static zzrf zzh() {
        ...
        synchronized (arrayDeque) {
            ...
            zzrf zzrf2 = (zzrf) arrayDeque.removeFirst();
            return zzrf2;
        }
    }
    ...
    public final void zzd(int i2, int i3, int i4, long j2, int i5) {
        zzc();
        zzrf zzh2 = zzh();
        zzh2.zza(i2, 0, i4, j2, i5);
        Handler handler = this.zze;
        int i6 = zzfj.zza;
        handler.obtainMessage(0, zzh2).sendToTarget();
    }

    public final void zze(int i2, int i3, zzhm zzhm, long j2, int i4) {
        zzc();
        zzrf zzh2 = zzh();
        zzh2.zza(i2, 0, 0, j2, 0);
        MediaCodec.CryptoInfo cryptoInfo = zzh2.zzd;
        cryptoInfo.numSubSamples = zzhm.zzf;
        cryptoInfo.numBytesOfClearData = zzj(zzhm.zzd, cryptoInfo.numBytesOfClearData);
        cryptoInfo.numBytesOfEncryptedData = zzj(zzhm.zze, cryptoInfo.numBytesOfEncryptedData);
        byte[] zzi = zzi(zzhm.zzb, cryptoInfo.key);
        zzi.getClass();
        cryptoInfo.key = zzi;
        byte[] zzi2 = zzi(zzhm.zza, cryptoInfo.iv);
        zzi2.getClass();
        cryptoInfo.iv = zzi2;
        cryptoInfo.mode = zzhm.zzc;
        if (zzfj.zza >= 24) {
            cryptoInfo.setPattern(new MediaCodec.CryptoInfo.Pattern(zzhm.zzg, zzhm.zzh));
        }
