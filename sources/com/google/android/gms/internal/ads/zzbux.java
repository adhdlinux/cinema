...
public interface zzbux extends IInterface {
    ...
    void zzg(zzbvb zzbvb) throws RemoteException;
    ...
    void zzl(zzby zzby) throws RemoteException;

    void zzm(String str) throws RemoteException;

    void zzn(boolean z2) throws RemoteException;

    void zzo(zzbva zzbva) throws RemoteException;
    ...
    void zzu(zzbuv zzbuv) throws RemoteException;
}
