...
public final class zzdv extends zzds {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x00b3 A[LOOP:4: B:27:0x00b3->B:28:0x00b5, LOOP_START, PHI: r0 
      PHI: (r0v2 int) = (r0v0 int), (r0v3 int) binds: [B:12:0x0036, B:28:0x00b5] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final zzdp zzi(zzdp zzdp) throws zzdq {
        ...
        return new zzdp(zzdp.zzb, zzdp.zzc, 2);
    }
}
