...
public final class zzbbm {
    ...
    public static final zzbbe zzaY = zzbbe.zzj(1, "gads:close_button_asset_name", Constants.COLLATION_DEFAULT);
    ...
    public static final zzbbe zzbO = zzbbe.zzh(1, "gads:video:range_http_data_source_low_water_mark", 102400);
    ...
    public static final zzbbe zzcz;
    public static final zzbbe zzd = zzbbe.zzg(1, "gads:js_eng_full_load:timeout_millis", DateTimeConstants.MILLIS_PER_MINUTE);
    ...
    public static final zzbbe zzhM = zzbbe.zzj(1, "gads:server_transaction_source:list", "Network");
    ...
    public static final zzbbe zziB = zzbbe.zzg(1, "gads:inspector:shake_reset_time_ms", AuthApiStatusCodes.AUTH_API_INVALID_CREDENTIALS);
    ...
    public static final zzbbe zziF = zzbbe.zzg(1, "gads:inspector:flick_reset_time_ms", AuthApiStatusCodes.AUTH_API_INVALID_CREDENTIALS);
    public static final zzbbe zziG = zzbbe.zzg(1, "gads:inspector:flick_count", 2);
    public static final zzbbe zziH = zzbbe.zzg(1, "gads:inspector:icon_width_px", UserVerificationMethods.USER_VERIFY_HANDPRINT);
    public static final zzbbe zziI = zzbbe.zzg(1, "gads:inspector:icon_height_px", UserVerificationMethods.USER_VERIFY_HANDPRINT);
    ...
    public static final zzbbe zzii = zzbbe.zzg(1, "gads:remote_log_send_rate_ms", DateTimeConstants.MILLIS_PER_MINUTE);
    ...
    public static final zzbbe zzin = zzbbe.zzg(1, "gads:cuj_automatic_flush_delay_ms", HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT);
    ...
    public static final zzbbe zzjn;
    public static final zzbbe zzjo;
    public static final zzbbe zzjp = zzbbe.zzg(1, "gads:timeout_for_show_call_succeed:ms", AuthApiStatusCodes.AUTH_API_INVALID_CREDENTIALS);
    public static final zzbbe zzjq;
    public static final zzbbe zzjr;
    public static final zzbbe zzjs;
    public static final zzbbe zzjt;
    ...
    public static final zzbbe zzv = zzbbe.zzg(1, "gads:video_stream_cache:limit_space", 8388608);
    public static final zzbbe zzw = zzbbe.zzg(1, "gads:video_stream_exo_cache:buffer_size", 8388608);
    ...
    static {
        ...
        zzas = zzbbe.zzh(1, "gads:sai:server_side_npa:ttl", timeUnit.toMillis(90));
        ...
        zzcP = zzbbe.zzh(1, "gads:signal:paid_v1_ttl", timeUnit.toMillis(182));
        zzcQ = zzbbe.zzh(1, "gads:signal:paid_v2_ttl", timeUnit.toMillis(390));
