...
public final class zzzu {
    ...
    private static int zzc(zzez zzez) {
        int zzd = zzez.zzd(5);
        if (zzd == 31) {
            return zzez.zzd(6) + 32;
        }
        return zzd;
    }

    private static int zzd(zzez zzez) throws zzcd {
        int zzd = zzez.zzd(4);
        if (zzd == 15) {
            if (zzez.zza() >= 24) {
                return zzez.zzd(24);
            }
            throw zzcd.zza("AAC header insufficient data", (Throwable) null);
        } else if (zzd < 13) {
            return zzb[zzd];
        } else {
            throw zzcd.zza("AAC header wrong Sampling Frequency Index", (Throwable) null);
        }
    }
}
