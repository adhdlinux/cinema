...
public final class zzamz extends zzgvn {
    ...
    public final void zzf(ByteBuffer byteBuffer) {
        ...
        double zza2 = zzamv.zza(byteBuffer);
        this.zzm = new zzgvx(zzb, zzb2, zzamv.zzb(byteBuffer), zzamv.zzb(byteBuffer), zza2, zzamv.zza(byteBuffer), zzamv.zza(byteBuffer), zzamv.zzb(byteBuffer), zzamv.zzb(byteBuffer));
        byteBuffer.getInt();
        byteBuffer.getInt();
        byteBuffer.getInt();
        byteBuffer.getInt();
