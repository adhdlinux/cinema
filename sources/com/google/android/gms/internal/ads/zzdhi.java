...
public interface zzdhi {
    ...
    void zzk(View view, View view2, Map map, Map map2, boolean z2, ImageView.ScaleType scaleType);

    void zzl(String str);

    void zzm(Bundle bundle);

    void zzo(View view, View view2, Map map, Map map2, boolean z2, ImageView.ScaleType scaleType, int i2);
