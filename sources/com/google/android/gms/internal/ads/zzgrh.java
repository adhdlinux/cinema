...
interface zzgrh {
    ...
    @Deprecated
    void zzC(List list, zzgrp zzgrp, zzgoy zzgoy) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgrp zzgrp, zzgoy zzgoy) throws IOException;
    ...
    zzgoe zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgrp zzgrp, zzgoy zzgoy) throws IOException;

    void zzu(Object obj, zzgrp zzgrp, zzgoy zzgoy) throws IOException;
