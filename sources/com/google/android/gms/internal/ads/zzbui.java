...
public final class zzbui {
    ...
    public zzbui(android.content.Context r7) {
        ...
        L_0x008a:
            r6.zzx = r0
            com.google.android.gms.common.wrappers.PackageManagerWrapper r0 = com.google.android.gms.common.wrappers.Wrappers.packageManager(r7)     // Catch:{ Exception -> 0x00b1 }
            java.lang.String r3 = "com.android.vending"
            r4 = 128(0x80, float:1.794E-43)
            android.content.pm.PackageInfo r0 = r0.getPackageInfo(r3, r4)     // Catch:{ Exception -> 0x00b1 }
    ...
    private static ResolveInfo zzb(PackageManager packageManager, String str) {
        try {
            ...
            zzt.zzo().zzu(th, "DeviceInfo.getResolveInfo");
            return null;
        }
    }
    ...
    private final void zzc(Context context) {
        ...
        if (audioManager != null) {
            try {
                ...
                zzt.zzo().zzu(th, "DeviceInfo.gatherAudioInfo");
            }
        }
        this.zza = -2;
        this.zzb = false;
    ...
    public zzbui(Context context, zzbuj zzbuj) {
        zzbbm.zza(context);
        zzc(context);
        zze(context);
        zzd(context);
