...
public final class zzee implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzee(Handler handler, zzed zzed) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i2) throws zzef {
        boolean z2;
        boolean z3;
        int[] iArr;
        boolean z4;
        ...
        zzeg.zza(z2, "eglGetDisplay failed");
        int[] iArr3 = new int[2];
        ...
        zzeg.zza(z3, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr4[0]), eGLConfigArr[0]}));
        ...
        zzeg.zza(z4, "eglCreateContext failed");
        ...
        if (i2 == 1) {
            ...
            zzeg.zza(z5, "eglCreatePbufferSurface failed");
        }
        zzeg.zza(EGL14.eglMakeCurrent(eGLDisplay2, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
