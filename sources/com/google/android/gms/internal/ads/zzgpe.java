...
public enum zzgpe {
    ...
    private static final zzgpe[] zzZ = null;
    private final zzgqa zzab;
    ...
    static {
        int i2;
        zzZ = new zzgpe[r1];
        for (zzgpe zzgpe : values()) {
            zzZ[zzgpe.zzac] = zzgpe;
        }
    }

    private zzgpe(int i2, int i3, zzgqa zzgqa) {
        this.zzac = i2;
        this.zzab = zzgqa;
        int i4 = i3 - 1;
        if (i4 == 1) {
