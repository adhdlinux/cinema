...
public final class zzxs implements zzxo, zzhg {
    ...
    /* synthetic */ zzxs(Context context, Map map, int i2, zzdz zzdz, boolean z2, zzxr zzxr) {
            ...
            if (zzg == null) {
                ...
                if (!(context == null || (telephonyManager = (TelephonyManager) context.getSystemService("phone")) == null)) {
                    ...
                    if (!TextUtils.isEmpty(networkCountryIso)) {
                        str = zzfon.zzb(networkCountryIso);
                        int[] zzm2 = zzm(str);
                        HashMap hashMap = new HashMap(8);
                        hashMap.put(0, 1000000L);
                        zzfsc zzfsc = zza;
                        hashMap.put(2, (Long) zzfsc.get(zzm2[0]));
                        ...
                        hashMap.put(7, (Long) zzfsc.get(zzm2[0]));
                        zzg = new zzxs(context2, hashMap, 2000, zzdz.zza, true, (zzxr) null);
                    }
                }
                str = zzfon.zzb(Locale.getDefault().getCountry());
                int[] zzm22 = zzm(str);
                HashMap hashMap2 = new HashMap(8);
                hashMap2.put(0, 1000000L);
                zzfsc zzfsc2 = zza;
                hashMap2.put(2, (Long) zzfsc2.get(zzm22[0]));
                ...
                hashMap2.put(7, (Long) zzfsc2.get(zzm22[0]));
                zzg = new zzxs(context2, hashMap2, 2000, zzdz.zza, true, (zzxr) null);
            }
            zzxs = zzg;
        }
        return zzxs;
    ...
    public final synchronized void zzk(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.zzo     // Catch:{ all -> 0x0045 }
            if (r0 != r9) goto L_0x0007
            monitor-exit(r8)
            return
        L_0x0007:
            r8.zzo = r9     // Catch:{ all -> 0x0045 }
            r0 = 1
            ...
            goto L_0x0043
        L_0x0013:
            long r0 = r8.zzi(r9)     // Catch:{ all -> 0x0045 }
            r8.zzr = r0     // Catch:{ all -> 0x0045 }
            long r0 = android.os.SystemClock.elapsedRealtime()     // Catch:{ all -> 0x0045 }
            int r9 = r8.zzl     // Catch:{ all -> 0x0045 }
            if (r9 <= 0) goto L_0x0028
            long r2 = r8.zzm     // Catch:{ all -> 0x0045 }
            long r2 = r0 - r2
            int r9 = (int) r2     // Catch:{ all -> 0x0045 }
            r3 = r9
            goto L_0x002a
        L_0x0028:
            r9 = 0
            r3 = 0
        L_0x002a:
            long r4 = r8.zzn     // Catch:{ all -> 0x0045 }
            long r6 = r8.zzr     // Catch:{ all -> 0x0045 }
            r2 = r8
            r2.zzj(r3, r4, r6)     // Catch:{ all -> 0x0045 }
            r8.zzm = r0     // Catch:{ all -> 0x0045 }
            r0 = 0
            r8.zzn = r0     // Catch:{ all -> 0x0045 }
            r8.zzq = r0     // Catch:{ all -> 0x0045 }
            r8.zzp = r0     // Catch:{ all -> 0x0045 }
            com.google.android.gms.internal.ads.zzyh r9 = r8.zzj     // Catch:{ all -> 0x0045 }
            r9.zzc()     // Catch:{ all -> 0x0045 }
            monitor-exit(r8)
            return
        L_0x0043:
            monitor-exit(r8)
        ...
        L_0x0045:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzxs.zzk(int):void");
    }

    private static boolean zzl(zzgj zzgj, boolean z2) {
        return z2 && !zzgj.zza(8);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:291:0x045b, code lost:
        if (r3.equals(com.google.android.gms.ads.RequestConfiguration.MAX_AD_CONTENT_RATING_PG) != false) goto L_0x0b88;
     */
    ...
    public final synchronized void zza(zzge zzge, zzgj zzgj, boolean z2, int i2) {
        if (zzl(zzgj, z2)) {
            this.zzn += (long) i2;
        }
    }

    public final synchronized void zzb(zzge zzge, zzgj zzgj, boolean z2) {
        boolean z3;
        if (zzl(zzgj, z2)) {
            if (this.zzl > 0) {
                z3 = true;
    ...
    public final synchronized void zzd(zzge zzge, zzgj zzgj, boolean z2) {
        if (zzl(zzgj, z2)) {
            if (this.zzl == 0) {
    ...
    public final void zze(Handler handler, zzxn zzxn) {
        zzxn.getClass();
        this.zzi.zza(handler, zzxn);
    }

    public final void zzf(zzxn zzxn) {
        this.zzi.zzc(zzxn);
    }
}
