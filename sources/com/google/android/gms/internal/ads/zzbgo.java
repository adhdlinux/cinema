...
public interface zzbgo extends IInterface {
    ...
    void zzD(zzcs zzcs) throws RemoteException;

    void zzE(zzdg zzdg) throws RemoteException;

    void zzF(zzbgl zzbgl) throws RemoteException;
    ...
    void zzy(zzcw zzcw) throws RemoteException;
