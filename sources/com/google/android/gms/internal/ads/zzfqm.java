...
final class zzfqm extends zzfqp implements NavigableMap {
    ...
    zzfqm(zzfqv zzfqv, NavigableMap navigableMap) {
    ...
    public final NavigableMap descendingMap() {
        return new zzfqm(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).descendingMap());
    }
    ...
    public final Map.Entry zzc(Iterator it2) {
        if (!it2.hasNext()) {
            return null;
        }
    ...
    public final NavigableSet zzg() {
        return new zzfqn(this.zzc, (NavigableMap) ((SortedMap) this.zza));
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z2) {
        return new zzfqm(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).headMap(obj, z2));
    }

    public final NavigableMap subMap(Object obj, boolean z2, Object obj2, boolean z3) {
        return new zzfqm(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).subMap(obj, z2, obj2, z3));
    }

    public final NavigableMap tailMap(Object obj, boolean z2) {
        return new zzfqm(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).tailMap(obj, z2));
    }
}
