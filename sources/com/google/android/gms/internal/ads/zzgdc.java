...
public final class zzgdc extends zzgcz {
    public zzgdc(byte[] bArr, int i2) throws InvalidKeyException {
        super(bArr, i2);
    }
    ...
    public final int[] zzb(int[] iArr, int i2) {
        ...
        if (length == 6) {
            ...
            iArr3[6] = iArr3[14];
            iArr3[7] = iArr3[15];
            zzgcv.zzb(iArr2, Arrays.copyOf(iArr3, 8));
            iArr2[12] = i2;
            iArr2[13] = 0;
            iArr2[14] = iArr[4];
            iArr2[15] = iArr[5];
