...
public final class zzdtw implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzba.zzc().zzb(zzbbm.zziy)).booleanValue()) {
            ...
            if (((float) Math.sqrt((double) ((f3 * f3) + (f4 * f4) + (f5 * f5)))) >= ((Float) zzba.zzc().zzb(zzbbm.zziz)).floatValue()) {
                long currentTimeMillis = zzt.zzB().currentTimeMillis();
                if (this.zzd + ((long) ((Integer) zzba.zzc().zzb(zzbbm.zziA)).intValue()) <= currentTimeMillis) {
                    if (this.zzd + ((long) ((Integer) zzba.zzc().zzb(zzbbm.zziB)).intValue()) < currentTimeMillis) {
                        this.zze = 0;
                    }
                    ...
                    int i2 = this.zze + 1;
                    this.zze = i2;
                    zzdtv zzdtv = this.zzf;
                    if (zzdtv != null) {
                        if (i2 == ((Integer) zzba.zzc().zzb(zzbbm.zziC)).intValue()) {
                            zzdsx zzdsx = (zzdsx) zzdtv;
                            zzdsx.zzh(new zzdsu(zzdsx), zzdsw.GESTURE);
                        }
                    }
                }
            }
    ...
    public final void zzb() {
        /*
            r6 = this;
            monitor-enter(r6)
            com.google.android.gms.internal.ads.zzbbe r0 = com.google.android.gms.internal.ads.zzbbm.zziy     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbbk r1 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x0015:
            ...
            com.google.android.gms.internal.ads.zzbzr.zzj(r0)     // Catch:{ all -> 0x006a }
            monitor-exit(r6)     // Catch:{ all -> 0x006a }
            return
        L_0x002f:
        ...
        L_0x0035:
            ...
            com.google.android.gms.internal.ads.zzbbe r0 = com.google.android.gms.internal.ads.zzbbm.zziA     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbbk r4 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x006a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdtw.zzb():void");
    }

    public final void zzc(zzdtv zzdtv) {
        this.zzf = zzdtv;
    }
}
