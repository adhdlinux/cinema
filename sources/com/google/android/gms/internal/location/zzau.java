...
public final class zzau implements FusedLocationProviderApi {
    ...
    public final LocationAvailability getLocationAvailability(GoogleApiClient googleApiClient) {
        ...
        Preconditions.checkArgument(z2, "GoogleApiClient parameter is required.");
        try {
    ...
    public final PendingResult<Status> setMockMode(GoogleApiClient googleApiClient, boolean z2) {
        return googleApiClient.execute(new zzaq(this, googleApiClient, z2));
    }
