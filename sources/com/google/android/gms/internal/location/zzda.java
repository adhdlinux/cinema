...
public final class zzda extends GmsClient {
    ...
    public final void zzA(boolean z2, TaskCompletionSource taskCompletionSource) throws RemoteException {
        if (zzE(zzm.zzg)) {
            ((zzo) getService()).zzx(z2, new zzcl(this, (Object) null, taskCompletionSource));
            return;
        }
        ((zzo) getService()).zzw(z2);
    ...
    public final void zzy(List list, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        Preconditions.checkArgument(z2, "geofenceRequestIds can't be null nor empty.");
