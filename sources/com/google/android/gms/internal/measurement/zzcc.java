...
public interface zzcc extends IInterface {
    ...
    void getTestFlag(zzcf zzcf, int i2) throws RemoteException;

    void getUserProperties(String str, String str2, boolean z2, zzcf zzcf) throws RemoteException;

    void initForTests(Map map) throws RemoteException;

    void initialize(IObjectWrapper iObjectWrapper, zzcl zzcl, long j2) throws RemoteException;
    ...
    void logEventAndBundle(String str, String str2, Bundle bundle, zzcf zzcf, long j2) throws RemoteException;
    ...
    void onActivitySaveInstanceState(IObjectWrapper iObjectWrapper, zzcf zzcf, long j2) throws RemoteException;
    ...
    void performAction(Bundle bundle, zzcf zzcf, long j2) throws RemoteException;
