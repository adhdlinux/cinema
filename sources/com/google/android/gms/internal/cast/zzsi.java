...
final class zzsi extends zzra implements RandomAccess, zzsm, zztw {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(zzsi.zzb, 0, this.zzb, this.zzc, zzsi.zzc);
            this.zzc = i4;
            this.modCount++;
            return true;
        }
    ...
    /* renamed from: zzf */
    public final zzsm zzg(int i2) {
        if (i2 >= this.zzc) {
            return new zzsi(Arrays.copyOf(this.zzb, i2), this.zzc, true);
        }
    ...
    private zzsi(int[] iArr, int i2, boolean z2) {
        super(z2);
        this.zzb = iArr;
        this.zzc = i2;
    }
