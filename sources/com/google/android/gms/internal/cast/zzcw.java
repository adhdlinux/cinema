...
public final class zzcw extends zzcq {
    ...
    public final void zzd() {
        ...
        int min = Math.min(Math.max(0, ((int) ((((double) this.zzc.getProgress()) / ((double) this.zzc.getMaxProgress())) * ((double) measuredWidth))) - (measuredWidth2 / 2)), measuredWidth - measuredWidth2);
