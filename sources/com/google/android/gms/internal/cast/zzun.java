...
class zzun extends AbstractMap {
    ...
    /* synthetic */ zzun(int i2, zzum zzum) {
        this.zza = i2;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i2 = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((zzuh) this.zzb.get(size)).zza());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
    ...
    public final Object zzl(int i2) {
        zzn();
        Object value = ((zzuh) this.zzb.remove(i2)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzul(this, (zzuk) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzun.zzb()) {
            return entrySet().equals(zzun.entrySet());
        }
        for (int i2 = 0; i2 < zzb2; i2++) {
            if (!zzg(i2).equals(zzun.zzg(i2))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzun.zzc);
        }
        return true;
    }
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzuh) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i3 = 0; i3 < zzb2; i3++) {
            i2 += ((zzuh) this.zzb.get(i3)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i3 = this.zza;
        if (size == i3) {
            zzuh zzuh = (zzuh) this.zzb.remove(i3 - 1);
            zzm().put(zzuh.zza(), zzuh.getValue());
        }
        this.zzb.add(i2, new zzuh(this, comparable, obj));
        return null;
    }
