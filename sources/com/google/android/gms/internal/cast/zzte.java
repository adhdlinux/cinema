...
final class zzte extends zzra implements RandomAccess, zzso, zztw {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(zzte.zzb, 0, this.zzb, this.zzc, zzte.zzc);
            this.zzc = i4;
            this.modCount++;
            return true;
        }
    ...
    public final /* bridge */ /* synthetic */ zzsp zzg(int i2) {
        if (i2 >= this.zzc) {
            return new zzte(Arrays.copyOf(this.zzb, i2), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzte(long[] jArr, int i2, boolean z2) {
        super(z2);
        this.zzb = jArr;
        this.zzc = i2;
    }
