...
final class SsaStyle {
    ...
    static final class Format {
        ...
        public static com.google.android.exoplayer2.text.ssa.SsaStyle.Format a(java.lang.String r17) {
            /*
                r0 = 7
                r1 = r17
    ...
    static final class Overrides {
        ...
        /* renamed from: c  reason: collision with root package name */
        private static final Pattern f27473c = Pattern.compile("\\{([^}]*)\\}");

        /* renamed from: d  reason: collision with root package name */
        private static final Pattern f27474d = Pattern.compile(Util.C("\\\\pos\\((%1$s),(%1$s)\\)", "\\s*\\d+(?:\\.\\d+)?\\s*"));

        /* renamed from: e  reason: collision with root package name */
        private static final Pattern f27475e = Pattern.compile(Util.C("\\\\move\\(%1$s,%1$s,(%1$s),(%1$s)(?:,%1$s,%1$s)?\\)", "\\s*\\d+(?:\\.\\d+)?\\s*"));

        /* renamed from: f  reason: collision with root package name */
        private static final Pattern f27476f = Pattern.compile("\\\\an(\\d+)");

        /* renamed from: a  reason: collision with root package name */
        public final int f27477a;

        /* renamed from: b  reason: collision with root package name */
        public final PointF f27478b;
        ...
        private static int a(String str) {
            Matcher matcher = f27476f.matcher(str);
            if (matcher.find()) {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static com.google.android.exoplayer2.text.ssa.SsaStyle.Overrides b(java.lang.String r5) {
            /*
                java.util.regex.Pattern r0 = f27473c
            ...
            L_0x002b:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.text.ssa.SsaStyle.Overrides.b(java.lang.String):com.google.android.exoplayer2.text.ssa.SsaStyle$Overrides");
        }

        private static PointF c(String str) {
            String str2;
            String str3;
            Matcher matcher = f27474d.matcher(str);
            Matcher matcher2 = f27475e.matcher(str);
            ...
            return new PointF(Float.parseFloat(((String) Assertions.e(str2)).trim()), Float.parseFloat(((String) Assertions.e(str3)).trim()));
        }

        public static String d(String str) {
            return f27473c.matcher(str).replaceAll("");
        }
    }
    ...
    public static SsaStyle b(String str, Format format) {
        ...
        int i4 = format2.f27472k;
        if (length != i4) {
            Log.i("SsaStyle", Util.C("Skipping malformed 'Style:' line (expected %s values, found %s): '%s'", Integer.valueOf(i4), Integer.valueOf(split.length), str2));
            return null;
        }
        try {
            String trim = split[format2.f27462a].trim();
            int i5 = format2.f27463b;
            if (i5 != -1) {
                i2 = e(split[i5].trim());
            } else {
                i2 = -1;
            }
            int i6 = format2.f27464c;
            if (i6 != -1) {
                num = h(split[i6].trim());
            } else {
                num = null;
            }
            int i7 = format2.f27465d;
            if (i7 != -1) {
                num2 = h(split[i7].trim());
            } else {
                num2 = null;
            }
            int i8 = format2.f27466e;
            if (i8 != -1) {
                f2 = i(split[i8].trim());
            } else {
                f2 = -3.4028235E38f;
            }
            int i9 = format2.f27467f;
            if (i9 == -1 || !f(split[i9].trim())) {
                z2 = false;
            } else {
                z2 = true;
            }
            int i10 = format2.f27468g;
            if (i10 == -1 || !f(split[i10].trim())) {
                z3 = false;
            } else {
                z3 = true;
            }
            int i11 = format2.f27469h;
            if (i11 == -1 || !f(split[i11].trim())) {
                z4 = false;
            } else {
                z4 = true;
            }
            int i12 = format2.f27470i;
            if (i12 == -1 || !f(split[i12].trim())) {
                z5 = false;
            } else {
                z5 = true;
            }
            int i13 = format2.f27471j;
            if (i13 != -1) {
                i3 = g(split[i13].trim());
            } else {
                i3 = -1;
            ...
            Log.j("SsaStyle", "Skipping malformed 'Style:' line: '" + str2 + "'", e2);
            return null;
        }
    }
    ...
    private static boolean f(String str) {
        try {
            ...
            Log.j("SsaStyle", "Failed to parse boolean value: '" + str + "'", e2);
            return false;
        }
    }
    ...
    public static Integer h(String str) {
        ...
        try {
            ...
            Log.j("SsaStyle", "Failed to parse color expression: '" + str + "'", e2);
            return null;
        }
    }
    ...
    private static float i(String str) {
        try {
            ...
            Log.j("SsaStyle", "Failed to parse font size: '" + str + "'", e2);
