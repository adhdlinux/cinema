...
public final class MediaCodecUtil {
    ...
    private static final Pattern f25331a = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap<CodecKey, List<MediaCodecInfo>> f25332b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private static int f25333c = -1;
    ...
    private static final class CodecKey {
        ...
        public boolean equals(Object obj) {
            ...
            if (TextUtils.equals(this.f25334a, codecKey.f25334a) && this.f25335b == codecKey.f25335b && this.f25336c == codecKey.f25336c) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            int i2;
            int hashCode = (this.f25334a.hashCode() + 31) * 31;
            int i3 = 1231;
            if (this.f25335b) {
                i2 = 1231;
            } else {
    ...
    private static final class MediaCodecListCompatV21 implements MediaCodecListCompat {
        ...
        /* renamed from: b  reason: collision with root package name */
        private MediaCodecInfo[] f25338b;
        ...
        private void f() {
            if (this.f25338b == null) {
                this.f25338b = new MediaCodecList(this.f25337a).getCodecInfos();
            }
        }

        public MediaCodecInfo a(int i2) {
            f();
            return this.f25338b[i2];
        }
    ...
    private static boolean A(MediaCodecInfo mediaCodecInfo) {
        return Util.f28808a >= 29 && B(mediaCodecInfo);
    }
    ...
    private static boolean C(MediaCodecInfo mediaCodecInfo, String str, boolean z2, String str2) {
        ...
        if (i2 < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            ...
            if ("a70".equals(str3) || ("Xiaomi".equals(Util.f28810c) && str3.startsWith("HM"))) {
                return false;
            }
        }
        if (i2 == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
            String str4 = Util.f28809b;
            if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                return false;
            }
        }
        if (i2 == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
            String str5 = Util.f28809b;
            if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                return false;
            }
        }
        if (i2 < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(Util.f28810c))) {
            String str6 = Util.f28809b;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i2 <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(Util.f28810c)) {
            String str7 = Util.f28809b;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i2 <= 19 && Util.f28809b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
    ...
    private static boolean F(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        if (com.google.android.exoplayer2.util.MimeTypes.o(str)) {
            return true;
        }
    ...
    public static /* synthetic */ int J(MediaCodecInfo mediaCodecInfo) {
        ...
        if (Util.f28808a >= 26 || !str.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
            return 0;
        }
        return -1;
    }
    ...
    public static /* synthetic */ int K(MediaCodecInfo mediaCodecInfo) {
        return mediaCodecInfo.f25273a.startsWith("OMX.google") ? 1 : 0;
    }
    ...
    public static int N() throws DecoderQueryException {
        ...
        if (f25333c == -1) {
            int i3 = 0;
            MediaCodecInfo r2 = r(MimeTypes.VIDEO_H264, false, false);
            if (r2 != null) {
                MediaCodecInfo.CodecProfileLevel[] h2 = r2.h();
                int length = h2.length;
                int i4 = 0;
                while (i3 < length) {
                    i4 = Math.max(h(h2[i3].level), i4);
                    i3++;
                }
                if (Util.f28808a >= 21) {
                    i2 = 345600;
    ...
    private static <T> void P(List<T> list, ScoreProvider<T> scoreProvider) {
        Collections.sort(list, new i(scoreProvider));
    }
    ...
    private static void e(String str, List<MediaCodecInfo> list) {
        if ("audio/raw".equals(str)) {
            if (Util.f28808a < 26 && Util.f28809b.equals("R9") && list.size() == 1 && list.get(0).f25273a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                list.add(MediaCodecInfo.F("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false, false));
            }
            P(list, new f());
        }
        int i2 = Util.f28808a;
        if (i2 < 21 && list.size() > 1) {
            String str2 = list.get(0).f25273a;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                P(list, new g());
            }
        }
        if (i2 < 32 && list.size() > 1 && "OMX.qti.audio.decoder.flac".equals(list.get(0).f25273a)) {
    ...
    private static Pair<Integer, Integer> l(String str, String[] strArr) {
        ...
        try {
            if ("audio/mp4a-latm".equals(com.google.android.exoplayer2.util.MimeTypes.h(Integer.parseInt(strArr[1], 16))) && (O = O(Integer.parseInt(strArr[2]))) != -1) {
    ...
    public static String m(Format format) {
        ...
        if ("audio/eac3-joc".equals(format.f23071m)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(format.f23071m) || (q2 = q(format)) == null) {
            return null;
        }
    ...
    private static Pair<Integer, Integer> n(String str, String[] strArr, ColorInfo colorInfo) {
        int i2;
        if (strArr.length < 4) {
            Log.i("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i3 = 1;
        try {
            ...
            if (parseInt != 0) {
                Log.i("MediaCodecUtil", "Unknown AV1 profile: " + parseInt);
                return null;
            } else if (parseInt3 == 8 || parseInt3 == 10) {
                if (parseInt3 != 8) {
                    if (colorInfo == null || !(colorInfo.f28847e != null || (i2 = colorInfo.f28846d) == 7 || i2 == 6)) {
                        i3 = 2;
                    } else {
                ...
                Log.i("MediaCodecUtil", "Unknown AV1 level: " + parseInt2);
                return null;
            } else {
                Log.i("MediaCodecUtil", "Unknown AV1 bit depth: " + parseInt3);
                return null;
            }
        } catch (NumberFormatException unused) {
            Log.i("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
    ...
    private static Pair<Integer, Integer> o(String str, String[] strArr) {
        ...
        try {
            ...
            int i4 = i(i3);
            if (i4 == -1) {
                Log.i("MediaCodecUtil", "Unknown AVC profile: " + i3);
                return null;
            }
            int g2 = g(i2);
            if (g2 != -1) {
            ...
            Log.i("MediaCodecUtil", "Unknown AVC level: " + i2);
            return null;
        } catch (NumberFormatException unused) {
            Log.i("MediaCodecUtil", "Ignoring malformed AVC codec string: " + str);
            return null;
    ...
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> q(com.google.android.exoplayer2.Format r6) {
        /*
            java.lang.String r0 = r6.f23068j
            r1 = 0
        ...
        L_0x0006:
            ...
            java.lang.String r3 = r6.f23071m
            boolean r2 = r2.equals(r3)
            if (r2 == 0) goto L_0x001d
            java.lang.String r6 = r6.f23068j
        ...
        L_0x0083:
            ...
            return r6
        L_0x008a:
            java.lang.String r1 = r6.f23068j
            com.google.android.exoplayer2.video.ColorInfo r6 = r6.f23083y
    ...
    public static MediaCodecInfo r(String str, boolean z2, boolean z3) throws DecoderQueryException {
        List<MediaCodecInfo> s2 = s(str, z2, z3);
        if (s2.isEmpty()) {
            return null;
        }
        return s2.get(0);
    ...
    public static synchronized List<MediaCodecInfo> s(String str, boolean z2, boolean z3) throws DecoderQueryException {
        MediaCodecListCompat mediaCodecListCompat;
        synchronized (MediaCodecUtil.class) {
            CodecKey codecKey = new CodecKey(str, z2, z3);
            HashMap<CodecKey, List<MediaCodecInfo>> hashMap = f25332b;
            ...
            ArrayList<MediaCodecInfo> t2 = t(codecKey, mediaCodecListCompat);
            if (z2 && t2.isEmpty() && 21 <= i2 && i2 <= 23) {
                t2 = t(codecKey, new MediaCodecListCompatV16());
                if (!t2.isEmpty()) {
                    Log.i("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + t2.get(0).f25273a);
                }
            }
            e(str, t2);
            ImmutableList<MediaCodecInfo> n2 = ImmutableList.n(t2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x007f, code lost:
        if (r1.f25335b == false) goto L_0x0081;
     */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.ArrayList<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> t(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.CodecKey r24, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat r25) throws com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException {
        /*
            r1 = r24
            r2 = r25
            ...
            java.lang.String r15 = r1.f25334a     // Catch:{ Exception -> 0x014f }
        ...
        L_0x003f:
            ...
            boolean r8 = r1.f25336c     // Catch:{ Exception -> 0x00ef }
        ...
        L_0x0056:
            ...
            boolean r8 = r1.f25335b     // Catch:{ Exception -> 0x00ef }
        ...
        L_0x0069:
            ...
            boolean r7 = r1.f25335b     // Catch:{ Exception -> 0x00ef }
            if (r7 == r6) goto L_0x0081
        L_0x007b:
            if (r13 != 0) goto L_0x00b3
            boolean r7 = r1.f25335b     // Catch:{ Exception -> 0x00a8 }
        ...
        L_0x0081:
            ...
            r18 = r14
            r14 = r19
            com.google.android.exoplayer2.mediacodec.MediaCodecInfo r0 = com.google.android.exoplayer2.mediacodec.MediaCodecInfo.F(r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ Exception -> 0x00a4 }
        ...
        L_0x00b3:
            ...
            r1 = r14
            r14 = r19
            com.google.android.exoplayer2.mediacodec.MediaCodecInfo r0 = com.google.android.exoplayer2.mediacodec.MediaCodecInfo.F(r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ Exception -> 0x00ea }
        ...
        L_0x00ef:
            ...
            r18 = r14
        L_0x00f9:
            int r6 = com.google.android.exoplayer2.util.Util.f28808a     // Catch:{ Exception -> 0x014f }
            r7 = 23
            ...
            com.google.android.exoplayer2.util.Log.c(r8, r0)     // Catch:{ Exception -> 0x014f }
        L_0x0120:
            int r12 = r22 + 1
            r1 = r24
            r14 = r18
        ...
        L_0x012a:
            ...
            com.google.android.exoplayer2.util.Log.c(r8, r1)     // Catch:{ Exception -> 0x014f }
        ...
        L_0x014f:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.t(com.google.android.exoplayer2.mediacodec.MediaCodecUtil$CodecKey, com.google.android.exoplayer2.mediacodec.MediaCodecUtil$MediaCodecListCompat):java.util.ArrayList");
    }

    public static List<MediaCodecInfo> u(List<MediaCodecInfo> list, Format format) {
        ArrayList arrayList = new ArrayList(list);
        P(arrayList, new h(format));
        return arrayList;
    }
    ...
    private static Pair<Integer, Integer> w(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        Matcher matcher = f25331a.matcher(strArr[1]);
        if (!matcher.matches()) {
            Log.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        Integer k2 = k(group);
        if (k2 == null) {
            Log.i("MediaCodecUtil", "Unknown Dolby Vision profile string: " + group);
            return null;
        }
        ...
        Log.i("MediaCodecUtil", "Unknown Dolby Vision level string: " + str2);
        return null;
    }

    private static Pair<Integer, Integer> x(String str, String[] strArr, ColorInfo colorInfo) {
        if (strArr.length < 4) {
            Log.i("MediaCodecUtil", "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i2 = 1;
        Matcher matcher = f25331a.matcher(strArr[1]);
        ...
        if (!"1".equals(group)) {
            if (!TraktV2.API_VERSION.equals(group)) {
                Log.i("MediaCodecUtil", "Unknown HEVC profile string: " + group);
                return null;
            } else if (colorInfo == null || colorInfo.f28846d != 6) {
                i2 = 2;
            } else {
        ...
        Integer z2 = z(str2);
        if (z2 != null) {
            return new Pair<>(Integer.valueOf(i2), z2);
        }
        Log.i("MediaCodecUtil", "Unknown HEVC level string: " + str2);
        return null;
    }

    private static Pair<Integer, Integer> y(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.i("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            int parseInt = Integer.parseInt(strArr[1]);
            ...
            int R = R(parseInt);
            if (R == -1) {
                Log.i("MediaCodecUtil", "Unknown VP9 profile: " + parseInt);
                return null;
            }
            int Q = Q(parseInt2);
            if (Q != -1) {
            ...
            Log.i("MediaCodecUtil", "Unknown VP9 level: " + parseInt2);
            return null;
        } catch (NumberFormatException unused) {
            Log.i("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
