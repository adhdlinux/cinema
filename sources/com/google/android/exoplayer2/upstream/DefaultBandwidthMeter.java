...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> f28367p = ImmutableList.v(4400000L, 3200000L, 2300000L, 1600000L, 810000L);

    /* renamed from: q  reason: collision with root package name */
    public static final ImmutableList<Long> f28368q = ImmutableList.v(1400000L, 990000L, 730000L, 510000L, 230000L);

    /* renamed from: r  reason: collision with root package name */
    public static final ImmutableList<Long> f28369r = ImmutableList.v(2100000L, 1400000L, 1000000L, 890000L, 640000L);

    /* renamed from: s  reason: collision with root package name */
    public static final ImmutableList<Long> f28370s = ImmutableList.v(2600000L, 1700000L, 1300000L, 1000000L, 700000L);

    /* renamed from: t  reason: collision with root package name */
    public static final ImmutableList<Long> f28371t = ImmutableList.v(5700000L, 3700000L, 2300000L, 1700000L, 990000L);

    /* renamed from: u  reason: collision with root package name */
    public static final ImmutableList<Long> f28372u = ImmutableList.v(2800000L, 1800000L, 1400000L, 1100000L, 870000L);

    /* renamed from: v  reason: collision with root package name */
    private static DefaultBandwidthMeter f28373v;

    /* renamed from: a  reason: collision with root package name */
    private final ImmutableMap<Integer, Long> f28374a;

    /* renamed from: b  reason: collision with root package name */
    private final BandwidthMeter.EventListener.EventDispatcher f28375b;

    /* renamed from: c  reason: collision with root package name */
    private final SlidingPercentile f28376c;

    /* renamed from: d  reason: collision with root package name */
    private final Clock f28377d;
    ...
    private long f28381h;

    /* renamed from: i  reason: collision with root package name */
    private int f28382i;

    /* renamed from: j  reason: collision with root package name */
    private long f28383j;
    ...
    public static final class Builder {
        ...
        /* renamed from: b  reason: collision with root package name */
        private Map<Integer, Long> f28390b;

        /* renamed from: c  reason: collision with root package name */
        private int f28391c;

        /* renamed from: d  reason: collision with root package name */
        private Clock f28392d;
        ...
        public Builder(Context context) {
            ...
            this.f28389a = context2;
            this.f28390b = b(Util.N(context));
            this.f28391c = 2000;
            this.f28392d = Clock.f28651a;
            this.f28393e = true;
        }

        private static Map<Integer, Long> b(String str) {
            int[] k2 = DefaultBandwidthMeter.l(str);
            HashMap hashMap = new HashMap(8);
            hashMap.put(0, 1000000L);
            ImmutableList<Long> immutableList = DefaultBandwidthMeter.f28367p;
            hashMap.put(2, immutableList.get(k2[0]));
            hashMap.put(3, DefaultBandwidthMeter.f28368q.get(k2[1]));
            hashMap.put(4, DefaultBandwidthMeter.f28369r.get(k2[2]));
            hashMap.put(5, DefaultBandwidthMeter.f28370s.get(k2[3]));
            hashMap.put(10, DefaultBandwidthMeter.f28371t.get(k2[4]));
            hashMap.put(9, DefaultBandwidthMeter.f28372u.get(k2[5]));
            hashMap.put(7, immutableList.get(k2[0]));
            return hashMap;
        }

        public DefaultBandwidthMeter a() {
            return new DefaultBandwidthMeter(this.f28389a, this.f28390b, this.f28391c, this.f28392d, this.f28393e);
        }
    }
    ...
    private long m(int i2) {
        Long l2 = this.f28374a.get(Integer.valueOf(i2));
        if (l2 == null) {
            l2 = this.f28374a.get(0);
        }
        if (l2 == null) {
            l2 = 1000000L;
        }
    ...
    public static synchronized DefaultBandwidthMeter n(Context context) {
        ...
        synchronized (DefaultBandwidthMeter.class) {
            if (f28373v == null) {
                f28373v = new Builder(context).a();
            }
            defaultBandwidthMeter = f28373v;
        }
    ...
    private void p(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.f28386m) {
            this.f28386m = j3;
            this.f28375b.c(i2, j2, j3);
        }
    }
    ...
    public synchronized void q(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f28382i     // Catch:{ all -> 0x0055 }
            if (r0 == 0) goto L_0x000b
            boolean r1 = r8.f28378e     // Catch:{ all -> 0x0055 }
            if (r1 != 0) goto L_0x000b
            monitor-exit(r8)
            return
        L_0x000b:
            boolean r1 = r8.f28387n     // Catch:{ all -> 0x0055 }
            if (r1 == 0) goto L_0x0011
            int r9 = r8.f28388o     // Catch:{ all -> 0x0055 }
        L_0x0011:
            if (r0 != r9) goto L_0x0015
            monitor-exit(r8)
            return
        L_0x0015:
            r8.f28382i = r9     // Catch:{ all -> 0x0055 }
            r0 = 1
        ...
        L_0x0021:
            ...
            r8.f28385l = r0     // Catch:{ all -> 0x0055 }
            com.google.android.exoplayer2.util.Clock r9 = r8.f28377d     // Catch:{ all -> 0x0055 }
            long r0 = r9.elapsedRealtime()     // Catch:{ all -> 0x0055 }
            int r9 = r8.f28379f     // Catch:{ all -> 0x0055 }
            if (r9 <= 0) goto L_0x0038
            long r2 = r8.f28380g     // Catch:{ all -> 0x0055 }
            long r2 = r0 - r2
        ...
        L_0x0038:
            ...
            r3 = 0
        L_0x003a:
            long r4 = r8.f28381h     // Catch:{ all -> 0x0055 }
            long r6 = r8.f28385l     // Catch:{ all -> 0x0055 }
            r2 = r8
            r2.p(r3, r4, r6)     // Catch:{ all -> 0x0055 }
            r8.f28380g = r0     // Catch:{ all -> 0x0055 }
            r0 = 0
            r8.f28381h = r0     // Catch:{ all -> 0x0055 }
            r8.f28384k = r0     // Catch:{ all -> 0x0055 }
            r8.f28383j = r0     // Catch:{ all -> 0x0055 }
            com.google.android.exoplayer2.upstream.SlidingPercentile r9 = r8.f28376c     // Catch:{ all -> 0x0055 }
        ...
        L_0x0055:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.upstream.DefaultBandwidthMeter.q(int):void");
    }
    ...
    public synchronized void d(DataSource dataSource, DataSpec dataSpec, boolean z2) {
        boolean z3;
        if (o(dataSpec, z2)) {
            if (this.f28379f > 0) {
                z3 = true;
            ...
            Assertions.g(z3);
            long elapsedRealtime = this.f28377d.elapsedRealtime();
            int i2 = (int) (elapsedRealtime - this.f28380g);
            this.f28383j += (long) i2;
            long j2 = this.f28384k;
            long j3 = this.f28381h;
            this.f28384k = j2 + j3;
            if (i2 > 0) {
                this.f28376c.c((int) Math.sqrt((double) j3), (((float) j3) * 8000.0f) / ((float) i2));
                if (this.f28383j >= 2000 || this.f28384k >= PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED) {
                    this.f28385l = (long) this.f28376c.f(0.5f);
                }
                p(i2, this.f28381h, this.f28385l);
                this.f28380g = elapsedRealtime;
                this.f28381h = 0;
            }
            this.f28379f--;
        }
    ...
    public void g(Handler handler, BandwidthMeter.EventListener eventListener) {
        ...
        this.f28375b.b(handler, eventListener);
    }

    public synchronized void h(DataSource dataSource, DataSpec dataSpec, boolean z2) {
        if (o(dataSpec, z2)) {
            if (this.f28379f == 0) {
                this.f28380g = this.f28377d.elapsedRealtime();
            }
            this.f28379f++;
        }
    }
    ...
    public DefaultBandwidthMeter() {
        this((Context) null, ImmutableMap.k(), 2000, Clock.f28651a, false);
    }

    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int i2, Clock clock, boolean z2) {
        this.f28374a = ImmutableMap.d(map);
        this.f28375b = new BandwidthMeter.EventListener.EventDispatcher();
        this.f28376c = new SlidingPercentile(i2);
        this.f28377d = clock;
        this.f28378e = z2;
        if (context != null) {
