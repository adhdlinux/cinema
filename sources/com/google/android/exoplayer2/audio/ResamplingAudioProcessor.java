...
final class ResamplingAudioProcessor extends BaseAudioProcessor {
    ...
    public void c(java.nio.ByteBuffer r10) {
        /*
            ...
            int r1 = r10.limit()
            int r2 = r1 - r0
            com.google.android.exoplayer2.audio.AudioProcessor$AudioFormat r3 = r9.f23736b
            int r3 = r3.f23684c
        ...
        L_0x008a:
            ...
            float r3 = com.google.android.exoplayer2.util.Util.p(r3, r4, r5)
        ...
        L_0x00c5:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.audio.ResamplingAudioProcessor.c(java.nio.ByteBuffer):void");
    }
    ...
    public AudioProcessor.AudioFormat g(AudioProcessor.AudioFormat audioFormat) throws AudioProcessor.UnhandledAudioFormatException {
        ...
        if (i2 != 3 && i2 != 2 && i2 != 268435456 && i2 != 536870912 && i2 != 805306368 && i2 != 4) {
            ...
            return new AudioProcessor.AudioFormat(audioFormat.f23682a, audioFormat.f23683b, 2);
        } else {
