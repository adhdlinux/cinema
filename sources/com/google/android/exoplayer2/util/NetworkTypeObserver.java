...
public final class NetworkTypeObserver {
    ...
    private static NetworkTypeObserver f28750e;

    /* renamed from: a  reason: collision with root package name */
    private final Handler f28751a = new Handler(Looper.getMainLooper());

    /* renamed from: b  reason: collision with root package name */
    private final CopyOnWriteArrayList<WeakReference<Listener>> f28752b = new CopyOnWriteArrayList<>();

    /* renamed from: c  reason: collision with root package name */
    private final Object f28753c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private int f28754d = 0;
    ...
    private static final class Api31 {
        ...
        private static final class DisplayInfoCallback extends TelephonyCallback implements TelephonyCallback.DisplayInfoListener {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final NetworkTypeObserver f28755a;

            public DisplayInfoCallback(NetworkTypeObserver networkTypeObserver) {
                this.f28755a = networkTypeObserver;
            }
            ...
            public void onDisplayInfoChanged(TelephonyDisplayInfo telephonyDisplayInfo) {
                ...
                NetworkTypeObserver networkTypeObserver = this.f28755a;
                if (z2) {
                    i2 = 10;
                }
    ...
    public static synchronized NetworkTypeObserver d(Context context) {
        ...
        synchronized (NetworkTypeObserver.class) {
            if (f28750e == null) {
                f28750e = new NetworkTypeObserver(context);
            }
            networkTypeObserver = f28750e;
        }
    ...
    private void j() {
        Iterator<WeakReference<Listener>> it2 = this.f28752b.iterator();
        while (it2.hasNext()) {
            WeakReference next = it2.next();
            if (next.get() == null) {
                this.f28752b.remove(next);
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x002a, code lost:
        r3.f28752b.remove(r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0030, code lost:
        return;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x000c, code lost:
        r0 = r3.f28752b.iterator();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void k(int r4) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.f28753c
            monitor-enter(r0)
            int r1 = r3.f28754d     // Catch:{ all -> 0x0031 }
            if (r1 != r4) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0031 }
            return
        L_0x0009:
            r3.f28754d = r4     // Catch:{ all -> 0x0031 }
            monitor-exit(r0)     // Catch:{ all -> 0x0031 }
            java.util.concurrent.CopyOnWriteArrayList<java.lang.ref.WeakReference<com.google.android.exoplayer2.util.NetworkTypeObserver$Listener>> r0 = r3.f28752b
        ...
        L_0x0012:
            ...
            goto L_0x0012
        L_0x002a:
            java.util.concurrent.CopyOnWriteArrayList<java.lang.ref.WeakReference<com.google.android.exoplayer2.util.NetworkTypeObserver$Listener>> r2 = r3.f28752b
            r2.remove(r1)
            goto L_0x0012
        L_0x0030:
            return
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.util.NetworkTypeObserver.k(int):void");
    }
    ...
    public void i(Listener listener) {
        j();
        this.f28752b.add(new WeakReference(listener));
        this.f28751a.post(new c(this, listener));
    }
}
