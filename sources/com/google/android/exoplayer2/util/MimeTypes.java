...
public final class MimeTypes {
    ...
    private static final ArrayList<CustomMimeType> f28709a = new ArrayList<>();

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f28710b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    private static String e(String str) {
        int size = f28709a.size();
        for (int i2 = 0; i2 < size; i2++) {
            CustomMimeType customMimeType = f28709a.get(i2);
            if (str.startsWith(customMimeType.f28712b)) {
                return customMimeType.f28711a;
            }
        }
        return null;
    }
    ...
    static Mp4aObjectType i(String str) {
        int i2;
        Matcher matcher = f28710b.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
    ...
    private static int l(String str) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            CustomMimeType customMimeType = f28709a.get(i2);
            if (str.equals(customMimeType.f28711a)) {
                return customMimeType.f28713c;
            }
        }
        return -1;
    }
