...
public final class SntpClient {
    ...
    public static final Object f28785a = new Object();
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public static final Object f28786b = new Object();
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public static boolean f28787c = false;
    /* access modifiers changed from: private */

    /* renamed from: d  reason: collision with root package name */
    public static long f28788d = 0;

    /* renamed from: e  reason: collision with root package name */
    private static String f28789e = "time.android.com";
    ...
    private static final class NtpTimeCallback implements Loader.Callback<Loader.Loadable> {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final InitializationCallback f28790b;

        public NtpTimeCallback(InitializationCallback initializationCallback) {
            this.f28790b = initializationCallback;
        }

        public void p(Loader.Loadable loadable, long j2, long j3, boolean z2) {
        }

        public void q(Loader.Loadable loadable, long j2, long j3) {
            if (this.f28790b == null) {
                return;
            }
            if (!SntpClient.k()) {
                this.f28790b.a(new IOException(new ConcurrentModificationException()));
            } else {
                this.f28790b.b();
            }
        }

        public Loader.LoadErrorAction t(Loader.Loadable loadable, long j2, long j3, IOException iOException, int i2) {
            InitializationCallback initializationCallback = this.f28790b;
    ...
    private static final class NtpTimeLoadable implements Loader.Loadable {
        ...
        public void a() throws IOException {
            synchronized (SntpClient.f28785a) {
                synchronized (SntpClient.f28786b) {
                    if (!SntpClient.f28787c) {
                        long e2 = SntpClient.l();
                        synchronized (SntpClient.f28786b) {
                            long unused = SntpClient.f28788d = e2;
                            boolean unused2 = SntpClient.f28787c = true;
                        }
                    }
                }
            }
