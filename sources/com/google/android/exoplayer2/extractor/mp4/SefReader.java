...
final class SefReader {
    ...
    private static final Splitter f24650d = Splitter.d(':');

    /* renamed from: e  reason: collision with root package name */
    private static final Splitter f24651e = Splitter.d('*');

    /* renamed from: a  reason: collision with root package name */
    private final List<DataReference> f24652a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private int f24653b = 0;
    ...
    private void a(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        this.f24654c = parsableByteArray.u() + 8;
        if (parsableByteArray.q() != 1397048916) {
            positionHolder.f24231a = 0;
            return;
        }
        positionHolder.f24231a = extractorInput.getPosition() - ((long) (this.f24654c - 12));
        this.f24653b = 2;
    }
    ...
    private void d(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        for (int i3 = 0; i3 < i2 / 12; i3++) {
            ...
            if (w2 == 2192 || w2 == 2816 || w2 == 2817 || w2 == 2819 || w2 == 2820) {
                this.f24652a.add(new DataReference(w2, (length - ((long) this.f24654c)) - ((long) parsableByteArray.u()), parsableByteArray.u()));
            } else {
        ...
        this.f24653b = 3;
        positionHolder.f24231a = this.f24652a.get(0).f24656b;
    }

    private void e(ExtractorInput extractorInput, List<Metadata.Entry> list) throws IOException {
        long position = extractorInput.getPosition();
        int length = (int) ((extractorInput.getLength() - extractorInput.getPosition()) - ((long) this.f24654c));
        ParsableByteArray parsableByteArray = new ParsableByteArray(length);
        extractorInput.readFully(parsableByteArray.e(), 0, length);
        for (int i2 = 0; i2 < this.f24652a.size(); i2++) {
            DataReference dataReference = this.f24652a.get(i2);
            parsableByteArray.U((int) (dataReference.f24656b - position));
            parsableByteArray.V(4);
            int u2 = parsableByteArray.u();
            int b2 = b(parsableByteArray.E(u2));
            int i3 = dataReference.f24657c - (u2 + 8);
            if (b2 == 2192) {
    ...
    private static SlowMotionData f(ParsableByteArray parsableByteArray, int i2) throws ParserException {
        ...
        List<String> f2 = f24651e.f(parsableByteArray.E(i2));
        int i3 = 0;
        while (i3 < f2.size()) {
            List<String> f3 = f24650d.f(f2.get(i3));
            if (f3.size() == 3) {
                try {
