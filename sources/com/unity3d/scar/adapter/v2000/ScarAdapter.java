...
public class ScarAdapter extends ScarAdapterBase {
    ...
    private SignalsStorage<QueryInfo> f37132e;
    ...
    public void d(Context context, final ScarAdMetadata scarAdMetadata, IScarRewardedAdListenerWrapper iScarRewardedAdListenerWrapper) {
        final ScarRewardedAd scarRewardedAd = new ScarRewardedAd(context, this.f37132e.a(scarAdMetadata.c()), scarAdMetadata, this.f37047d, iScarRewardedAdListenerWrapper);
    ...
    public void e(Context context, final ScarAdMetadata scarAdMetadata, IScarInterstitialAdListenerWrapper iScarInterstitialAdListenerWrapper) {
        final ScarInterstitialAd scarInterstitialAd = new ScarInterstitialAd(context, this.f37132e.a(scarAdMetadata.c()), scarAdMetadata, this.f37047d, iScarInterstitialAdListenerWrapper);
        Utils.a(new Runnable() {
            public void run() {
