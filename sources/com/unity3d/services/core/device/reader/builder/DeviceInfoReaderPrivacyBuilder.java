...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList(new String[]{"privacy", GDPR.GDPR_STANDARD, "unity", "pipl"}), Collections.singletonList(AppMeasurementSdk.ConditionalUserProperty.VALUE), Arrays.asList(new String[]{HlsSegmentFormat.TS, "exclude", "mode"}));
    }
