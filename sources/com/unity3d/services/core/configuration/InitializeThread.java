...
public class InitializeThread extends Thread {
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        public InitializeState executeLegacy(Configuration configuration) {
            ...
            try {
                ...
                if (configuration.getExperiments().isNativeWebViewCacheEnabled()) {
                    initializeState = new InitializeStateCreateWithRemote(configuration);
                } else {
                    initializeState = new InitializeStateLoadCache(configuration);
                }
                this._nextState = initializeState;
                ...
                privacyConfigurationLoader.loadConfiguration(new IConfigurationLoaderListener() {
                    ...
                    public void onSuccess(Configuration configuration) {
                        ...
                        if (isNativeWebViewCacheEnabled) {
                            initializeState = new InitializeStateCreateWithRemote(initializeStateConfig2._configuration);
                        } else {
                            initializeState = new InitializeStateLoadCache(initializeStateConfig2._configuration);
                        }
                        InitializeState unused3 = initializeStateConfig2._nextState = initializeState;
                    }
                });
                return this._nextState;
            } catch (Exception e2) {
        ...
        public InitializeState execute() {
            ...
            if (currentApp != null) {
                ...
                if (currentApp.getWebView() != null) {
                    ...
                    z2 = conditionVariable.block((long) this._resetWebAppTimeout);
                } else {
                    z2 = true;
                }
                if (!z2) {
    ...
    public static class InitializeStateRetry extends InitializeState {
        ...
        public InitializeStateRetry(InitializeState initializeState, long j2) {
            super();
