...
public class Configuration {
    ...
    private void setOptionalFields(JSONObject jSONObject, boolean z2) {
        ...
        this._loadTimeout = jSONObject.optInt("lto", HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT);
