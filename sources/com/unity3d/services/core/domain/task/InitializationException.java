...
public final class InitializationException extends Exception {
    ...
    public InitializationException(ErrorState errorState2, Exception exc, Configuration configuration) {
        ...
        Intrinsics.f(exc, "originalException");
    ...
    public static /* synthetic */ InitializationException copy$default(InitializationException initializationException, ErrorState errorState2, Exception exc, Configuration configuration, int i2, Object obj) {
        if ((i2 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.errorState == initializationException.errorState && Intrinsics.a(this.originalException, initializationException.originalException) && Intrinsics.a(this.config, initializationException.config);
    }
