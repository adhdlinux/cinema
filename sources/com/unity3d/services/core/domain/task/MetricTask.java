...
public abstract class MetricTask<P extends BaseParams, R> implements BaseTask<P, R> {
    ...
    private final void captureMetric(R r2) {
        String str = "success";
        if ((r2 instanceof Result) && !Result.h(((Result) r2).j())) {
            str = "failure";
        }
        this.taskStatus = str;
        sendMetric();
    ...
    private final Map<String, String> getMetricTagsForState() {
        ...
        Intrinsics.e(retryTags, "getInstance().retryTags");
        return retryTags;
    }

    private final SDKMetricsSender getSDKMetrics() {
        return (SDKMetricsSender) getServiceProvider().getRegistry().getService("", Reflection.b(SDKMetricsSender.class));
    }
    ...
    static /* synthetic */ java.lang.Object invoke$suspendImpl(com.unity3d.services.core.domain.task.MetricTask<? super P, R> r8, P r9, kotlin.coroutines.Continuation<? super R> r10) {
        /*
    ...
    public final String getMetricNameForTask(Object obj) {
        boolean z2;
        Intrinsics.f(obj, "task");
        String simpleName = obj.getClass().getSimpleName();
        Intrinsics.e(simpleName, "className");
    ...
    public Object invoke(P p2, Continuation<? super R> continuation) {
        return invoke$suspendImpl(this, p2, continuation);
    }
