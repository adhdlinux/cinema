...
public class WebRequest {
    ...
    public WebRequest(String str, String str2, Map<String, List<String>> map) throws MalformedURLException {
        this(str, str2, map, HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT, HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT);
    }
    ...
    public WebRequest(String str, String str2, Map<String, List<String>> map, int i2, int i3) throws MalformedURLException {
