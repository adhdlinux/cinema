...
public class TSIMetric {
    ...
    public static Metric newConfigRequestLatencyFailure(Long l2) {
        return new Metric(TSI_METRIC_CONFIG_REQUEST_FAILURE, l2);
    }

    public static Metric newConfigRequestLatencySuccess(Long l2) {
        return new Metric(TSI_METRIC_CONFIG_REQUEST_SUCCESS, l2);
    }

    public static Metric newDeviceInfoCollectionLatency(Long l2) {
        return new Metric(TSI_METRIC_COLLECTION_LATENCY, l2);
    }

    public static Metric newDeviceInfoCompressionLatency(Long l2) {
        return new Metric(TSI_METRIC_COMPRESSION_LATENCY, l2);
    }
    ...
    public static Metric newInitStarted() {
        return new Metric(TSI_METRIC_INIT_STARTED, (Object) null);
    }
    ...
    public static Metric newPrivacyRequestLatencyFailure(Long l2) {
        return new Metric(TSI_METRIC_PRIVACY_REQUEST_FAILURE, l2);
    }

    public static Metric newPrivacyRequestLatencySuccess(Long l2) {
        return new Metric(TSI_METRIC_PRIVACY_REQUEST_SUCCESS, l2);
    }

    public static Metric newPrivacyResolutionRequestLatencyFailure(Long l2) {
        return new Metric(TSI_METRIC_PRIVACY_RESOLUTION_FAILURE, l2);
    }

    public static Metric newPrivacyResolutionRequestLatencySuccess(Long l2) {
        return new Metric(TSI_METRIC_PRIVACY_RESOLUTION_SUCCESS, l2);
    }

    public static Metric newTokenAvailabilityLatencyConfig(Long l2, Map<String, String> map) {
        return new Metric(TSI_METRIC_TOKEN_CONFIG, l2, map);
    }

    public static Metric newTokenAvailabilityLatencyWebview(Long l2, Map<String, String> map) {
        return new Metric(TSI_METRIC_TOKEN_WEBVIEW, l2, map);
    }

    public static Metric newTokenResolutionRequestLatency(Long l2, Map<String, String> map) {
        return new Metric(TSI_METRIC_TOKEN_RESOLUTION, l2, map);
    }
}
