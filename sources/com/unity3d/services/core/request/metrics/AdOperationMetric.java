...
public class AdOperationMetric {
    ...
    private static HashMap<String, String> getTags(AdOperationError adOperationError, boolean z2, boolean z3) {
        String str;
        String str2;
        if (adOperationError == null) {
            str = UNKNOWN;
        } else {
            str = adOperationError.toString();
        }
        if (z3) {
            str2 = "banner";
        } else {
        ...
        return new HashMap<String, String>(z2, str, str2) {
...

            {
                ...
                put(AdOperationMetric.AD_LOAD_TYPE, r3);
            }
        };
    }

    private static AdOperationError mapUnityAdsLoadError(UnityAds.UnityAdsLoadError unityAdsLoadError) {
        int i2 = AnonymousClass2.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsLoadError[unityAdsLoadError.ordinal()];
        if (i2 == 1) {
    ...
    public static Metric newAdLoadFailure(AdOperationError adOperationError, Long l2, boolean z2) {
        return new Metric(AD_LOAD_FAIL, l2, getTags(adOperationError, true, z2));
    }

    public static Metric newAdLoadStart() {
        return new Metric(AD_LOAD_START, (Object) null);
    }

    public static Metric newAdLoadSuccess(Long l2, boolean z2) {
        return new Metric(AD_LOAD_SUCCESS, l2, getTags((AdOperationError) null, false, z2));
    }

    public static Metric newAdShowFailure(AdOperationError adOperationError, Long l2) {
        return new Metric(AD_SHOW_FAIL, l2, getTags(adOperationError, true, false));
    }

    public static Metric newAdShowStart() {
        return new Metric(AD_SHOW_START, (Object) null);
    }

    public static Metric newAdShowSuccess(Long l2) {
        return new Metric(AD_SHOW_SUCCESS, l2);
    }

    public static Metric newAdLoadFailure(UnityAds.UnityAdsLoadError unityAdsLoadError, Long l2, boolean z2) {
        return newAdLoadFailure(mapUnityAdsLoadError(unityAdsLoadError), l2, z2);
    }

    public static Metric newAdShowFailure(UnityAds.UnityAdsShowError unityAdsShowError, Long l2) {
        return newAdShowFailure(mapUnityAdsShowError(unityAdsShowError), l2);
    }
}
