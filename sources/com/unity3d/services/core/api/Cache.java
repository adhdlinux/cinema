...
public class Cache {
    ...
    public static void getFileContent(String str, String str2, WebViewCallback webViewCallback) {
        ...
        try {
            ...
            webViewCallback.error(cacheError, str, fileIdToFilename, e2.getMessage() + ", " + e2.getClass().getName());
        }
    }
    ...
    public static void getMetaData(String str, JSONArray jSONArray, WebViewCallback webViewCallback) {
        try {
            ...
            webViewCallback.error(CacheError.JSON_ERROR, e2.getMessage());
        } catch (RuntimeException e3) {
            webViewCallback.error(CacheError.INVALID_ARGUMENT, e3.getMessage());
        } catch (IOException e4) {
            webViewCallback.error(CacheError.FILE_IO_ERROR, e4.getMessage());
        }
    }
        ...
        if (file.exists()) {
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                if (extractMetadata != null) {
                    sparseArray.put(i3, extractMetadata);
                }
            }
            return sparseArray;
        }
