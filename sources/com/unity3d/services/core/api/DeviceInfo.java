...
public class DeviceInfo {
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i2 = AnonymousClass1.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i2 == 1) {
    ...
    public static void getSupportedAbis(WebViewCallback webViewCallback) {
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it2 = Device.getSupportedAbis().iterator();
        while (it2.hasNext()) {
