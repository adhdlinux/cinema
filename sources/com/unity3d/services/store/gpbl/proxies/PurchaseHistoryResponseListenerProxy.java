...
public class PurchaseHistoryResponseListenerProxy extends GenericListenerProxy {
    ...
    public PurchaseHistoryResponseListenerProxy(IPurchaseHistoryResponseListener iPurchaseHistoryResponseListener, int i2) {
    ...
    public void onPurchaseHistoryResponse(Object obj, List<Object> list) {
        ...
        if (list != null) {
            ...
            int i2 = 0;
            while (i2 < this._maxPurchases && i2 < list.size()) {
