...
public class AdUnitActivityController {
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        ...
        this._eventSender.sendEvent(WebViewEventCategory.ADUNIT, AdUnitEvent.KEY_DOWN, Integer.valueOf(i2), Long.valueOf(keyEvent.getEventTime()), Long.valueOf(keyEvent.getDownTime()), Integer.valueOf(keyEvent.getRepeatCount()), Integer.valueOf(this._activityId));
        return true;
    }
    ...
    public void onRequestPermissionsResult(int i2, String[] strArr, int[] iArr) {
        try {
            ...
            this._eventSender.sendEvent(WebViewEventCategory.PERMISSIONS, PermissionsEvent.PERMISSIONS_RESULT, Integer.valueOf(i2), jSONArray, jSONArray2);
        } catch (Exception e2) {
            this._eventSender.sendEvent(WebViewEventCategory.PERMISSIONS, PermissionsEvent.PERMISSIONS_ERROR, e2.getMessage());
        }
    }
    ...
    public void setOrientation(int i2) {
        ...
        this._adUnitActivity.setRequestedOrientation(i2);
    }

    public boolean setSystemUiVisibility(int i2) {
        this._systemUiVisibility = i2;
        try {
            this._adUnitActivity.getWindow().getDecorView().setSystemUiVisibility(i2);
            return true;
        } catch (Exception e2) {
    ...
    public void setViews(String[] strArr) {
        ...
        while (it2.hasNext()) {
            getViewHandler((String) it2.next()).destroy();
        }
        this._views = strArr;
