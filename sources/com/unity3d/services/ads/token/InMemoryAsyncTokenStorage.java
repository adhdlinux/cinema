...
public class InMemoryAsyncTokenStorage implements AsyncTokenStorage {
    ...
    private void sendTokenMetrics(String str, TokenType tokenType) {
        int i2 = AnonymousClass3.$SwitchMap$com$unity3d$services$core$device$TokenType[tokenType.ordinal()];
        if (i2 == 1) {
    ...
    public synchronized void setConfiguration(Configuration configuration) {
        ...
        if (isValidConfig) {
            ...
            Iterator it2 = new ArrayList(this._tokenListeners).iterator();
            while (it2.hasNext()) {
                handleTokenInvocation((TokenListenerState) it2.next());
            }
        }
    }
}
