...
public class MetaData extends JsonStorage {
    ...
    private synchronized boolean set(String str, boolean z2) {
        return set(str, (Object) Boolean.valueOf(z2));
    }
    ...
    private synchronized boolean set(String str, int i2) {
        return set(str, (Object) Integer.valueOf(i2));
    }

    private synchronized boolean set(String str, long j2) {
        return set(str, (Object) Long.valueOf(j2));
    }
