...
public final class VungleInternal$getAvailableBidTokensAsync$$inlined$inject$2 extends Lambda implements Function0<SDKExecutors> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VungleInternal$getAvailableBidTokensAsync$$inlined$inject$2(Context context) {
        super(0);
