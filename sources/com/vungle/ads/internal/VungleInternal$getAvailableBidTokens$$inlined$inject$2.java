...
public final class VungleInternal$getAvailableBidTokens$$inlined$inject$2 extends Lambda implements Function0<SDKExecutors> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VungleInternal$getAvailableBidTokens$$inlined$inject$2(Context context) {
        super(0);
