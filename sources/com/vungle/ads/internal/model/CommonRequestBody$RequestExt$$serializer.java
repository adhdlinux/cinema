...
public final class CommonRequestBody$RequestExt$$serializer implements GeneratedSerializer<CommonRequestBody.RequestExt> {
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{BuiltinSerializersKt.s(stringSerializer), BuiltinSerializersKt.s(stringSerializer), BuiltinSerializersKt.s(LongSerializer.f41017a)};
    }

    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.vungle.ads.internal.model.CommonRequestBody.RequestExt deserialize(kotlinx.serialization.encoding.Decoder r12) {
        /*
            r11 = this;
            ...
            kotlinx.serialization.internal.LongSerializer r3 = kotlinx.serialization.internal.LongSerializer.f41017a
        ...
        L_0x0064:
            r12.c(r0)
            com.vungle.ads.internal.model.CommonRequestBody$RequestExt r12 = new com.vungle.ads.internal.model.CommonRequestBody$RequestExt
            ...
            r8 = 0
            r3 = r12
            r3.<init>((int) r4, (java.lang.String) r5, (java.lang.String) r6, (java.lang.Long) r7, (kotlinx.serialization.internal.SerializationConstructorMarker) r8)
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vungle.ads.internal.model.CommonRequestBody$RequestExt$$serializer.deserialize(kotlinx.serialization.encoding.Decoder):com.vungle.ads.internal.model.CommonRequestBody$RequestExt");
    }
    ...
    public void serialize(Encoder encoder, CommonRequestBody.RequestExt requestExt) {
        Intrinsics.f(encoder, "encoder");
        Intrinsics.f(requestExt, AppMeasurementSdk.ConditionalUserProperty.VALUE);
