...
public final class MRAIDPresenter$special$$inlined$inject$4 extends Lambda implements Function0<SignalManager> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MRAIDPresenter$special$$inlined$inject$4(Context context) {
        super(0);
