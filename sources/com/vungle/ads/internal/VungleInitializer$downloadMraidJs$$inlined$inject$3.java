...
public final class VungleInitializer$downloadMraidJs$$inlined$inject$3 extends Lambda implements Function0<Executors> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VungleInitializer$downloadMraidJs$$inlined$inject$3(Context context) {
        super(0);
