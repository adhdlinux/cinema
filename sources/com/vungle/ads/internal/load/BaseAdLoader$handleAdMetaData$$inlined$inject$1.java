...
public final class BaseAdLoader$handleAdMetaData$$inlined$inject$1 extends Lambda implements Function0<SignalManager> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BaseAdLoader$handleAdMetaData$$inlined$inject$1(Context context) {
        super(0);
