...
public final class SignalManager$special$$inlined$inject$1 extends Lambda implements Function0<FilePreferences> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SignalManager$special$$inlined$inject$1(Context context) {
        super(0);
