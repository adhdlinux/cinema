...
public final class VungleInitializer$downloadMraidJs$$inlined$inject$2 extends Lambda implements Function0<Downloader> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VungleInitializer$downloadMraidJs$$inlined$inject$2(Context context) {
        super(0);
