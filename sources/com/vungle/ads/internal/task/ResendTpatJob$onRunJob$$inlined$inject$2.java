...
public final class ResendTpatJob$onRunJob$$inlined$inject$2 extends Lambda implements Function0<Executors> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ResendTpatJob$onRunJob$$inlined$inject$2(Context context) {
        super(0);
