...
public final class Request {
    ...
    public static final class Builder {
        ...
        public Request build() {
            ...
            } else if (z2 && this.targetWidth == 0 && this.targetHeight == 0) {
        ...
        Builder(Uri uri2, int i2, Bitmap.Config config2) {
            this.uri = uri2;
            this.resourceId = i2;
            this.config = config2;
        }
    ...
    private Request(Uri uri2, int i2, String str, List<Transformation> list, int i3, int i4, boolean z2, boolean z3, int i5, boolean z4, float f2, float f3, float f4, boolean z5, boolean z6, Bitmap.Config config2, Picasso.Priority priority2) {
        this.uri = uri2;
        this.resourceId = i2;
        this.stableKey = str;
        if (list == null) {
