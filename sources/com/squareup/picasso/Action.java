...
abstract class Action<T> {
    ...
    static class RequestWeakReference<M> extends WeakReference<M> {
        ...
        RequestWeakReference(Action action2, M m2, ReferenceQueue<? super M> referenceQueue) {
            super(m2, referenceQueue);
            this.action = action2;
        }
    }

    Action(Picasso picasso2, T t2, Request request2, int i2, int i3, int i4, Drawable drawable, String str, Object obj, boolean z2) {
        ...
        if (t2 == null) {
            ...
            requestWeakReference = new RequestWeakReference(this, t2, picasso2.referenceQueue);
        }
