...
public class Picasso {
    ...
    Picasso(Context context2, Dispatcher dispatcher2, Cache cache2, Listener listener2, RequestTransformer requestTransformer2, List<RequestHandler> list, Stats stats2, Bitmap.Config config, boolean z2, boolean z3) {
        int i2;
    ...
    public static Picasso get() {
        if (singleton == null) {
            synchronized (Picasso.class) {
                if (singleton == null) {
                    Context context2 = PicassoProvider.context;
                    if (context2 != null) {
