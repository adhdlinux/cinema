...
public class d implements a {
    ...
    private final int[] f31735a = new int[2];

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.C0048a aVar, boolean z2) {
    ...
    @TargetApi(21)
    private void c(ViewGroup viewGroup, JSONObject jSONObject, a.C0048a aVar, boolean z2) {
    ...
    public JSONObject a(View view) {
        ...
        view.getLocationOnScreen(this.f31735a);
        int[] iArr = this.f31735a;
