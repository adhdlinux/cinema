...
public class GifDrawableTransformation implements Transformation<GifDrawable> {
    ...
    private final Transformation<Bitmap> f16928b;
    ...
    public Resource<GifDrawable> a(Context context, Resource<GifDrawable> resource, int i2, int i3) {
        ...
        Resource<Bitmap> a2 = this.f16928b.a(context, bitmapResource, i2, i3);
        if (!bitmapResource.equals(a2)) {
            bitmapResource.recycle();
        }
        gifDrawable.m(this.f16928b, a2.get());
        return resource;
    }

    public void b(MessageDigest messageDigest) {
        this.f16928b.b(messageDigest);
    }

    public boolean equals(Object obj) {
        if (obj instanceof GifDrawableTransformation) {
            return this.f16928b.equals(((GifDrawableTransformation) obj).f16928b);
        }
        return false;
    }
