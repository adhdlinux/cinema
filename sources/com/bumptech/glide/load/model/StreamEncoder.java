...
public class StreamEncoder implements Encoder<InputStream> {
    ...
    private final ArrayPool f16755a;

    public StreamEncoder(ArrayPool arrayPool) {
        this.f16755a = arrayPool;
    }
    ...
    public boolean a(java.io.InputStream r5, java.io.File r6, com.bumptech.glide.load.Options r7) {
        /*
            r4 = this;
            java.lang.String r7 = "StreamEncoder"
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r0 = r4.f16755a
        ...
        L_0x0026:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r4.f16755a
            r5.put(r0)
            r1 = 1
            goto L_0x004c
        L_0x002d:
        ...
        L_0x0052:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r6 = r4.f16755a
            r6.put(r0)
            throw r5
        */
