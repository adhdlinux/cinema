...
public class LteFrequencyUtil {
    ...
    private static final List<LteFrequencyUtil> f35523a = new ArrayList<LteFrequencyUtil>() {
        {
    ...
    private float f35524b;

    /* renamed from: c  reason: collision with root package name */
    private float f35525c;
    ...
    private float f35528f;

    /* renamed from: g  reason: collision with root package name */
    private float f35529g;
    ...
    public static g1 a(int i2) {
        g1 g1Var = null;
        for (LteFrequencyUtil next : f35523a) {
            if (next.b(i2)) {
                g1Var = next.c(i2).f35530h;
            } else if (i2 > 0 && next.a((long) i2)) {
                g1Var = next.d(i2).f35530h;
            }
        }
        return g1Var;
    }
    ...
    private boolean b(int i2) {
        float f2 = (float) i2;
        return f2 >= this.f35529g && f2 <= this.f35528f;
    }

    private LteFrequencyUtil c(int i2) {
        g1 g1Var = this.f35530h;
        float f2 = (float) i2;
        float f3 = this.f35527e + ((f2 - this.f35529g) * 0.1f);
        g1Var.download_frequency = f3;
        g1Var.download_frequency = a(f3, 1);
        g1 g1Var2 = this.f35530h;
        g1Var2.download_earfcn = i2;
        float f4 = this.f35524b;
        if (!(f4 == 0.0f && this.f35526d == 0.0f)) {
            float f5 = f4 + (g1Var2.download_frequency - this.f35527e);
            g1Var2.upload_frequency = f5;
            g1Var2.upload_frequency = a(f5, 1);
            this.f35530h.upload_earfcn = (int) (this.f35526d + (f2 - this.f35529g));
        }
        return this;
    }

    private LteFrequencyUtil d(int i2) {
        g1 g1Var = this.f35530h;
        float f2 = (float) i2;
        float f3 = this.f35524b + ((f2 - this.f35526d) * 0.1f);
        g1Var.upload_frequency = f3;
        g1Var.upload_frequency = a(f3, 1);
        g1 g1Var2 = this.f35530h;
        g1Var2.upload_earfcn = i2;
        float f4 = this.f35527e + (g1Var2.upload_frequency - this.f35524b);
        g1Var2.download_frequency = f4;
        g1Var2.download_frequency = a(f4, 1);
        this.f35530h.download_earfcn = (int) (this.f35529g + (f2 - this.f35526d));
        return this;
    }

    private LteFrequencyUtil(int i2, float f2, float f3, float f4, float f5, float f6, float f7) {
        this.f35530h = null;
        g1 g1Var = new g1();
        this.f35530h = g1Var;
        g1Var.band = i2;
    ...
    private boolean a(long j2) {
        float f2 = (float) j2;
        return f2 >= this.f35526d && f2 <= this.f35525c;
    }

    private float a(float f2, int i2) {
        if (i2 >= 0) {
            float pow = (float) ((long) Math.pow(10.0d, (double) i2));
