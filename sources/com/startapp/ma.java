...
public class ma {
    ...
    public static android.graphics.Bitmap b(java.lang.String r5) {
        /*
            r0 = 0
            java.net.URL r1 = new java.net.URL     // Catch:{ all -> 0x0030 }
            r1.<init>(r5)     // Catch:{ all -> 0x0030 }
            java.net.URLConnection r5 = r1.openConnection()     // Catch:{ all -> 0x0030 }
            java.net.HttpURLConnection r5 = (java.net.HttpURLConnection) r5     // Catch:{ all -> 0x0030 }
            ...
            com.startapp.ma$a r3 = new com.startapp.ma$a     // Catch:{ all -> 0x002b }
        ...
        L_0x0038:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.ma.b(java.lang.String):android.graphics.Bitmap");
    }
