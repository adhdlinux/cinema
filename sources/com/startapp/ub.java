...
public class ub {
    ...
    public transient SoftReference<vb> f36668g;

    /* renamed from: h  reason: collision with root package name */
    public final transient Map<String, SoftReference<Map<String, Object>>> f36669h = new ConcurrentHashMap();

    public static class a implements Iterator<Object> {

        /* renamed from: a  reason: collision with root package name */
        public final Object f36670a;
        ...
        public boolean hasNext() {
            return this.f36672c < this.f36671b;
        }
    ...
    public ub(String str, String str2, String[] strArr, Class[] clsArr, Object[] objArr, String[] strArr2) {
        this.f36662a = str;
        this.f36663b = str2;
        this.f36664c = strArr;
        this.f36665d = clsArr;
        this.f36666e = objArr;
        this.f36667f = strArr2;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v4, resolved type: com.startapp.na} */
    ...
    public org.json.JSONArray a(android.content.Context r9, int[] r10, java.lang.Integer r11) {
        /*
            r8 = this;
            r0 = 5
            com.startapp.vb r9 = r8.a((android.content.Context) r9)     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.Object[] r1 = r8.f36666e     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.reflect.Method r2 = r9.f36743b     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.Object r9 = r9.f36742a     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.Object r9 = r2.invoke(r9, r1)     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            if (r9 != 0) goto L_0x0014
            com.startapp.ub$b r9 = com.startapp.ub.b.f36673a
            goto L_0x003c
        L_0x0014:
        ...
        L_0x001f:
            ...
            com.startapp.ub$a r0 = new com.startapp.ub$a
        ...
        L_0x0050:
            ...
            java.util.Map<java.lang.String, java.lang.ref.SoftReference<java.util.Map<java.lang.String, java.lang.Object>>> r6 = r8.f36669h
        ...
        L_0x006d:
            ...
            java.lang.String[] r2 = r8.f36667f
        ...
        L_0x00e1:
            ...
            java.lang.String[] r9 = r8.f36667f
            int r9 = r9.length
            int r1 = r10.length
            r4 = 0
        L_0x00eb:
            ...
            java.lang.String[] r6 = r8.f36667f
            int r7 = java.lang.Math.abs(r5)
            int r7 = r7 + -1
            r6 = r6[r7]
            com.startapp.za r7 = new com.startapp.za
            r7.<init>(r6)
        ...
        L_0x010c:
            ...
            goto L_0x0116
        L_0x0110:
            com.startapp.na r5 = new com.startapp.na
            r5.<init>(r2, r7)
            r2 = r5
        L_0x0116:
            int r4 = r4 + 1
        ...
        L_0x015b:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.ub.a(android.content.Context, int[], java.lang.Integer):org.json.JSONArray");
    }
    ...
    public boolean equals(Object obj) {
        ...
        ub ubVar = (ub) obj;
        if (!lb.a(this.f36662a, ubVar.f36662a) || !lb.a(this.f36663b, ubVar.f36663b) || !Arrays.equals(this.f36664c, ubVar.f36664c) || !Arrays.equals(this.f36666e, ubVar.f36666e) || !Arrays.equals(this.f36667f, ubVar.f36667f)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        Object[] objArr = {this.f36662a, this.f36663b, this.f36664c, this.f36666e, this.f36667f};
    ...
    public final vb a(Context context) {
        Object obj;
        SoftReference<vb> softReference = this.f36668g;
        vb vbVar = softReference != null ? softReference.get() : null;
        if (vbVar != null) {
            return vbVar;
        }
        Object systemService = context.getSystemService(this.f36662a);
        if (systemService == null) {
            try {
                Object obj2 = ((LinkedHashMap) a(Context.class, new String[]{this.f36662a})).get(this.f36662a);
        ...
        if (systemService != null) {
            try {
                Method a2 = a(systemService.getClass(), this.f36663b, this.f36665d);
                if (!a2.isAccessible()) {
                    try {
                        a2.setAccessible(true);
                    } catch (SecurityException e2) {
                        throw new RuntimeException(String.valueOf(4), e2);
                    }
                }
                vb vbVar2 = new vb(systemService, a2);
                this.f36668g = new SoftReference<>(vbVar2);
                return vbVar2;
            } catch (NoSuchMethodException e3) {
                throw new RuntimeException(String.valueOf(3), e3);
            }
        } else {
    ...
    public final java.util.Map<java.lang.String, java.lang.Object> a(java.lang.Class<?> r11, java.lang.String[] r12) {
        ...
        L_0x009a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.ub.a(java.lang.Class, java.lang.String[]):java.util.Map");
    }
}
