...
public class RatingBar extends LinearLayout {
    ...
    public static Map<String, String> f36529a = new HashMap<String, String>() {
        {
    ...
    public final void a(String str) {
        try {
            ...
            Bitmap a4 = ka.a(getContext(), str);
            if (a4 == null) {
                a4 = ma.a(f36529a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a4, p.a(getContext(), 15), p.a(getContext(), 15), true));
    ...
    public void setRating(float f2) {
        int i2;
        removeAllViews();
        float round = ((float) Math.round(f2 * 2.0f)) / 2.0f;
        int floor = (int) Math.floor((double) round);
        if (round - ((float) floor) == 0.5f) {
            i2 = 1;
        } else {
            i2 = 0;
        }
