...
public class u0 {
    ...
    private long CONNECTIVITY_KEEPALIVE_INTERVAL = SignalManager.TWENTY_FOUR_HOURS_MILLIS;
    private boolean CONNECTIVITY_TEST_ALLOW_IN_IDLE = false;
    private long CONNECTIVITY_TEST_CDNCONFIG_UPDATE_INTERVAL = SignalManager.TWENTY_FOUR_HOURS_MILLIS;
    ...
    private long CONNECTIVITY_TEST_TRUSTSTORE_UPDATE_INTERVAL = SignalManager.TWENTY_FOUR_HOURS_MILLIS;
