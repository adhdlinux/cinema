...
public interface Sync {
    ...
    @GET("sync/playback")
    Call<List<PlaybackResponse>> getPlayback(@Query("limit") Integer num);

    @GET("sync/playback/episodes")
    Call<List<PlaybackResponse>> getPlaybackEpisodes(@Query("limit") Integer num);

    @GET("sync/playback/movies")
    Call<List<PlaybackResponse>> getPlaybackMovies(@Query("limit") Integer num);

    @GET("sync/last_activities")
    Call<LastActivities> lastActivities();

    @GET("sync/ratings/episodes{rating}")
    Call<List<RatedEpisode>> ratingsEpisodes(@Path(encoded = true, value = "rating") RatingsFilter ratingsFilter, @Query(encoded = true, value = "extended") Extended extended, @Query("page") Integer num, @Query("limit") Integer num2);

    @GET("sync/ratings/movies{rating}")
    Call<List<RatedMovie>> ratingsMovies(@Path(encoded = true, value = "rating") RatingsFilter ratingsFilter, @Query(encoded = true, value = "extended") Extended extended, @Query("page") Integer num, @Query("limit") Integer num2);

    @GET("sync/ratings/seasons{rating}")
    Call<List<RatedSeason>> ratingsSeasons(@Path(encoded = true, value = "rating") RatingsFilter ratingsFilter, @Query(encoded = true, value = "extended") Extended extended, @Query("page") Integer num, @Query("limit") Integer num2);

    @GET("sync/ratings/shows{rating}")
    Call<List<RatedShow>> ratingsShows(@Path(encoded = true, value = "rating") RatingsFilter ratingsFilter, @Query(encoded = true, value = "extended") Extended extended, @Query("page") Integer num, @Query("limit") Integer num2);
