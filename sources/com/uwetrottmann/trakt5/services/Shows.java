...
public interface Shows {
    ...
    Call<BaseShow> collectedProgress(@Path("id") String str, @Query("hidden") Boolean bool, @Query("specials") Boolean bool2, @Query("count_specials") Boolean bool3, @Query("last_activity") ProgressLastActivity progressLastActivity, @Query(encoded = true, value = "extended") Extended extended);
    ...
    Call<List<Show>> related(@Path("id") String str, @Query("page") Integer num, @Query("limit") Integer num2, @Query(encoded = true, value = "extended") Extended extended);
    ...
    Call<BaseShow> watchedProgress(@Path("id") String str, @Query("hidden") Boolean bool, @Query("specials") Boolean bool2, @Query("count_specials") Boolean bool3, @Query("last_activity") ProgressLastActivity progressLastActivity, @Query(encoded = true, value = "extended") Extended extended);
}
