...
public class FinalizerCloseableReference<T> extends CloseableReference<T> {
    ...
    FinalizerCloseableReference(T t2, ResourceReleaser<T> resourceReleaser, CloseableReference.LeakHandler leakHandler, Throwable th) {
    ...
    public void finalize() throws java.lang.Throwable {
        ...
        L_0x000a:
            monitor-exit(r6)     // Catch:{ all -> 0x004b }
            com.facebook.common.references.SharedReference<T> r0 = r6.mSharedReference     // Catch:{ all -> 0x004e }
            ...
            com.facebook.common.references.SharedReference<T> r4 = r6.mSharedReference     // Catch:{ all -> 0x004e }
