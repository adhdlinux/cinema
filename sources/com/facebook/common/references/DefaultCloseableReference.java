...
public class DefaultCloseableReference<T> extends CloseableReference<T> {
    ...
    public void finalize() throws java.lang.Throwable {
        ...
        L_0x000a:
            monitor-exit(r6)     // Catch:{ all -> 0x0052 }
            com.facebook.common.references.SharedReference<T> r0 = r6.mSharedReference     // Catch:{ all -> 0x0055 }
            ...
            int r4 = java.lang.System.identityHashCode(r6)     // Catch:{ all -> 0x0055 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ all -> 0x0055 }
            r5 = 0
            r3[r5] = r4     // Catch:{ all -> 0x0055 }
            com.facebook.common.references.SharedReference<T> r4 = r6.mSharedReference     // Catch:{ all -> 0x0055 }
            int r4 = java.lang.System.identityHashCode(r4)     // Catch:{ all -> 0x0055 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ all -> 0x0055 }
            r5 = 1
            r3[r5] = r4     // Catch:{ all -> 0x0055 }
        ...
        L_0x003c:
            ...
            com.facebook.common.references.SharedReference<T> r1 = r6.mSharedReference     // Catch:{ all -> 0x0055 }
    ...
    DefaultCloseableReference(T t2, ResourceReleaser<T> resourceReleaser, CloseableReference.LeakHandler leakHandler, Throwable th) {
