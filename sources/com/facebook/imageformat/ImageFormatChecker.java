...
public class ImageFormatChecker {
    ...
    private static int readHeaderFromStream(int i2, InputStream inputStream, byte[] bArr) throws IOException {
        boolean z2;
    ...
    public void setUseNewOrder(boolean z2) {
        this.mDefaultFormatChecker.setUseNewOrder(z2);
    }
    ...
    public static com.facebook.imageformat.ImageFormat getImageFormat(java.lang.String r2) {
        /*
            ...
            com.facebook.imageformat.ImageFormat r2 = getImageFormat((java.io.InputStream) r1)     // Catch:{ IOException -> 0x0011, all -> 0x000e }
            com.facebook.common.internal.Closeables.closeQuietly((java.io.InputStream) r1)
            return r2
        L_0x000e:
            r2 = move-exception
            r0 = r1
