...
public class DefaultImageFormatChecker implements ImageFormat.FormatChecker {
    ...
    private static boolean isDngHeader(byte[] bArr, int i2) {
        if (i2 < DNG_HEADER_LENGTH || (!ImageFormatCheckerUtils.startsWithPattern(bArr, DNG_HEADER_II) && !ImageFormatCheckerUtils.startsWithPattern(bArr, DNG_HEADER_MM))) {
            return false;
        }
        return true;
    }
    ...
    public final ImageFormat determineFormat(byte[] bArr, int i2) {
        ...
        if (!this.mUseNewOrder && WebpSupportStatus.isWebpHeader(bArr, 0, i2)) {
