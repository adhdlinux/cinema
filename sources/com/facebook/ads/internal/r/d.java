...
class d {
    static Float a(View view) {
        ...
        if (findViewById == null) {
            findViewById = a2.getWindow().getDecorView().findViewById(16908290);
        }
    ...
    static Float a(View view, View view2) {
        ...
        if (b2.isEmpty()) {
            ...
            hashSet.add(rect);
            for (View globalVisibleRect : b2) {
                Rect rect2 = new Rect();
                if (globalVisibleRect.getGlobalVisibleRect(rect2)) {
                    HashSet hashSet2 = new HashSet();
                    for (Rect a2 : hashSet) {
                        hashSet2.addAll(a(a2, rect2));
                    }
                    hashSet = hashSet2;
                }
            }
    ...
    private static List<View> b(View view, View view2) {
        ...
        while (!stack.empty()) {
            ...
            if (view3.getVisibility() == 0) {
                ...
                } else if (z2 || view3.getZ() > view2.getZ()) {
