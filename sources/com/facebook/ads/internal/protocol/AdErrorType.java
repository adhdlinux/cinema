...
public enum AdErrorType {
    ...
    private AdErrorType(int i2, String str, boolean z2) {
        this.f20538a = i2;
        this.f20539b = str;
        this.f20540c = z2;
    }

    public static AdErrorType adErrorTypeFromCode(int i2) {
        return adErrorTypeFromCode(i2, UNKNOWN_ERROR);
    }

    public static AdErrorType adErrorTypeFromCode(int i2, AdErrorType adErrorType) {
        for (AdErrorType adErrorType2 : values()) {
            if (adErrorType2.getErrorCode() == i2) {
                return adErrorType2;
            }
        }
        return adErrorType;
