...
public class b {
    ...
    private static final String f20763a = "b";
    ...
    public static Map<String, String> a(Context context) {
        ...
        if (context == null) {
            Log.v(f20763a, "Null context in window interactive check.");
            return hashMap;
        }
        try {
            ...
            if (context instanceof Activity) {
                ...
                if (window != null) {
                    ...
                    String str3 = "1";
                    hashMap.put("wfdkg", (4194304 & i2) > 0 ? str3 : "0");
                    if ((524288 & i2) <= 0) {
                        str3 = "0";
                    }
            ...
            Log.e(f20763a, "Exception in window info check", e2);
            a.a(context, "risky", com.facebook.ads.internal.q.d.b.f20758r, e2);
        }
        return hashMap;
    }
