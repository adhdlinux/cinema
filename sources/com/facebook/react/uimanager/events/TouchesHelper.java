...
public class TouchesHelper {
    ...
    private static WritableMap[] createPointersArray(TouchEvent touchEvent) {
        ...
        for (int i2 = 0; i2 < motionEvent.getPointerCount(); i2++) {
            ...
            createMap.putDouble(LOCATION_X_KEY, (double) PixelUtil.toDIPFromPixel(motionEvent.getX(i2) - x2));
            createMap.putDouble(LOCATION_Y_KEY, (double) PixelUtil.toDIPFromPixel(motionEvent.getY(i2) - y2));
    ...
    public static void sendTouchEvent(RCTModernEventEmitter rCTModernEventEmitter, TouchEvent touchEvent) {
        ...
        if (i2 != 1) {
            if (i2 == 2) {
                ...
                for (int i3 = 0; i3 < createPointersArray.length; i3++) {
                    writableMapArr2[i3] = createPointersArray[i3].copy();
                }
            } else if (i2 != 4) {
