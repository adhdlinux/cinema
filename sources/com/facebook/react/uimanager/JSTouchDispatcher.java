...
public class JSTouchDispatcher {
    ...
    private void dispatchCancelEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        ((EventDispatcher) Assertions.assertNotNull(eventDispatcher)).dispatchEvent(TouchEvent.obtain(surfaceId, i2, touchEventType, motionEvent, j2, fArr[0], fArr[1], this.mTouchEventCoalescingKeyHelper));
    }
    ...
    public void handleTouchEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        if (action == 0) {
            ...
            if (this.mTargetTag == -1) {
                ...
                eventDispatcher2.dispatchEvent(TouchEvent.obtain(surfaceId2, i3, touchEventType2, motionEvent, j3, fArr2[0], fArr2[1], this.mTouchEventCoalescingKeyHelper));
                this.mTargetTag = -1;
                ...
                eventDispatcher2.dispatchEvent(TouchEvent.obtain(surfaceId3, i4, touchEventType3, motionEvent, j4, fArr3[0], fArr3[1], this.mTouchEventCoalescingKeyHelper));
            } else if (action == 5) {
                ...
                eventDispatcher2.dispatchEvent(TouchEvent.obtain(surfaceId4, i5, touchEventType4, motionEvent, j5, fArr4[0], fArr4[1], this.mTouchEventCoalescingKeyHelper));
            } else if (action == 6) {
                ...
                eventDispatcher2.dispatchEvent(TouchEvent.obtain(surfaceId5, i6, touchEventType5, motionEvent, j6, fArr5[0], fArr5[1], this.mTouchEventCoalescingKeyHelper));
            } else if (action == 3) {
