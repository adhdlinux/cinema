...
public class ViewProps {
    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c2) {
            case 0:
                if (readableMap2.isNull(BORDER_RIGHT_COLOR) || readableMap2.getInt(BORDER_RIGHT_COLOR) != 0) {
                    return false;
                }
                return true;
            case 1:
                if (readableMap2.isNull(BORDER_RIGHT_WIDTH) || readableMap2.getDouble(BORDER_RIGHT_WIDTH) == 0.0d) {
                    return true;
                }
                return false;
            case 2:
                if (readableMap2.isNull(BORDER_TOP_COLOR) || readableMap2.getInt(BORDER_TOP_COLOR) != 0) {
                    return false;
                }
                return true;
            case 3:
                if (readableMap2.isNull(BORDER_TOP_WIDTH) || readableMap2.getDouble(BORDER_TOP_WIDTH) == 0.0d) {
                    return true;
                }
                return false;
            case 4:
                if (readableMap2.isNull(BORDER_BOTTOM_COLOR) || readableMap2.getInt(BORDER_BOTTOM_COLOR) != 0) {
                    return false;
                }
                return true;
            case 5:
                if (readableMap2.isNull(BORDER_BOTTOM_WIDTH) || readableMap2.getDouble(BORDER_BOTTOM_WIDTH) == 0.0d) {
                    return true;
                }
                return false;
            case 6:
                ...
                return false;
            case 7:
                if (readableMap2.isNull(BORDER_LEFT_COLOR) || readableMap2.getInt(BORDER_LEFT_COLOR) != 0) {
                    return false;
                }
                return true;
            case 8:
                if (readableMap2.isNull(BORDER_LEFT_WIDTH) || readableMap2.getDouble(BORDER_LEFT_WIDTH) == 0.0d) {
                    return true;
                }
                return false;
            case 9:
                ...
                return false;
            case 10:
                if (readableMap2.isNull(BORDER_WIDTH) || readableMap2.getDouble(BORDER_WIDTH) == 0.0d) {
                    return true;
                }
                return false;
            case 11:
                if (readableMap2.hasKey(BACKGROUND_COLOR) && (((type = readableMap2.getType(BACKGROUND_COLOR)) == ReadableType.Number && readableMap2.getInt(BACKGROUND_COLOR) != 0) || type != ReadableType.Null)) {
                    return false;
                }
                if (!readableMap2.hasKey(BORDER_WIDTH) || readableMap2.isNull(BORDER_WIDTH) || readableMap2.getDouble(BORDER_WIDTH) == 0.0d) {
                    return true;
                }
                return false;
            default:
