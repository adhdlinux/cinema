...
public class FabricViewStateManager {
    ...
    private void setState(StateWrapper stateWrapper, StateUpdateCallback stateUpdateCallback, int i2) {
        WritableMap stateUpdate;
        if (stateWrapper == null) {
            FLog.e(TAG, "setState called without a StateWrapper");
        } else if (stateWrapper == this.mStateWrapper && i2 <= 60 && (stateUpdate = stateUpdateCallback.getStateUpdate()) != null) {
