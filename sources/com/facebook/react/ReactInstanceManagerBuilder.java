...
public class ReactInstanceManagerBuilder {
    ...
    public ReactInstanceManager build() {
        ...
        Assertions.assertCondition(z2, "JS Bundle File or Asset URL has to be provided when dev support is disabled");
        if (this.mJSMainModulePath == null && this.mJSBundleAssetUrl == null && this.mJSBundleLoader == null) {
            z3 = false;
        }
        Assertions.assertCondition(z3, "Either MainModulePath or JS Bundle File needs to be provided");
        ...
        boolean z4 = this.mUseDeveloperSupport;
    ...
    public ReactInstanceManagerBuilder setJsEngineAsHermes(boolean z2) {
        if (z2) {
