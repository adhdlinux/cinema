...
public final class JavaScriptModuleRegistry {
    ...
    public synchronized <T extends JavaScriptModule> T getJavaScriptModule(CatalystInstance catalystInstance, Class<T> cls) {
        T t2 = (JavaScriptModule) this.mModuleInstances.get(cls);
        if (t2 != null) {
            return t2;
        }
        T t3 = (JavaScriptModule) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new JavaScriptModuleInvocationHandler(catalystInstance, cls));
        this.mModuleInstances.put(cls, t3);
        return t3;
    }
}
