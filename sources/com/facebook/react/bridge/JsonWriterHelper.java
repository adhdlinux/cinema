            ...
            try {
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i2).ordinal()]) {
                    case 1:
                        ...
                        break;
                    case 2:
                        jsonWriter.value(readableArray.getBoolean(i2));
                        break;
                    case 3:
                        jsonWriter.value(readableArray.getDouble(i2));
                        break;
                    case 4:
                        jsonWriter.value(readableArray.getString(i2));
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableArray.getMap(i2));
                        break;
                    case 6:
                        readableArrayValue(jsonWriter, readableArray.getArray(i2));
                        break;
                    default:
                        throw new IllegalArgumentException("Unknown data type: " + readableArray.getType(i2));
                }
                i2++;
            } finally {
                jsonWriter.endArray();
