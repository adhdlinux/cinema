...
public class DialogModule extends NativeDialogManagerAndroidSpec implements LifecycleEventListener {
    ...
    private class FragmentManagerHelper {
        ...
        private void dismissExisting() {
            ...
            if (DialogModule.this.mIsInForeground && (alertFragment = (AlertFragment) this.mFragmentManager.i0(DialogModule.FRAGMENT_TAG)) != null && alertFragment.isResumed()) {
        ...
        public void showNewAlert(Bundle bundle, Callback callback) {
            ...
            if (!DialogModule.this.mIsInForeground || this.mFragmentManager.L0()) {
