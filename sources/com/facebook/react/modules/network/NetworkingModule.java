...
public final class NetworkingModule extends NativeNetworkingAndroidSpec {
    ...
    private MultipartBody.Builder constructMultipartBody(ReadableArray readableArray, String str, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (extractHeaders == null) {
                ResponseUtil.onRequestError(eventEmitter, i2, "Missing or invalid header format for FormData part.", (Throwable) null);
                return null;
            }
            ...
            if (map.hasKey(REQUEST_BODY_KEY_STRING)) {
                ...
                ResponseUtil.onRequestError(eventEmitter, i2, "Unrecognized FormData part.", (Throwable) null);
            } else if (mediaType == null) {
                ResponseUtil.onRequestError(eventEmitter, i2, "Binary FormData part needs a content-type header.", (Throwable) null);
                return null;
            } else {
                String string = map.getString(REQUEST_BODY_KEY_URI);
                InputStream fileInputStream = RequestBodyUtil.getFileInputStream(getReactApplicationContext(), string);
                if (fileInputStream == null) {
                    ResponseUtil.onRequestError(eventEmitter, i2, "Could not retrieve file for uri " + string, (Throwable) null);
                    return null;
                }
    ...
    public void sendRequest(String str, String str2, double d2, ReadableArray readableArray, ReadableMap readableMap, String str3, boolean z2, double d3, boolean z3) {
        ...
        try {
            ...
            if (eventEmitter != null) {
                ResponseUtil.onRequestError(eventEmitter, i2, th2.getMessage(), th2);
            }
        }
    }
    ...
    public void sendRequestInternal(java.lang.String r16, java.lang.String r17, int r18, com.facebook.react.bridge.ReadableArray r19, com.facebook.react.bridge.ReadableMap r20, java.lang.String r21, boolean r22, int r23, boolean r24) {
        /*
            r15 = this;
            r7 = r15
            r0 = r16
            ...
            com.facebook.react.modules.core.DeviceEventManagerModule$RCTDeviceEventEmitter r4 = r15.getEventEmitter(r4)
            android.net.Uri r6 = android.net.Uri.parse(r17)     // Catch:{ IOException -> 0x01c1 }
            java.util.List<com.facebook.react.modules.network.NetworkingModule$UriHandler> r8 = r7.mUriHandlers     // Catch:{ IOException -> 0x01c1 }
            java.util.Iterator r8 = r8.iterator()     // Catch:{ IOException -> 0x01c1 }
        L_0x001b:
            boolean r9 = r8.hasNext()     // Catch:{ IOException -> 0x01c1 }
            if (r9 == 0) goto L_0x0038
            java.lang.Object r9 = r8.next()     // Catch:{ IOException -> 0x01c1 }
            com.facebook.react.modules.network.NetworkingModule$UriHandler r9 = (com.facebook.react.modules.network.NetworkingModule.UriHandler) r9     // Catch:{ IOException -> 0x01c1 }
            boolean r10 = r9.supports(r6, r5)     // Catch:{ IOException -> 0x01c1 }
            if (r10 == 0) goto L_0x001b
            com.facebook.react.bridge.WritableMap r0 = r9.fetch(r6)     // Catch:{ IOException -> 0x01c1 }
            com.facebook.react.modules.network.ResponseUtil.onDataReceived((com.facebook.react.modules.core.DeviceEventManagerModule.RCTDeviceEventEmitter) r4, (int) r3, (com.facebook.react.bridge.WritableMap) r0)     // Catch:{ IOException -> 0x01c1 }
            com.facebook.react.modules.network.ResponseUtil.onRequestSuccess(r4, r3)     // Catch:{ IOException -> 0x01c1 }
            return
        L_0x0038:
            r6 = 0
            okhttp3.Request$Builder r8 = new okhttp3.Request$Builder     // Catch:{ Exception -> 0x01b8 }
            r8.<init>()     // Catch:{ Exception -> 0x01b8 }
            r9 = r17
            okhttp3.Request$Builder r8 = r8.url((java.lang.String) r9)     // Catch:{ Exception -> 0x01b8 }
        ...
        L_0x0075:
            ...
            r9 = r19
            okhttp3.Headers r9 = r15.extractHeaders(r9, r1)
        ...
        L_0x00b2:
            ...
            java.lang.String r13 = r0.toLowerCase(r9)
        ...
        L_0x0125:
            ...
            okio.ByteString r1 = okio.ByteString.c(r1)
        ...
        L_0x0144:
            java.lang.String r1 = r1.getString(r9)
            com.facebook.react.bridge.ReactApplicationContext r9 = r15.getReactApplicationContext()
        ...
        L_0x017c:
            ...
            okhttp3.MultipartBody$Builder r1 = r15.constructMultipartBody(r1, r10, r3)
        ...
        L_0x0187:
            ...
            goto L_0x0195
        L_0x018c:
            okhttp3.RequestBody r1 = com.facebook.react.modules.network.RequestBodyUtil.getEmptyBody(r16)
            goto L_0x0195
        L_0x0191:
            okhttp3.RequestBody r1 = com.facebook.react.modules.network.RequestBodyUtil.getEmptyBody(r16)
        L_0x0195:
            okhttp3.RequestBody r1 = r15.wrapRequestBodyWithProgressEmitter(r1, r4, r3)
            r8.method(r0, r1)
            r15.addRequest(r3)
