        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                while (i2 < readableArray.size()) {
                    ...
                    int i3 = min;
                    int i4 = i2;
                    Cursor query = AsyncStorageModule.this.mReactDatabaseSupplier.get().query("catalystLocalStorage", strArr, AsyncLocalStorageUtil.buildKeySelection(min), AsyncLocalStorageUtil.buildKeySelectionArgs(readableArray, i2, min), (String) null, (String) null, (String) null);
                    hashSet.clear();
                    try {
        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    WritableMap error = AsyncStorageErrorUtil.getError((String) null, e7.getMessage());
                    try {
                        AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                    } catch (Exception e8) {
                        FLog.w(ReactConstants.TAG, e8.getMessage(), (Throwable) e8);
                        if (error == null) {
                            writableMap = AsyncStorageErrorUtil.getError((String) null, e8.getMessage());
                        }
                    }
                    writableMap = error;
                } catch (Throwable th) {
                    try {
                        ...
                        FLog.w(ReactConstants.TAG, e9.getMessage(), (Throwable) e9);
                        AsyncStorageErrorUtil.getError((String) null, e9.getMessage());
                    }
                    throw th;
                }
                if (writableMap != null) {
