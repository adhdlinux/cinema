...
public class AccessibilityInfoModule extends NativeAccessibilityInfoSpec implements LifecycleEventListener {
    ...
    public void updateAndSendAccessibilityServiceChangeEvent(boolean z2) {
    ...
    /* access modifiers changed from: private */
    public void updateAndSendTouchExplorationChangeEvent(boolean z2) {
    ...
    public void getRecommendedTimeoutMillis(double d2, Callback callback) {
        ...
        int a2 = this.mAccessibilityManager.getRecommendedTimeoutMillis((int) d2, 4);
        this.mRecommendedTimeout = a2;
