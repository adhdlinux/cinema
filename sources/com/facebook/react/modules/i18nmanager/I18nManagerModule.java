...
public class I18nManagerModule extends NativeI18nManagerSpec {
    ...
    public void allowRTL(boolean z2) {
        this.sharedI18nUtilInstance.allowRTL(getReactApplicationContext(), z2);
    }

    public void forceRTL(boolean z2) {
        this.sharedI18nUtilInstance.forceRTL(getReactApplicationContext(), z2);
    }
    ...
    public void swapLeftAndRightInRTL(boolean z2) {
        this.sharedI18nUtilInstance.swapLeftAndRightInRTL(getReactApplicationContext(), z2);
    }
}
