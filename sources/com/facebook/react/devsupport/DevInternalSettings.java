...
public class DevInternalSettings implements DeveloperSettings, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void setElementInspectorEnabled(boolean z2) {
        this.mPreferences.edit().putBoolean(PREFS_INSPECTOR_DEBUG_KEY, z2).apply();
    }

    public void setFpsDebugEnabled(boolean z2) {
        this.mPreferences.edit().putBoolean(PREFS_FPS_DEBUG_KEY, z2).apply();
    }

    public void setHotModuleReplacementEnabled(boolean z2) {
        this.mPreferences.edit().putBoolean(PREFS_HOT_MODULE_REPLACEMENT_KEY, z2).apply();
    }

    public void setJSDevModeEnabled(boolean z2) {
        this.mPreferences.edit().putBoolean(PREFS_JS_DEV_MODE_DEBUG_KEY, z2).apply();
    }

    public void setRemoteJSDebugEnabled(boolean z2) {
        this.mPreferences.edit().putBoolean(PREFS_REMOTE_JS_DEBUG_KEY, z2).apply();
    }
}
