...
public class DevServerHelper {
    ...
    public java.io.File downloadBundleResourceFromUrlSync(java.lang.String r5, java.io.File r6) {
        /*
            ...
            r1 = 0
            okhttp3.OkHttpClient r2 = r4.mClient     // Catch:{ Exception -> 0x0062 }
            okhttp3.Call r0 = r2.newCall(r0)     // Catch:{ Exception -> 0x0062 }
            okhttp3.Response r0 = r0.execute()     // Catch:{ Exception -> 0x0062 }
            boolean r2 = r0.isSuccessful()     // Catch:{ all -> 0x0056 }
            if (r2 != 0) goto L_0x0030
            r0.close()     // Catch:{ Exception -> 0x0062 }
            return r1
        L_0x0030:
            okio.Sink r2 = okio.Okio.f(r6)     // Catch:{ all -> 0x004e }
            okhttp3.ResponseBody r3 = r0.body()     // Catch:{ all -> 0x004c }
            okio.BufferedSource r3 = r3.source()     // Catch:{ all -> 0x004c }
            okio.BufferedSource r3 = okio.Okio.d(r3)     // Catch:{ all -> 0x004c }
            r3.i0(r2)     // Catch:{ all -> 0x004c }
        ...
        L_0x005d:
            r0 = move-exception
            r2.addSuppressed(r0)     // Catch:{ Exception -> 0x0062 }
        L_0x0061:
            throw r2     // Catch:{ Exception -> 0x0062 }
        L_0x0062:
            r0 = move-exception
            r2 = 3
    ...
    public void openStackFrameCall(StackFrame stackFrame) {
        ((Call) Assertions.assertNotNull(this.mClient.newCall(new Request.Builder().url(createOpenStackFrameURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).post(RequestBody.create(MediaType.parse(TraktV2.CONTENT_TYPE_JSON), stackFrame.toJSON().toString())).build()))).enqueue(new Callback() {
            public void onFailure(Call call, IOException iOException) {
        ...
        new AsyncTask<Void, String, Boolean>() {
            public boolean doSync() {
                try {
                    ...
                    new OkHttpClient().newCall(new Request.Builder().url(access$600).post(RequestBody.create(MediaType.parse(TraktV2.CONTENT_TYPE_JSON), new JSONObject().put(ImagesContract.URL, str).toString())).build()).execute();
                    return true;
                } catch (IOException | JSONException e2) {
                    FLog.e(ReactConstants.TAG, "Failed to open URL" + str, e2);
                    return false;
                }
            }
    ...
    public void symbolicateStackTrace(Iterable<StackFrame> iterable, final SymbolicationListener symbolicationListener) {
        try {
            ...
            ((Call) Assertions.assertNotNull(this.mClient.newCall(new Request.Builder().url(createSymbolicateURL).post(RequestBody.create(MediaType.parse(TraktV2.CONTENT_TYPE_JSON), new JSONObject().put("stack", jSONArray).toString())).build()))).enqueue(new Callback() {
                public void onFailure(Call call, IOException iOException) {
    ...
    private String createBundleURL(String str, BundleType bundleType, String str2, boolean z2, boolean z3) {
        ...
        String str3 = "true";
        objArr[6] = z2 ? str3 : Constants.CASEFIRST_FALSE;
        if (!z3) {
