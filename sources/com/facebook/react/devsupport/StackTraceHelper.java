...
public class StackTraceHelper {
    ...
    public static StackFrame[] convertJsStackTrace(ReadableArray readableArray) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (type == ReadableType.Map) {
                ...
                stackFrameArr[i2] = new StackFrameImpl(map.getString("file"), string, (!map.hasKey("lineNumber") || map.isNull("lineNumber")) ? -1 : map.getInt("lineNumber"), (!map.hasKey("column") || map.isNull("column")) ? -1 : map.getInt("column"), map.hasKey("collapse") && !map.isNull("collapse") && map.getBoolean("collapse"));
    ...
    public static class StackFrameImpl implements StackFrame {
        ...
        public JSONObject toJSON() {
            return new JSONObject(MapBuilder.of("file", getFile(), JSStackTrace.METHOD_NAME_KEY, getMethod(), "lineNumber", Integer.valueOf(getLine()), "column", Integer.valueOf(getColumn()), "collapse", Boolean.valueOf(isCollapsed())));
        }
    ...
    public static StackFrame[] convertJsStackTrace(JSONArray jSONArray) {
        ...
        while (i2 < length) {
            try {
                ...
                stackFrameArr[i2] = new StackFrameImpl(jSONObject.getString("file"), jSONObject.getString(JSStackTrace.METHOD_NAME_KEY), (!jSONObject.has("lineNumber") || jSONObject.isNull("lineNumber")) ? -1 : jSONObject.getInt("lineNumber"), (!jSONObject.has("column") || jSONObject.isNull("column")) ? -1 : jSONObject.getInt("column"), jSONObject.has("collapse") && !jSONObject.isNull("collapse") && jSONObject.getBoolean("collapse"));
                i2++;
