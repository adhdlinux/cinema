...
public class ReactTextInputShadowNode extends ReactBaseTextShadowNode implements YogaMeasureFunction {
    ...
    public long measure(YogaNode yogaNode, float f2, YogaMeasureMode yogaMeasureMode, float f3, YogaMeasureMode yogaMeasureMode2) {
        ...
        if (reactTextInputLocalData != null) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && editText.getBreakStrategy() != (i2 = this.mTextBreakStrategy)) {
    ...
    public void setThemedContext(ThemedReactContext themedReactContext) {
        ...
        setDefaultPadding(4, (float) ViewCompat.I(createInternalEditText));
        setDefaultPadding(1, (float) createInternalEditText.getPaddingTop());
        setDefaultPadding(5, (float) ViewCompat.H(createInternalEditText));
