...
public class ReactProgressBarViewManager extends BaseViewManager<ProgressBarContainerView, ProgressBarShadowNode> implements AndroidProgressBarManagerInterface<ProgressBarContainerView> {
    ...
    public static ProgressBar createProgressBar(Context context, int i2) {
        ...
        synchronized (sProgressBarCtorLock) {
            progressBar = new ProgressBar(context, (AttributeSet) null, i2);
        }
        return progressBar;
    }
    ...
    public void setAnimating(ProgressBarContainerView progressBarContainerView, boolean z2) {
        progressBarContainerView.setAnimating(z2);
    }
    ...
    public void setIndeterminate(ProgressBarContainerView progressBarContainerView, boolean z2) {
        progressBarContainerView.setIndeterminate(z2);
    }
