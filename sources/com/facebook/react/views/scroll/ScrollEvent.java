...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    private void init(int i2, int i3, ScrollEventType scrollEventType, float f2, float f3, float f4, float f5, int i4, int i5, int i6, int i7) {
        super.init(i2, i3);
    ...
    public WritableMap getEventData() {
        ...
        createMap2.putDouble("x", (double) PixelUtil.toDIPFromPixel(this.mScrollX));
        createMap2.putDouble("y", (double) PixelUtil.toDIPFromPixel(this.mScrollY));
        ...
        createMap5.putDouble("x", (double) this.mXVelocity);
        createMap5.putDouble("y", (double) this.mYVelocity);
    ...
    public static ScrollEvent obtain(int i2, int i3, ScrollEventType scrollEventType, float f2, float f3, float f4, float f5, int i4, int i5, int i6, int i7) {
        ...
        acquire.init(i2, i3, scrollEventType, f2, f3, f4, f5, i4, i5, i6, i7);
        return acquire;
    }
}
