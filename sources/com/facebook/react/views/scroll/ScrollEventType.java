...
public enum ScrollEventType {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = $SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = $SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = $SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x003e }
    ...
    public static String getJSEventName(ScrollEventType scrollEventType) {
        int i2 = AnonymousClass1.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType[scrollEventType.ordinal()];
        if (i2 == 1) {
