...
public class PipelineDraweeController extends AbstractDraweeController<CloseableReference<CloseableImage>, ImageInfo> {
    ...
    public synchronized com.facebook.imagepipeline.listener.RequestListener getRequestListener() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r0 = r3.mImageOriginListener     // Catch:{ all -> 0x0024 }
            if (r0 == 0) goto L_0x0011
            com.facebook.drawee.backends.pipeline.info.ImageOriginRequestListener r0 = new com.facebook.drawee.backends.pipeline.info.ImageOriginRequestListener     // Catch:{ all -> 0x0024 }
            java.lang.String r1 = r3.getId()     // Catch:{ all -> 0x0024 }
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r2 = r3.mImageOriginListener     // Catch:{ all -> 0x0024 }
            r0.<init>(r1, r2)     // Catch:{ all -> 0x0024 }
            goto L_0x0012
        L_0x0011:
            r0 = 0
        L_0x0012:
            java.util.Set<com.facebook.imagepipeline.listener.RequestListener> r1 = r3.mRequestListeners     // Catch:{ all -> 0x0024 }
            if (r1 == 0) goto L_0x0022
            com.facebook.imagepipeline.listener.ForwardingRequestListener r2 = new com.facebook.imagepipeline.listener.ForwardingRequestListener     // Catch:{ all -> 0x0024 }
            r2.<init>((java.util.Set<com.facebook.imagepipeline.listener.RequestListener>) r1)     // Catch:{ all -> 0x0024 }
            if (r0 == 0) goto L_0x0020
            r2.addRequestListener(r0)     // Catch:{ all -> 0x0024 }
        L_0x0020:
            monitor-exit(r3)
            return r2
        L_0x0022:
    ...
    /* access modifiers changed from: protected */
    public synchronized void initializePerformanceMonitoring(ImagePerfDataListener imagePerfDataListener, AbstractDraweeControllerBuilder<PipelineDraweeControllerBuilder, ImageRequest, CloseableReference<CloseableImage>, ImageInfo> abstractDraweeControllerBuilder, Supplier<Boolean> supplier) {
