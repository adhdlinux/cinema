...
public class YogaNative {
    ...
    static native void jni_YGConfigSetExperimentalFeatureEnabledJNI(long j2, int i2, boolean z2);
    ...
    static native void jni_YGConfigSetPrintTreeFlagJNI(long j2, boolean z2);

    static native void jni_YGConfigSetShouldDiffLayoutWithoutLegacyStretchBehaviourJNI(long j2, boolean z2);

    static native void jni_YGConfigSetUseLegacyStretchBehaviourJNI(long j2, boolean z2);

    static native void jni_YGConfigSetUseWebDefaultsJNI(long j2, boolean z2);
    ...
    static native void jni_YGNodeSetHasBaselineFuncJNI(long j2, boolean z2);

    static native void jni_YGNodeSetHasMeasureFuncJNI(long j2, boolean z2);

    static native void jni_YGNodeSetIsReferenceBaselineJNI(long j2, boolean z2);
