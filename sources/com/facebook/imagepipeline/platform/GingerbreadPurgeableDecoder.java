...
public class GingerbreadPurgeableDecoder extends DalvikPurgeableDecoder {
    ...
    private static MemoryFile copyToMemoryFile(CloseableReference<PooledByteBuffer> closeableReference, int i2, byte[] bArr) throws IOException {
        int i3;
        Closeable closeable;
        ...
        MemoryFile memoryFile = new MemoryFile((String) null, i3 + i2);
    ...
    public Bitmap decodeJPEGByteArrayAsPurgeable(CloseableReference<PooledByteBuffer> closeableReference, int i2, BitmapFactory.Options options) {
        ...
        return decodeFileDescriptorAsPurgeable(closeableReference, i2, bArr, options);
    }
}
