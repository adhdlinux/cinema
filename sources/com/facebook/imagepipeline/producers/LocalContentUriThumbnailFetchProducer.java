    ...
    private static int getRotationAngle(String str) {
        if (str != null) {
            try {
                ...
                FLog.e(TAG, (Throwable) e2, "Unable to retrieve thumbnail rotation for %s", str);
            }
        }
        return 0;
    }

    private EncodedImage getThumbnail(ResizeOptions resizeOptions, long j2) throws IOException {
