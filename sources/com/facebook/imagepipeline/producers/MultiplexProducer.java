...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    class Multiplexer {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x004a, code lost:
            if (com.facebook.imagepipeline.producers.BaseConsumer.isLast(r9) == false) goto L_0x0081;
         */
        ...
        public void onNextResult(com.facebook.imagepipeline.producers.MultiplexProducer<K, T>.Multiplexer.ForwardingConsumer r7, T r8, int r9) {
            /*
                r6 = this;
                monitor-enter(r6)
                com.facebook.imagepipeline.producers.MultiplexProducer<K, T>$Multiplexer.ForwardingConsumer r0 = r6.mForwardingConsumer     // Catch:{ all -> 0x008e }
                if (r0 == r7) goto L_0x0007
                monitor-exit(r6)     // Catch:{ all -> 0x008e }
                return
            L_0x0007:
                T r7 = r6.mLastIntermediateResult     // Catch:{ all -> 0x008e }
                r6.closeSafely(r7)     // Catch:{ all -> 0x008e }
                r7 = 0
                r6.mLastIntermediateResult = r7     // Catch:{ all -> 0x008e }
                java.util.concurrent.CopyOnWriteArraySet<android.util.Pair<com.facebook.imagepipeline.producers.Consumer<T>, com.facebook.imagepipeline.producers.ProducerContext>> r0 = r6.mConsumerContextPairs     // Catch:{ all -> 0x008e }
                java.util.Iterator r0 = r0.iterator()     // Catch:{ all -> 0x008e }
                java.util.concurrent.CopyOnWriteArraySet<android.util.Pair<com.facebook.imagepipeline.producers.Consumer<T>, com.facebook.imagepipeline.producers.ProducerContext>> r1 = r6.mConsumerContextPairs     // Catch:{ all -> 0x008e }
                int r1 = r1.size()     // Catch:{ all -> 0x008e }
                boolean r2 = com.facebook.imagepipeline.producers.BaseConsumer.isNotLast(r9)     // Catch:{ all -> 0x008e }
                if (r2 == 0) goto L_0x002c
                com.facebook.imagepipeline.producers.MultiplexProducer r2 = com.facebook.imagepipeline.producers.MultiplexProducer.this     // Catch:{ all -> 0x008e }
                java.io.Closeable r2 = r2.cloneOrNull(r8)     // Catch:{ all -> 0x008e }
                r6.mLastIntermediateResult = r2     // Catch:{ all -> 0x008e }
                r6.mLastStatus = r9     // Catch:{ all -> 0x008e }
                goto L_0x0038
            L_0x002c:
                java.util.concurrent.CopyOnWriteArraySet<android.util.Pair<com.facebook.imagepipeline.producers.Consumer<T>, com.facebook.imagepipeline.producers.ProducerContext>> r2 = r6.mConsumerContextPairs     // Catch:{ all -> 0x008e }
                r2.clear()     // Catch:{ all -> 0x008e }
                com.facebook.imagepipeline.producers.MultiplexProducer r2 = com.facebook.imagepipeline.producers.MultiplexProducer.this     // Catch:{ all -> 0x008e }
                K r3 = r6.mKey     // Catch:{ all -> 0x008e }
                r2.removeMultiplexer(r3, r6)     // Catch:{ all -> 0x008e }
            L_0x0038:
                monitor-exit(r6)     // Catch:{ all -> 0x008e }
            L_0x0039:
                ...
                monitor-enter(r2)
                boolean r3 = com.facebook.imagepipeline.producers.BaseConsumer.isLast(r9)     // Catch:{ all -> 0x008a }
                if (r3 == 0) goto L_0x0081
                java.lang.Object r3 = r2.second     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.ProducerContext r3 = (com.facebook.imagepipeline.producers.ProducerContext) r3     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.ProducerListener2 r3 = r3.getProducerListener()     // Catch:{ all -> 0x008a }
                java.lang.Object r4 = r2.second     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.ProducerContext r4 = (com.facebook.imagepipeline.producers.ProducerContext) r4     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.MultiplexProducer r5 = com.facebook.imagepipeline.producers.MultiplexProducer.this     // Catch:{ all -> 0x008a }
                java.lang.String r5 = r5.mProducerName     // Catch:{ all -> 0x008a }
                r3.onProducerFinishWithSuccess(r4, r5, r7)     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.BaseProducerContext r3 = r6.mMultiplexProducerContext     // Catch:{ all -> 0x008a }
                if (r3 == 0) goto L_0x0070
                java.lang.Object r4 = r2.second     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.ProducerContext r4 = (com.facebook.imagepipeline.producers.ProducerContext) r4     // Catch:{ all -> 0x008a }
                java.util.Map r3 = r3.getExtras()     // Catch:{ all -> 0x008a }
                r4.putExtras(r3)     // Catch:{ all -> 0x008a }
            L_0x0070:
                java.lang.Object r3 = r2.second     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.ProducerContext r3 = (com.facebook.imagepipeline.producers.ProducerContext) r3     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.MultiplexProducer r4 = com.facebook.imagepipeline.producers.MultiplexProducer.this     // Catch:{ all -> 0x008a }
                java.lang.String r4 = r4.mDedupedRequestsCountKey     // Catch:{ all -> 0x008a }
                java.lang.Integer r5 = java.lang.Integer.valueOf(r1)     // Catch:{ all -> 0x008a }
                r3.setExtra(r4, r5)     // Catch:{ all -> 0x008a }
            L_0x0081:
                java.lang.Object r3 = r2.first     // Catch:{ all -> 0x008a }
                com.facebook.imagepipeline.producers.Consumer r3 = (com.facebook.imagepipeline.producers.Consumer) r3     // Catch:{ all -> 0x008a }
                r3.onNewResult(r8, r9)     // Catch:{ all -> 0x008a }
    ...
    protected MultiplexProducer(Producer<T> producer, String str, @ProducerContext.ExtraKeys String str2, boolean z2) {
