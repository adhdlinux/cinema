...
public class HttpUrlConnectionNetworkFetcher extends BaseNetworkFetcher<HttpUrlConnectionNetworkFetchState> {
    ...
    public HttpUrlConnectionNetworkFetcher(String str, Map<String, String> map, int i2) {
        this(str, map, (MonotonicClock) RealtimeSinceBootClock.get());
        this.mHttpConnectionTimeout = i2;
    }

    HttpUrlConnectionNetworkFetcher(String str, Map<String, String> map, MonotonicClock monotonicClock) {
