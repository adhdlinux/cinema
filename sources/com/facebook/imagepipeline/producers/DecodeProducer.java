...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class LocalImagesProgressiveDecoder extends ProgressiveDecoder {
        public LocalImagesProgressiveDecoder(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext, boolean z2, int i2) {
    ...
    private class NetworkImagesProgressiveDecoder extends ProgressiveDecoder {
        ...
        public NetworkImagesProgressiveDecoder(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext, ProgressiveJpegParser progressiveJpegParser, ProgressiveJpegConfig progressiveJpegConfig, boolean z2, int i2) {
            super(consumer, producerContext, z2, i2);
        ...
        public synchronized boolean updateDecodeJob(com.facebook.imagepipeline.image.EncodedImage r4, int r5) {
            /*
                ...
                boolean r1 = com.facebook.imagepipeline.producers.BaseConsumer.isNotLast(r5)     // Catch:{ all -> 0x0055 }
                if (r1 != 0) goto L_0x0013
                r1 = 8
                boolean r1 = com.facebook.imagepipeline.producers.BaseConsumer.statusHasFlag(r5, r1)     // Catch:{ all -> 0x0055 }
                if (r1 == 0) goto L_0x0053
            L_0x0013:
                r1 = 4
                boolean r5 = com.facebook.imagepipeline.producers.BaseConsumer.statusHasFlag(r5, r1)     // Catch:{ all -> 0x0055 }
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        public ProgressiveDecoder(Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext, final boolean z2, final int i2) {
            super(consumer);
        ...
        public void doDecode(com.facebook.imagepipeline.image.EncodedImage r21, int r22) {
            /*
                ...
                boolean r1 = com.facebook.imagepipeline.producers.BaseConsumer.isNotLast(r22)
            ...
            L_0x0034:
                ...
                boolean r6 = com.facebook.imagepipeline.producers.BaseConsumer.isLast(r22)
                r4 = 1
            ...
            L_0x006a:
                r9 = 4
                boolean r14 = com.facebook.imagepipeline.producers.BaseConsumer.statusHasFlag(r0, r9)
            ...
            L_0x0093:
                r15 = r2
            L_0x0094:
                com.facebook.imagepipeline.producers.JobScheduler r1 = r11.mJobScheduler     // Catch:{ all -> 0x013c }
                long r17 = r1.getQueuedTime()     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.producers.ProducerContext r1 = r11.mProducerContext     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.request.ImageRequest r1 = r1.getImageRequest()     // Catch:{ all -> 0x013c }
                android.net.Uri r1 = r1.getSourceUri()     // Catch:{ all -> 0x013c }
                java.lang.String r1 = java.lang.String.valueOf(r1)     // Catch:{ all -> 0x013c }
                if (r5 != 0) goto L_0x00b2
                if (r14 == 0) goto L_0x00ad
                goto L_0x00b2
            L_0x00ad:
                int r2 = r20.getIntermediateImageEndOffset(r21)     // Catch:{ all -> 0x013c }
                goto L_0x00b6
            L_0x00b2:
                int r2 = r21.getSize()     // Catch:{ all -> 0x013c }
            L_0x00b6:
                if (r5 != 0) goto L_0x00c0
                if (r14 == 0) goto L_0x00bb
                goto L_0x00c0
            L_0x00bb:
                com.facebook.imagepipeline.image.QualityInfo r3 = r20.getQualityInfo()     // Catch:{ all -> 0x013c }
                goto L_0x00c2
            L_0x00c0:
                com.facebook.imagepipeline.image.QualityInfo r3 = com.facebook.imagepipeline.image.ImmutableQualityInfo.FULL_QUALITY     // Catch:{ all -> 0x013c }
            L_0x00c2:
                r5 = r3
                com.facebook.imagepipeline.producers.ProducerListener2 r3 = r11.mProducerListener     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.producers.ProducerContext r14 = r11.mProducerContext     // Catch:{ all -> 0x013c }
                r3.onProducerStart(r14, r13)     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.image.CloseableImage r14 = r11.internalDecode(r12, r2, r5)     // Catch:{ DecodeException -> 0x00f7 }
                int r1 = r21.getSampleSize()     // Catch:{ Exception -> 0x00f1 }
            ...
            L_0x00d6:
                ...
                r3 = r17
                r9 = r15
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.mProducerListener     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x013c }
                r2.onProducerFinishWithSuccess(r3, r13, r1)     // Catch:{ all -> 0x013c }
                r11.setImageExtras(r12, r14)     // Catch:{ all -> 0x013c }
                r11.handleResult(r14, r0)     // Catch:{ all -> 0x013c }
            ...
            L_0x00f7:
                r0 = move-exception
                r2 = r0
                com.facebook.imagepipeline.image.EncodedImage r0 = r2.getEncodedImage()     // Catch:{ Exception -> 0x00f4 }
                ...
                r1 = 10
                java.lang.String r1 = r0.getFirstBytesAsHexString(r1)     // Catch:{ Exception -> 0x00f4 }
                r4 = 2
                r9[r4] = r1     // Catch:{ Exception -> 0x00f4 }
                int r0 = r0.getSize()     // Catch:{ Exception -> 0x00f4 }
                java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ Exception -> 0x00f4 }
                r1 = 3
                r9[r1] = r0     // Catch:{ Exception -> 0x00f4 }
                com.facebook.common.logging.FLog.w((java.lang.String) r14, (java.lang.String) r3, (java.lang.Object[]) r9)     // Catch:{ Exception -> 0x00f4 }
            ...
            L_0x0125:
                ...
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.mProducerListener     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x013c }
                r2.onProducerFinishWithFailure(r3, r13, r0, r1)     // Catch:{ all -> 0x013c }
                r11.handleError(r0)     // Catch:{ all -> 0x013c }
                com.facebook.imagepipeline.image.EncodedImage.closeSafely(r21)
                return
            L_0x013c:
                r0 = move-exception
        ...
        private Map<String, String> getExtraMap(CloseableImage closeableImage, long j2, QualityInfo qualityInfo, boolean z2, String str, String str2, String str3, String str4) {
        ...
        private CloseableImage internalDecode(EncodedImage encodedImage, int i2, QualityInfo qualityInfo) {
            ...
            try {
                return DecodeProducer.this.mImageDecoder.decode(encodedImage, i2, qualityInfo, this.mImageDecodeOptions);
        ...
        private void maybeFinish(boolean z2) {
            synchronized (this) {
                if (z2) {
                    if (!this.mIsFinished) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public DecodeProducer(com.facebook.common.memory.ByteArrayPool r1, java.util.concurrent.Executor r2, com.facebook.imagepipeline.decoder.ImageDecoder r3, com.facebook.imagepipeline.decoder.ProgressiveJpegConfig r4, boolean r5, boolean r6, boolean r7, com.facebook.imagepipeline.producers.Producer<com.facebook.imagepipeline.image.EncodedImage> r8, int r9, com.facebook.imagepipeline.core.CloseableReferenceFactory r10, java.lang.Runnable r11, com.facebook.common.internal.Supplier<java.lang.Boolean> r12) {
        /*
            r0 = this;
            r0.<init>()
