...
public class LocalExifThumbnailProducer implements ThumbnailProducer<EncodedImage> {
    ...
    public EncodedImage buildEncodedImage(PooledByteBuffer pooledByteBuffer, ExifInterface exifInterface) {
        ...
        if (decodeDimensions != null) {
            i2 = ((Integer) decodeDimensions.first).intValue();
        } else {
            i2 = -1;
        }
        if (decodeDimensions != null) {
            i3 = ((Integer) decodeDimensions.second).intValue();
        }
        ...
        try {
            ...
            encodedImage.setWidth(i2);
            encodedImage.setHeight(i3);
            return encodedImage;
        } catch (Throwable th) {
            CloseableReference.closeSafely((CloseableReference<?>) of);
            throw th;
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final AnonymousClass1 r02 = new StatefulProducerRunnable<EncodedImage>(consumer, producerListener, producerContext, PRODUCER_NAME) {
