...
public class BitmapCounter {
    ...
    public BitmapCounter(int i2, int i3) {
        ...
        Preconditions.checkArgument(Boolean.valueOf(i3 <= 0 ? false : z3));
        this.mMaxCount = i2;
        this.mMaxSize = i3;
    ...
    public synchronized void decrease(Bitmap bitmap) {
        ...
        Preconditions.checkArgument(z2, "No bitmaps registered.");
        ...
        Preconditions.checkArgument(z3, "Bitmap size bigger than the total registered size: %d, %d", Integer.valueOf(sizeInBytes), Long.valueOf(this.mSize));
        this.mSize -= j2;
        this.mCount--;
    }
