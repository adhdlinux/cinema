...
public class StagingArea {
    ...
    public synchronized com.facebook.imagepipeline.image.EncodedImage get(com.facebook.cache.common.CacheKey r7) {
        /*
            ...
            java.lang.Class<?> r1 = TAG     // Catch:{ all -> 0x004c }
            java.lang.String r2 = "Found closed reference %d for key %s (%d)"
            r3 = 3
            java.lang.Object[] r3 = new java.lang.Object[r3]     // Catch:{ all -> 0x004c }
            int r4 = java.lang.System.identityHashCode(r0)     // Catch:{ all -> 0x004c }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ all -> 0x004c }
            r5 = 0
            r3[r5] = r4     // Catch:{ all -> 0x004c }
            java.lang.String r4 = r7.getUriString()     // Catch:{ all -> 0x004c }
            r5 = 1
            r3[r5] = r4     // Catch:{ all -> 0x004c }
            ...
            com.facebook.common.logging.FLog.w((java.lang.Class<?>) r1, (java.lang.String) r2, (java.lang.Object[]) r3)     // Catch:{ all -> 0x004c }
            monitor-exit(r0)     // Catch:{ all -> 0x004c }
            monitor-exit(r6)
            r7 = 0
            return r7
        L_0x0045:
            com.facebook.imagepipeline.image.EncodedImage r7 = com.facebook.imagepipeline.image.EncodedImage.cloneOrNull(r0)     // Catch:{ all -> 0x004c }
            monitor-exit(r0)     // Catch:{ all -> 0x004c }
            r0 = r7
            goto L_0x004f
        L_0x004c:
        ...
        if (!(byteBufferRef == null || byteBufferRef2 == null)) {
            try {
                if (byteBufferRef.get() == byteBufferRef2.get()) {
                    this.mMap.remove(cacheKey);
                    CloseableReference.closeSafely((CloseableReference<?>) byteBufferRef2);
