...
public abstract class AbstractDataSource<T> implements DataSource<T> {
    ...
    private synchronized boolean setFailureInternal(java.lang.Throwable r3, java.util.Map<java.lang.String, java.lang.Object> r4) {
        /*
            r2 = this;
            monitor-enter(r2)
    ...
    /* access modifiers changed from: protected */
    public void notifyDataSubscriber(final DataSubscriber<T> dataSubscriber, Executor executor, final boolean z2, final boolean z3) {
        ...
        if (dataSourceInstrumenter != null) {
            r02 = dataSourceInstrumenter.decorateRunnable(r02, "AbstractDataSource_notifyDataSubscriber");
        }
    ...
    public boolean setResult(T t2, boolean z2) {
        return setResult(t2, z2, (Map<String, Object>) null);
    }
}
