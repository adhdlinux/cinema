...
public class UnicodeExtensionKeys {
    ...
    public static boolean isValidKeyword(String str, String str2, ILocaleObject iLocaleObject) throws JSRangeErrorException {
        ...
        } else if (s_validKeywords.containsKey(str)) {
            return Arrays.asList(s_validKeywords.get(str)).contains(str2);
        } else {
            return true;
        }
    }
    ...
    public static Object resolveKnownAliases(String str, Object obj) {
        ...
        if ((str.equals(Constants.COLLATION_EXTENSION_PARAM_NUMERIC_SHORT) || str.equals(Constants.COLLATION_EXTENSION_PARAM_CASEFIRST_SHORT)) && JSObjects.isString(obj) && obj.equals("no")) {
            return JSObjects.newString(Constants.CASEFIRST_FALSE);
        }
        return obj;
    }
