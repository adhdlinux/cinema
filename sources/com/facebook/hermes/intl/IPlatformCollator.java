...
public interface IPlatformCollator {
    ...
    public enum CaseFirst {
        ...
        public String toString() {
            int i2 = AnonymousClass1.$SwitchMap$com$facebook$hermes$intl$IPlatformCollator$CaseFirst[ordinal()];
            if (i2 == 1) {
    ...
    public enum Sensitivity {
        ...
        public String toString() {
            int i2 = AnonymousClass1.$SwitchMap$com$facebook$hermes$intl$IPlatformCollator$Sensitivity[ordinal()];
            if (i2 == 1) {
    ...
    public enum Usage {
        ...
        public String toString() {
            int i2 = AnonymousClass1.$SwitchMap$com$facebook$hermes$intl$IPlatformCollator$Usage[ordinal()];
            if (i2 == 1) {
