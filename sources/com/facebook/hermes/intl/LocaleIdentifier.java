...
public class LocaleIdentifier {
    ...
    static boolean handleExtensions(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z2, ParsedLocaleIdentifier parsedLocaleIdentifier) throws JSRangeErrorException, LocaleIdTokenizer.LocaleIdSubtagIterationFailed {
        if (z2 && localeIdSubtag.isTranformedExtensionTKey()) {
    ...
    static void parseLanguageId(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, LocaleIdTokenizer.LocaleIdSubtag localeIdSubtag, boolean z2, ParsedLocaleIdentifier parsedLocaleIdentifier) throws JSRangeErrorException, LocaleIdTokenizer.LocaleIdSubtagIterationFailed {
        ...
        try {
            if (localeIdSubtag.isUnicodeLanguageSubtag()) {
                ...
                if (localeIdTokenizer.hasMoreSubtags()) {
                    ...
                    if (!handleExtensions(charSequence, localeIdTokenizer, nextSubtag, z2, parsedLocaleIdentifier)) {
                        ...
                        while (!handleExtensions(charSequence, localeIdTokenizer, nextSubtag, z2, parsedLocaleIdentifier)) {
    ...
    static void parseOtherExtensions(CharSequence charSequence, LocaleIdTokenizer localeIdTokenizer, ParsedLocaleIdentifier parsedLocaleIdentifier, char c2) throws JSRangeErrorException, LocaleIdTokenizer.LocaleIdSubtagIterationFailed {
        if (localeIdTokenizer.hasMoreSubtags()) {
            LocaleIdTokenizer.LocaleIdSubtag nextSubtag = localeIdTokenizer.nextSubtag();
            ...
            parsedLocaleIdentifier.otherExtensionsMap.put(new Character(c2), arrayList);
