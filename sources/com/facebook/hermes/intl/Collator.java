...
public class Collator {
    ...
    public Collator(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        if (Build.VERSION.SDK_INT >= 24) {
            this.mPlatformCollatorObject = new PlatformCollatorICU();
        } else {
            this.mPlatformCollatorObject = new PlatformCollatorAndroid();
        }
    ...
    private void initializeCollator(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        ...
        if (this.mResolvedUsage == IPlatformCollator.Usage.SEARCH) {
            ...
            Iterator<String> it2 = unicodeExtensions.iterator();
            while (it2.hasNext()) {
                arrayList.add(UnicodeExtensionKeys.resolveCollationAlias(it2.next()));
            }
