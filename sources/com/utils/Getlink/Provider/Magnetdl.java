...
public class Magnetdl extends BaseProvider {

    /* renamed from: e  reason: collision with root package name */
    public String f37378e = Utils.getProvider(13);
    ...
    public void J(MovieInfo movieInfo, ObservableEmitter<? super MediaSource> observableEmitter, boolean z2) {
        ...
        hashMap.put("referer", this.f37378e + "/");
        hashMap.put("upgrade-insecure-requests", "1");
        Iterator it4 = Jsoup.b(HttpHelper.i().m(this.f37378e + "/search/?q=" + com.original.tase.utils.Utils.k(movieInfo2.name + str, new boolean[0]) + "&m=1&x=" + Utils.p0(1, 100) + "&y=" + Utils.p0(1, 50), hashMap)).q0("table.download").g("tr").iterator();
        ...
        while (it4.hasNext()) {
            try {
                ...
                String c2 = element.r0("td.n").r0(a.f20042a).c("title");
                if (z4) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (h2.startsWith(TitleHelper.h(sb.toString(), ""))) {
                                hashMap2.put(Regex.a(element.toString(), "href\\s*=\\s*['\"](magnet.*?[^'\"]+)['\"]?", 1), c2);
                            }
                    ...
                    arrayList2 = arrayList3;
                    if (z2) {
                        SeasonPack c3 = SeasonPack.c(c2);
                        if (c3 != null) {
                            Logger.a(A() + c2 + c3.toString());
                            if (c3.b(movieInfo2, str)) {
                                Regex.a(element.toString(), "href\\s*=\\s*['\"](magnet.*?[^'\"]+)['\"]?", 1);
                                hashMap2.put(element.toString(), c2);
                            }
                        }
                    } else {
                        if (TitleHelper.h(c2.toLowerCase().replace(movieInfo2.year, ""), "").startsWith(TitleHelper.h(movieInfo.getName().toLowerCase() + str.toLowerCase(), ""))) {
                            hashMap2.put(Regex.a(element.toString(), "href\\s*=\\s*['\"](magnet.*?[^'\"]+)['\"]?", 1), c2);
                        }
                    }
                }
        ...
        while (it5.hasNext()) {
            ...
            try {
                ...
                if (z2) {
                    String a2 = Regex.a(str3, "[sS]['\"]>(\\d+)\\s*<", 1);
                    String a3 = Regex.a(str3, "[Ll]['\"]>(\\d+)\\s*<", 1);
