...
public class MyWS extends BaseProvider {
    ...
    private String f37387e = Utils.getProvider(74);

    /* renamed from: f  reason: collision with root package name */
    private String f37388f = "Ij4aiaQXgluXQRs6";

    /* renamed from: g  reason: collision with root package name */
    private String f37389g = "8z5Ag5wgagfsOuhz";
    ...
    private void J(ObservableEmitter<? super MediaSource> observableEmitter, String str, MovieInfo movieInfo) {
        ...
        if (!a2.isEmpty()) {
            String n2 = KotlinHelper.f37692a.n(a2, this.f37388f);
            HashMap<String, String> c2 = Constants.c();
            c2.put("accept", "application/json, text/javascript, */*; q=0.01");
            c2.put("referer", str4);
            String replace = HttpHelper.i().m(this.f37387e + "/ajax/episode/list/" + a2 + "?vrf=" + n2, c2).replace("\\", "");
            if (!z2) {
            ...
            if (!str2.isEmpty()) {
                Iterator it3 = Jsoup.b(HttpHelper.i().m(this.f37387e + "/ajax/server/list/" + str2 + "?vrf=" + KotlinHelper.f37692a.n(str2, this.f37388f), c2).replace("\\", "")).q0("span.server").iterator();
                while (it3.hasNext()) {
                    ...
                    if (!str3.isEmpty()) {
                        ...
                        String m2 = companion.m(Regex.a(HttpHelper.i().m(this.f37387e + "/ajax/server/" + str3 + "?vrf=" + companion.n(str3, this.f37388f), c2).replace("\\", ""), "['\"]?(?:url|src|link)['\"]?\\s*[=|:]\\s*['\"]([^'\"]+)['\"]", 1), this.f37389g);
                        if (!m2.isEmpty()) {
    ...
    private String K(MovieInfo movieInfo) {
        ...
        Iterator it2 = Jsoup.b(HttpHelper.i().m(this.f37387e + "/filter?keyword=" + k2, new Map[0])).q0("div.germ").g("div.entity").iterator();
        while (it2.hasNext()) {
            Element element = (Element) it2.next();
            String v02 = element.r0("h5").v0();
            if (!v02.isEmpty()) {
                if (z2) {
