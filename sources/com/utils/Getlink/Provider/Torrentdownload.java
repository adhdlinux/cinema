...
public class Torrentdownload extends BaseProvider {

    /* renamed from: e  reason: collision with root package name */
    public String f37472e = Utils.getProvider(11);
    ...
    public void J(MovieInfo movieInfo, ObservableEmitter<? super MediaSource> observableEmitter, boolean z2) {
        ...
        sb.append(this.f37472e);
        String str5 = "/";
        sb.append(str5);
        hashMap.put("referer", sb.toString());
        hashMap.put("upgrade-insecure-requests", "1");
        Iterator it4 = Jsoup.b(HttpHelper.i().m(this.f37472e + "/search/?search=" + TitleHelper.h(movieInfo2.name + str, "+").replace("+", "%20"), hashMap)).q0("div.inner_container").g("div.grey_bar3").iterator();
        ...
        while (it5.hasNext()) {
            ...
            try {
                ...
                if (z2) {
                    String a2 = Regex.a(m2, "Seeds:\\s*<\\/span>\\s*(\\d+)\\s*<", 1);
                    String a3 = Regex.a(m2, "Leechers:\\s*<\\/span>\\s*(\\d+)\\s*<", 1);
        ...
        if (arrayList.size() > 0) {
            ...
            mediaSource.setStreamLink("magnet:Torrentdownload");
