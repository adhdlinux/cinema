...
public class FileRio extends PremiumResolver {
    public String c() {
        return "FileRio";
    }
    ...
    public void l(MediaSource mediaSource, ObservableEmitter<? super MediaSource> observableEmitter) {
        String a2 = Regex.a(mediaSource.getStreamLink(), "(?://|\\.)(filerio\\.in)/(?:embed-|embed/)?([0-9a-zA-Z]+)", 2);
        if (!a2.isEmpty()) {
            super.l(mediaSource, observableEmitter);
            if (!Utils.f37611d) {
                String str = "https://filerio.in/embed-" + a2 + ".html";
