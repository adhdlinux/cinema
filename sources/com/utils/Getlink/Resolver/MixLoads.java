...
public class MixLoads extends PremiumResolver {
    public String c() {
        return "MixLoads";
    }
    ...
    public void l(MediaSource mediaSource, ObservableEmitter<? super MediaSource> observableEmitter) {
        String a2 = Regex.a(mediaSource.getStreamLink(), "(?://|\\.)(mixloads\\.com)/(?:embed-|embed/)?([0-9a-zA-Z]+)", 2);
        if (!a2.isEmpty()) {
            super.l(mediaSource, observableEmitter);
            if (!Utils.f37611d) {
                String str = "https://mixloads.com/embed-" + a2 + ".html";
