...
public class Fembed extends BaseResolver {
    ...
    public void l(MediaSource mediaSource, ObservableEmitter<? super MediaSource> observableEmitter) {
        ...
        String b2 = Regex.b(streamLink, "(?:\\/|\\.)(fembed|24hd|gcloud|mediashore|feurl|club|bmoviesfree|mediashore|streamm4u|vanfem|moviepl|embedsito)\\.(?:com|be|live|link|io|org|club|xyz)\\/(?:v|f|e)\\/([0-9a-zA-Z-]+)", 2, 2);
        if (!b2.isEmpty()) {
            ...
            String replace = i2.l("https://" + str + "/api/source/" + b2, "r=&d=" + str, c2).replace("\\/", "/");
