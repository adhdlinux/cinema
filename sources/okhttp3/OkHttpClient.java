...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            Intrinsics.e(socketFactory2, "getDefault()");
        ...
        public final Builder m334addInterceptor(Function1<? super Interceptor.Chain, Response> function1) {
            Intrinsics.f(function1, "block");
            return addInterceptor(new OkHttpClient$Builder$addInterceptor$2(function1));
        }

        /* renamed from: -addNetworkInterceptor  reason: not valid java name */
        public final Builder m335addNetworkInterceptor(Function1<? super Interceptor.Chain, Response> function1) {
            Intrinsics.f(function1, "block");
        ...
        public final Builder authenticator(Authenticator authenticator2) {
            Intrinsics.f(authenticator2, "authenticator");
            this.authenticator = authenticator2;
            return this;
        }
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner2) {
            Intrinsics.f(certificatePinner2, "certificatePinner");
        ...
        public final Builder connectionPool(ConnectionPool connectionPool2) {
            Intrinsics.f(connectionPool2, "connectionPool");
        ...
        public final Builder eventListenerFactory(EventListener.Factory factory) {
            Intrinsics.f(factory, "eventListenerFactory");
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier2) {
            Intrinsics.f(hostnameVerifier2, "hostnameVerifier");
        ...
        public final Builder protocols(List<? extends Protocol> list) {
            ...
            if (z2) {
                ...
                } else if (!c02.contains(Protocol.HTTP_1_0)) {
                    Intrinsics.d(c02, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Protocol?>");
                    if (!c02.contains((Object) null)) {
                        c02.remove(Protocol.SPDY_3);
                        if (!Intrinsics.a(c02, this.protocols)) {
                            this.routeDatabase = null;
                        }
        ...
        public final Builder proxyAuthenticator(Authenticator authenticator2) {
            Intrinsics.f(authenticator2, "proxyAuthenticator");
        ...
        public final void setAuthenticator$okhttp(Authenticator authenticator2) {
            Intrinsics.f(authenticator2, "<set-?>");
            this.authenticator = authenticator2;
        }
        ...
        public final void setCertificatePinner$okhttp(CertificatePinner certificatePinner2) {
            Intrinsics.f(certificatePinner2, "<set-?>");
            this.certificatePinner = certificatePinner2;
        }
        ...
        public final void setConnectionPool$okhttp(ConnectionPool connectionPool2) {
            Intrinsics.f(connectionPool2, "<set-?>");
            this.connectionPool = connectionPool2;
        }
        ...
        public final void setHostnameVerifier$okhttp(HostnameVerifier hostnameVerifier2) {
            Intrinsics.f(hostnameVerifier2, "<set-?>");
            this.hostnameVerifier = hostnameVerifier2;
        }
        ...
        public final void setSocketFactory$okhttp(SocketFactory socketFactory2) {
            Intrinsics.f(socketFactory2, "<set-?>");
            this.socketFactory = socketFactory2;
        }
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            boolean unused = CollectionsKt__MutableCollectionsKt.u(this.interceptors, okHttpClient.interceptors());
            boolean unused2 = CollectionsKt__MutableCollectionsKt.u(this.networkInterceptors, okHttpClient.networkInterceptors());
    ...
    public final Authenticator m308deprecated_authenticator() {
        return this.authenticator;
    }

    /* renamed from: -deprecated_cache  reason: not valid java name */
    public final Cache m309deprecated_cache() {
        return this.cache;
    }

    /* renamed from: -deprecated_callTimeoutMillis  reason: not valid java name */
    public final int m310deprecated_callTimeoutMillis() {
        return this.callTimeoutMillis;
    }

    /* renamed from: -deprecated_certificatePinner  reason: not valid java name */
    public final CertificatePinner m311deprecated_certificatePinner() {
        return this.certificatePinner;
    }

    /* renamed from: -deprecated_connectTimeoutMillis  reason: not valid java name */
    public final int m312deprecated_connectTimeoutMillis() {
        return this.connectTimeoutMillis;
    }

    /* renamed from: -deprecated_connectionPool  reason: not valid java name */
    public final ConnectionPool m313deprecated_connectionPool() {
        return this.connectionPool;
    }

    /* renamed from: -deprecated_connectionSpecs  reason: not valid java name */
    public final List<ConnectionSpec> m314deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    /* renamed from: -deprecated_cookieJar  reason: not valid java name */
    public final CookieJar m315deprecated_cookieJar() {
        return this.cookieJar;
    }

    /* renamed from: -deprecated_dispatcher  reason: not valid java name */
    public final Dispatcher m316deprecated_dispatcher() {
        return this.dispatcher;
    }

    /* renamed from: -deprecated_dns  reason: not valid java name */
    public final Dns m317deprecated_dns() {
        return this.dns;
    }

    /* renamed from: -deprecated_eventListenerFactory  reason: not valid java name */
    public final EventListener.Factory m318deprecated_eventListenerFactory() {
        return this.eventListenerFactory;
    }

    /* renamed from: -deprecated_followRedirects  reason: not valid java name */
    public final boolean m319deprecated_followRedirects() {
        return this.followRedirects;
    }

    /* renamed from: -deprecated_followSslRedirects  reason: not valid java name */
    public final boolean m320deprecated_followSslRedirects() {
        return this.followSslRedirects;
    }

    /* renamed from: -deprecated_hostnameVerifier  reason: not valid java name */
    public final HostnameVerifier m321deprecated_hostnameVerifier() {
        return this.hostnameVerifier;
    }

    /* renamed from: -deprecated_interceptors  reason: not valid java name */
    public final List<Interceptor> m322deprecated_interceptors() {
        return this.interceptors;
    }

    /* renamed from: -deprecated_networkInterceptors  reason: not valid java name */
    public final List<Interceptor> m323deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }

    /* renamed from: -deprecated_pingIntervalMillis  reason: not valid java name */
    public final int m324deprecated_pingIntervalMillis() {
        return this.pingIntervalMillis;
    }

    /* renamed from: -deprecated_protocols  reason: not valid java name */
    public final List<Protocol> m325deprecated_protocols() {
        return this.protocols;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m326deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_proxyAuthenticator  reason: not valid java name */
    public final Authenticator m327deprecated_proxyAuthenticator() {
        return this.proxyAuthenticator;
    }

    /* renamed from: -deprecated_proxySelector  reason: not valid java name */
    public final ProxySelector m328deprecated_proxySelector() {
        return this.proxySelector;
    }

    /* renamed from: -deprecated_readTimeoutMillis  reason: not valid java name */
    public final int m329deprecated_readTimeoutMillis() {
        return this.readTimeoutMillis;
    }

    /* renamed from: -deprecated_retryOnConnectionFailure  reason: not valid java name */
    public final boolean m330deprecated_retryOnConnectionFailure() {
        return this.retryOnConnectionFailure;
    }
    ...
    public final int m333deprecated_writeTimeoutMillis() {
