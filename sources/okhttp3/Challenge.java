...
public final class Challenge {
    ...
    public final Map<String, String> m246deprecated_authParams() {
        return this.authParams;
    }

    /* renamed from: -deprecated_charset  reason: not valid java name */
    public final Charset m247deprecated_charset() {
        return charset();
    }

    /* renamed from: -deprecated_realm  reason: not valid java name */
    public final String m248deprecated_realm() {
        return realm();
    }

    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m249deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        Map w2 = MapsKt__MapsKt.w(this.authParams);
        String name = charset.name();
        Intrinsics.e(name, "charset.name()");
        w2.put("charset", name);
        return new Challenge(this.scheme, (Map<String, String>) w2);
    }
