...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z2) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            strArr2 = Util.intersect(enabledProtocols, this.tlsVersionsAsString, ComparisonsKt__ComparisonsKt.b());
        } else {
        ...
        if (z2 && indexOf != -1) {
            Intrinsics.e(strArr, "cipherSuitesIntersection");
        ...
        Intrinsics.e(strArr2, "tlsVersionsIntersection");
        return cipherSuites.tlsVersions((String[]) Arrays.copyOf(strArr2, strArr2.length)).build();
    }

    /* renamed from: -deprecated_cipherSuites  reason: not valid java name */
    public final List<CipherSuite> m251deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* renamed from: -deprecated_supportsTlsExtensions  reason: not valid java name */
    public final boolean m252deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* renamed from: -deprecated_tlsVersions  reason: not valid java name */
    public final List<TlsVersion> m253deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        return ((i4 + i3) * 31) + (this.supportsTlsExtensions ^ true ? 1 : 0);
    }

    public final boolean isCompatible(SSLSocket sSLSocket) {
        Intrinsics.f(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            Intrinsics.f(cipherSuiteArr, "cipherSuites");
            if (this.tls) {
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersionArr) {
            Intrinsics.f(tlsVersionArr, "tlsVersions");
            if (this.tls) {
        ...
        public final Builder cipherSuites(String... strArr) {
            Intrinsics.f(strArr, "cipherSuites");
            if (this.tls) {
                if (!(strArr.length == 0)) {
        ...
        public final Builder tlsVersions(String... strArr) {
            Intrinsics.f(strArr, "tlsVersions");
            if (this.tls) {
                if (!(strArr.length == 0)) {
