...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private long idleAtNs = Clock.MAX_TIME;
    ...
    public static final class Companion {
        ...
        public final RealConnection newTestConnection(RealConnectionPool realConnectionPool, Route route, Socket socket, long j2) {
            Intrinsics.f(realConnectionPool, "connectionPool");
    ...
    private final void connectSocket(int i2, int i3, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            Platform.Companion.get().connectSocket(socket2, this.route.socketAddress(), i2);
            try {
                this.source = Okio.d(Okio.m(socket2));
                this.sink = Okio.c(Okio.i(socket2));
            } catch (NullPointerException e2) {
                if (Intrinsics.a(e2.getMessage(), NPE_THROW_WITH_NULL)) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:29:0x0176  */
    /* JADX WARNING: Removed duplicated region for block: B:31:0x0181  */
    ...
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r11) throws java.io.IOException {
        /*
            ...
            r2 = 0
            kotlin.jvm.internal.Intrinsics.c(r1)     // Catch:{ all -> 0x0173 }
            ...
            kotlin.jvm.internal.Intrinsics.d(r1, r3)     // Catch:{ all -> 0x0173 }
            javax.net.ssl.SSLSocket r1 = (javax.net.ssl.SSLSocket) r1     // Catch:{ all -> 0x0173 }
            okhttp3.ConnectionSpec r11 = r11.configureSecureSocket(r1)     // Catch:{ all -> 0x0170 }
            boolean r3 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x0170 }
            if (r3 == 0) goto L_0x004b
            okhttp3.internal.platform.Platform$Companion r3 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0170 }
            okhttp3.internal.platform.Platform r3 = r3.get()     // Catch:{ all -> 0x0170 }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ all -> 0x0170 }
            java.lang.String r4 = r4.host()     // Catch:{ all -> 0x0170 }
            java.util.List r5 = r0.protocols()     // Catch:{ all -> 0x0170 }
            r3.configureTlsExtensions(r1, r4, r5)     // Catch:{ all -> 0x0170 }
        L_0x004b:
            r1.startHandshake()     // Catch:{ all -> 0x0170 }
            javax.net.ssl.SSLSession r3 = r1.getSession()     // Catch:{ all -> 0x0170 }
            okhttp3.Handshake$Companion r4 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x0170 }
            java.lang.String r5 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.e(r3, r5)     // Catch:{ all -> 0x0170 }
            okhttp3.Handshake r4 = r4.get(r3)     // Catch:{ all -> 0x0170 }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ all -> 0x0170 }
            kotlin.jvm.internal.Intrinsics.c(r5)     // Catch:{ all -> 0x0170 }
            okhttp3.HttpUrl r7 = r0.url()     // Catch:{ all -> 0x0170 }
            java.lang.String r7 = r7.host()     // Catch:{ all -> 0x0170 }
            boolean r3 = r5.verify(r7, r3)     // Catch:{ all -> 0x0170 }
            if (r3 != 0) goto L_0x0104
            java.util.List r11 = r4.peerCertificates()     // Catch:{ all -> 0x0170 }
            r3 = r11
            java.util.Collection r3 = (java.util.Collection) r3     // Catch:{ all -> 0x0170 }
            boolean r3 = r3.isEmpty()     // Catch:{ all -> 0x0170 }
            r3 = r3 ^ r6
            if (r3 == 0) goto L_0x00e0
            r3 = 0
            java.lang.Object r11 = r11.get(r3)     // Catch:{ all -> 0x0170 }
            java.lang.String r3 = "null cannot be cast to non-null type java.security.cert.X509Certificate"
            kotlin.jvm.internal.Intrinsics.d(r11, r3)     // Catch:{ all -> 0x0170 }
            java.security.cert.X509Certificate r11 = (java.security.cert.X509Certificate) r11     // Catch:{ all -> 0x0170 }
            javax.net.ssl.SSLPeerUnverifiedException r3 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x0170 }
            ...
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x0170 }
            r4.append(r0)     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = " not verified:\n              |    certificate: "
            r4.append(r0)     // Catch:{ all -> 0x0170 }
            okhttp3.CertificatePinner$Companion r0 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = r0.pin(r11)     // Catch:{ all -> 0x0170 }
            r4.append(r0)     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = "\n              |    DN: "
            r4.append(r0)     // Catch:{ all -> 0x0170 }
            java.security.Principal r0 = r11.getSubjectDN()     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = r0.getName()     // Catch:{ all -> 0x0170 }
            r4.append(r0)     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = "\n              |    subjectAltNames: "
            r4.append(r0)     // Catch:{ all -> 0x0170 }
            okhttp3.internal.tls.OkHostnameVerifier r0 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x0170 }
            java.util.List r11 = r0.allSubjectAltNames(r11)     // Catch:{ all -> 0x0170 }
            r4.append(r11)     // Catch:{ all -> 0x0170 }
            java.lang.String r11 = "\n              "
            r4.append(r11)     // Catch:{ all -> 0x0170 }
            java.lang.String r11 = r4.toString()     // Catch:{ all -> 0x0170 }
            java.lang.String r11 = kotlin.text.StringsKt__IndentKt.h(r11, r2, r6, r2)     // Catch:{ all -> 0x0170 }
            r3.<init>(r11)     // Catch:{ all -> 0x0170 }
            throw r3     // Catch:{ all -> 0x0170 }
        L_0x00e0:
            javax.net.ssl.SSLPeerUnverifiedException r11 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x0170 }
            ...
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x0170 }
            r2.append(r0)     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = " not verified (no certificates)"
            r2.append(r0)     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = r2.toString()     // Catch:{ all -> 0x0170 }
            r11.<init>(r0)     // Catch:{ all -> 0x0170 }
            throw r11     // Catch:{ all -> 0x0170 }
        L_0x0104:
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ all -> 0x0170 }
            kotlin.jvm.internal.Intrinsics.c(r3)     // Catch:{ all -> 0x0170 }
            okhttp3.Handshake r5 = new okhttp3.Handshake     // Catch:{ all -> 0x0170 }
            okhttp3.TlsVersion r6 = r4.tlsVersion()     // Catch:{ all -> 0x0170 }
            okhttp3.CipherSuite r7 = r4.cipherSuite()     // Catch:{ all -> 0x0170 }
            java.util.List r8 = r4.localCertificates()     // Catch:{ all -> 0x0170 }
            okhttp3.internal.connection.RealConnection$connectTls$1 r9 = new okhttp3.internal.connection.RealConnection$connectTls$1     // Catch:{ all -> 0x0170 }
            r9.<init>(r3, r4, r0)     // Catch:{ all -> 0x0170 }
            r5.<init>(r6, r7, r8, r9)     // Catch:{ all -> 0x0170 }
            r10.handshake = r5     // Catch:{ all -> 0x0170 }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ all -> 0x0170 }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x0170 }
            okhttp3.internal.connection.RealConnection$connectTls$2 r4 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x0170 }
            r4.<init>(r10)     // Catch:{ all -> 0x0170 }
            r3.check$okhttp(r0, r4)     // Catch:{ all -> 0x0170 }
            boolean r11 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x0170 }
            if (r11 == 0) goto L_0x0143
            okhttp3.internal.platform.Platform$Companion r11 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0170 }
            okhttp3.internal.platform.Platform r11 = r11.get()     // Catch:{ all -> 0x0170 }
            java.lang.String r2 = r11.getSelectedProtocol(r1)     // Catch:{ all -> 0x0170 }
        L_0x0143:
            r10.socket = r1     // Catch:{ all -> 0x0170 }
            okio.Source r11 = okio.Okio.m(r1)     // Catch:{ all -> 0x0170 }
            okio.BufferedSource r11 = okio.Okio.d(r11)     // Catch:{ all -> 0x0170 }
            r10.source = r11     // Catch:{ all -> 0x0170 }
            okio.Sink r11 = okio.Okio.i(r1)     // Catch:{ all -> 0x0170 }
            okio.BufferedSink r11 = okio.Okio.c(r11)     // Catch:{ all -> 0x0170 }
            r10.sink = r11     // Catch:{ all -> 0x0170 }
            if (r2 == 0) goto L_0x0162
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x0170 }
            okhttp3.Protocol r11 = r11.get(r2)     // Catch:{ all -> 0x0170 }
            goto L_0x0164
        L_0x0162:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x0170 }
        L_0x0164:
            r10.protocol = r11     // Catch:{ all -> 0x0170 }
    ...
    private final Request createTunnel(int i2, int i3, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            bufferedSource.timeout().timeout((long) i2, timeUnit);
            ...
            if (code != 200) {
                if (code == 407) {
                    ...
                    } else if (StringsKt__StringsJVMKt.t(MRAIDPresenter.CLOSE, Response.header$default(build, "Connection", (String) null, 2, (Object) null), true)) {
                        return authenticate;
                    } else {
            ...
            } else if (bufferedSource.c().V() && bufferedSink.c().V()) {
                return null;
            } else {
    ...
    private final boolean routeMatchesAny(List<Route> list) {
        ...
        for (Route route2 : iterable) {
            if (route2.proxy().type() == Proxy.Type.DIRECT && this.route.proxy().type() == Proxy.Type.DIRECT && Intrinsics.a(this.route.socketAddress(), route2.socketAddress())) {
                z2 = true;
                continue;
            } else {
                z2 = false;
    ...
    private final void startHttp2(int i2) throws IOException {
        ...
        Http2Connection build = new Http2Connection.Builder(true, TaskRunner.INSTANCE).socket(socket2, this.route.address().url().host(), bufferedSource, bufferedSink).listener(this).pingIntervalMillis(i2).build();
    ...
    public final void connectFailed$okhttp(OkHttpClient okHttpClient, Route route2, IOException iOException) {
        ...
        Intrinsics.f(route2, "failedRoute");
        Intrinsics.f(iOException, "failure");
    ...
    public synchronized void onSettings(Http2Connection http2Connection2, Settings settings) {
        Intrinsics.f(http2Connection2, "connection");
        Intrinsics.f(settings, "settings");
        this.allocationLimit = settings.getMaxConcurrentStreams();
    }

    public void onStream(Http2Stream http2Stream) throws IOException {
        Intrinsics.f(http2Stream, "stream");
