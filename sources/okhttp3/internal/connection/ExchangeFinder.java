...
public final class ExchangeFinder {
    ...
    private final okhttp3.internal.connection.RealConnection findConnection(int r15, int r16, int r17, int r18, boolean r19) throws java.io.IOException {
        ...
        L_0x0036:
            kotlin.Unit r6 = kotlin.Unit.f40298a     // Catch:{ all -> 0x0061 }
            monitor-exit(r2)
        ...
        L_0x0150:
            ...
            kotlin.Unit r0 = kotlin.Unit.f40298a     // Catch:{ all -> 0x0166 }
            monitor-exit(r3)
    ...
    public final ExchangeCodec find(OkHttpClient okHttpClient, RealInterceptorChain realInterceptorChain) {
        ...
        try {
            ...
            if (!Intrinsics.a(realInterceptorChain.getRequest$okhttp().method(), "GET")) {
                z2 = true;
            } else {
                z2 = false;
            }
            return findHealthyConnection(connectTimeoutMillis$okhttp, readTimeoutMillis$okhttp, writeTimeoutMillis$okhttp, pingIntervalMillis, retryOnConnectionFailure, z2).newCodec$okhttp(okHttpClient, realInterceptorChain);
    ...
    public final boolean retryAfterFailure() {
        ...
        if (!z2 && (routeSelector2 = this.routeSelector) != null) {
