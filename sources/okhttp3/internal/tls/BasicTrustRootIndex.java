...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(X509Certificate... x509CertificateArr) {
        Intrinsics.f(x509CertificateArr, "caCerts");
    ...
    public boolean equals(Object obj) {
        return obj == this || ((obj instanceof BasicTrustRootIndex) && Intrinsics.a(((BasicTrustRootIndex) obj).subjectToCaCerts, this.subjectToCaCerts));
    }
    ...
    public java.security.cert.X509Certificate findByIssuerAndSignature(java.security.cert.X509Certificate r5) {
        ...
        L_0x001b:
            ...
            java.security.PublicKey r3 = r3.getPublicKey()     // Catch:{ Exception -> 0x0031 }
            r5.verify(r3)     // Catch:{ Exception -> 0x0031 }
            r3 = 1
            goto L_0x0032
        L_0x0031:
            r3 = 0
