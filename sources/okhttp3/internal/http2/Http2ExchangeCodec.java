...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (Intrinsics.a(lowerCase, Http2ExchangeCodec.TE) && Intrinsics.a(headers.value(i2), "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headers, Protocol protocol) {
            Intrinsics.f(headers, "headerBlock");
    ...
    public Http2ExchangeCodec(OkHttpClient okHttpClient, RealConnection realConnection, RealInterceptorChain realInterceptorChain, Http2Connection http2Connection2) {
        ...
        Intrinsics.f(http2Connection2, "http2Connection");
    ...
    public void writeRequestHeaders(Request request) {
        ...
        if (this.stream == null) {
            ...
            this.stream = this.http2Connection.newStream(Companion.http2HeadersList(request), z2);
            if (!this.canceled) {
                Http2Stream http2Stream = this.stream;
                Intrinsics.c(http2Stream);
