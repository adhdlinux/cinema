...
public final class Huffman {
    ...
    private final void addCode(int i2, int i3, int i4) {
        ...
        while (i4 > 8) {
            i4 -= 8;
            int i5 = (i3 >>> i4) & JfifUtil.MARKER_FIRST_BYTE;
        ...
        int i6 = 8 - i4;
        int i7 = (i3 << i6) & JfifUtil.MARKER_FIRST_BYTE;
        Node[] children2 = node2.getChildren();
        Intrinsics.c(children2);
        ArraysKt___ArraysJvmKt.k(children2, node, i7, (1 << i6) + i7);
    }

    public final void decode(BufferedSource bufferedSource, long j2, BufferedSink bufferedSink) {
        ...
        for (long j3 = 0; j3 < j2; j3++) {
            i2 = (i2 << 8) | Util.and(bufferedSource.readByte(), (int) JfifUtil.MARKER_FIRST_BYTE);
            i3 += 8;
            while (i3 >= 8) {
    ...
    public final int encodedLength(ByteString byteString) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            j2 += (long) CODE_BIT_COUNTS[Util.and(byteString.f(i2), (int) JfifUtil.MARKER_FIRST_BYTE)];
        }
