...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    private final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j2) {
            ...
            if (!(!this.closed)) {
                ...
                Http1ExchangeCodec.this.sink.b0(j2);
    ...
    private final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() {
            ...
            if (this.bytesRemainingInChunk != -1) {
                this.this$0.source.F();
            }
            try {
                this.bytesRemainingInChunk = this.this$0.source.l0();
                String obj = StringsKt__StringsKt.N0(this.this$0.source.F()).toString();
                if (this.bytesRemainingInChunk >= 0) {
                    ...
                    if (!z2 || StringsKt__StringsJVMKt.G(obj, ";", false, 2, (Object) null)) {
                        if (this.bytesRemainingInChunk == 0) {
    ...
    private final boolean isChunked(Response response) {
        return StringsKt__StringsJVMKt.t("chunked", Response.header$default(response, "Transfer-Encoding", (String) null, 2, (Object) null), true);
    }
    ...
    public final void writeRequest(Headers headers, String str) {
        ...
        if (z2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                this.sink.w(headers.name(i2)).w(": ").w(headers.value(i2)).w("\r\n");
            }
            this.sink.w("\r\n");
            this.state = 1;
            return;
    ...
    private final boolean isChunked(Request request) {
        return StringsKt__StringsJVMKt.t("chunked", request.header("Transfer-Encoding"), true);
    }
}
