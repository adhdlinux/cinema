...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (StringsKt__StringsJVMKt.G(str, "TLS_", false, 2, (Object) null)) {
                ...
                sb.append(substring);
                return sb.toString();
            } else if (!StringsKt__StringsJVMKt.G(str, "SSL_", false, 2, (Object) null)) {
                return str;
            } else {
    ...
    static {
        ...
        TLS_PSK_WITH_RC4_128_SHA = companion.init("TLS_PSK_WITH_RC4_128_SHA", Sdk$SDKError.Reason.CONFIG_REFRESH_FAILED_VALUE);
        ...
        TLS_EMPTY_RENEGOTIATION_INFO_SCSV = companion.init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", JfifUtil.MARKER_FIRST_BYTE);
    ...
    public final String m250deprecated_javaName() {
