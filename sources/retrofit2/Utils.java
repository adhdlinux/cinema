...
final class Utils {
    ...
    static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            if (type2 instanceof Class) {
                ...
                if (z2 != (((Class) type2).getEnclosingClass() != null ? false : z3)) {
    ...
    static Type getParameterLowerBound(int i2, ParameterizedType parameterizedType) {
    ...
    static boolean isUnit(Type type) {
        if (!checkForKotlinUnit || type != Unit.class) {
            return false;
        }
        return true;
    }
    ...
    static RuntimeException parameterError(Method method, Throwable th, int i2, String str, Object... objArr) {
        String describeMethodParameter = Platform.reflection.describeMethodParameter(method, i2);
        return methodError(method, th, str + " (" + describeMethodParameter + ")", objArr);
    }
    ...
    static RuntimeException parameterError(Method method, int i2, String str, Object... objArr) {
        String describeMethodParameter = Platform.reflection.describeMethodParameter(method, i2);
        return methodError(method, str + " (" + describeMethodParameter + ")", objArr);
    }
}
