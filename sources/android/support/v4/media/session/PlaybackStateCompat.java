...
public final class PlaybackStateCompat implements Parcelable {
    ...
    private static class Api21Impl {
        ...
        static PlaybackState.CustomAction.Builder createCustomActionBuilder(String str, CharSequence charSequence, int i2) {
        ...
        static void setActions(PlaybackState.Builder builder, long j2) {
            builder.setActions(j2);
        }

        static void setActiveQueueItemId(PlaybackState.Builder builder, long j2) {
            builder.setActiveQueueItemId(j2);
        }

        static void setBufferedPosition(PlaybackState.Builder builder, long j2) {
        ...
        static void setState(PlaybackState.Builder builder, int i2, long j2, float f2, long j3) {
    ...
    public static final class Builder {
        ...
        public Builder addCustomAction(String str, String str2, int i2) {
            return addCustomAction(new CustomAction(str, str2, i2, (Bundle) null));
        }
    ...
    public long getCurrentPosition(Long l2) {
        ...
        return Math.max(0, j3 + ((long) (f2 * ((float) j2))));
    }
