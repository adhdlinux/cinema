...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
            ...
            public void onReceiveResult(int i2, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(BundleCompat.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                        mediaControllerImplApi21.mSessionToken.setSession2Token(ParcelUtils.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
        ...
        public void adjustVolume(int i2, int i3) {
            this.mControllerFwk.adjustVolume(i2, i3);
        }
        ...
        public void setVolumeTo(int i2, int i3) {
            this.mControllerFwk.setVolumeTo(i2, i3);
        }
    ...
    static class MediaControllerImplApi29 extends MediaControllerImplApi21 {
        ...
        public Bundle getSessionInfo() {
            ...
            Bundle a2 = this.mControllerFwk.getSessionInfo();
            this.mSessionInfo = a2;
            Bundle unparcelWithClassLoader = MediaSessionCompat.unparcelWithClassLoader(a2);
            this.mSessionInfo = unparcelWithClassLoader;
            if (unparcelWithClassLoader == null) {
                return Bundle.EMPTY;
            }
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void setPlaybackSpeed(float f2) {
            if (f2 != 0.0f) {
                Bundle bundle = new Bundle();
                bundle.putFloat(MediaSessionCompat.ACTION_ARGUMENT_PLAYBACK_SPEED, f2);
        ...
        public void skipToQueueItem(long j2) {
            this.mControlsFwk.skipToQueueItem(j2);
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(R$id.f3854a);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(R$id.f3854a, mediaControllerCompat);
