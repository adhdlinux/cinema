...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() {
            public View c(int i2) {
                if (createFragmentContainer.d()) {
                    return createFragmentContainer.c(i2);
                }
                return DialogFragment.this.onFindViewById(i2);
            }

            public boolean d() {
                return createFragmentContainer.d() || DialogFragment.this.onHasView();
            }
        };
    }
    ...
    public int show(FragmentTransaction fragmentTransaction, String str) {
        ...
        this.mViewDestroyed = false;
        int h2 = fragmentTransaction.h();
        this.mBackStackId = h2;
        return h2;
    }
