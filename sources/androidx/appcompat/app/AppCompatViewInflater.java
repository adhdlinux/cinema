...
public class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private final View f494b;

        /* renamed from: c  reason: collision with root package name */
        private final String f495c;

        /* renamed from: d  reason: collision with root package name */
        private Method f496d;

        /* renamed from: e  reason: collision with root package name */
        private Context f497e;
        ...
        private void a(Context context) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f495c, new Class[]{View.class})) != null) {
                        this.f496d = method;
                        this.f497e = context;
                        return;
                    }
            ...
            int id = this.f494b.getId();
            if (id == -1) {
                str = "";
            } else {
                str = " with id '" + this.f494b.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f495c + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f494b.getClass() + str);
        }

        public void onClick(View view) {
            if (this.f496d == null) {
                a(this.f494b.getContext());
            }
            try {
                this.f496d.invoke(this.f497e, new Object[]{view});
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if ((context instanceof ContextWrapper) && ViewCompat.Q(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z2, boolean z3) {
        int i2;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.X3, 0, 0);
        if (z2) {
            i2 = obtainStyledAttributes.getResourceId(R$styleable.Y3, 0);
        } else {
            i2 = 0;
        }
        if (z3 && i2 == 0 && (i2 = obtainStyledAttributes.getResourceId(R$styleable.Z3, 0)) != 0) {
        ...
        if (!(context instanceof ContextThemeWrapper) || ((ContextThemeWrapper) context).c() != i2) {
