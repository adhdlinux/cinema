...
class LayoutIncludeDetector {
    ...
    private final Deque<WeakReference<XmlPullParser>> f502a = new ArrayDeque();
    ...
    public boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser c2 = c(this.f502a);
        this.f502a.push(new WeakReference(xmlPullParser));
        if (d(xmlPullParser, c2)) {
            return true;
        }
        return false;
    }
