...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundDrawablesView {
    ...
    private final AppCompatCompoundButtonHelper f1102b;

    /* renamed from: c  reason: collision with root package name */
    private final AppCompatBackgroundHelper f1103c;

    /* renamed from: d  reason: collision with root package name */
    private final AppCompatTextHelper f1104d;

    /* renamed from: e  reason: collision with root package name */
    private AppCompatEmojiTextHelper f1105e;

    public AppCompatCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R$attr.f107r);
    }

    private AppCompatEmojiTextHelper getEmojiTextViewHelper() {
        if (this.f1105e == null) {
            this.f1105e = new AppCompatEmojiTextHelper(this);
        }
        return this.f1105e;
    }
    ...
    public void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1103c;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f1104d;
    ...
    public int getCompoundPaddingLeft() {
        ...
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.f1102b;
