...
public class ListPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        builder.n(this.mEntries, this.mClickedDialogEntryIndex, new DialogInterface.OnClickListener() {
        ...
        builder.l((CharSequence) null, (DialogInterface.OnClickListener) null);
    }
