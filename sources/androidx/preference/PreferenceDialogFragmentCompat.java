...
public abstract class PreferenceDialogFragmentCompat extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog.Builder i2 = new AlertDialog.Builder(activity).setTitle(this.mDialogTitle).e(this.mDialogIcon).l(this.mPositiveButtonText, this).i(this.mNegativeButtonText, this);
        View onCreateDialogView = onCreateDialogView(activity);
        if (onCreateDialogView != null) {
            onBindDialogView(onCreateDialogView);
            i2.setView(onCreateDialogView);
        } else {
            i2.g(this.mDialogMessage);
        }
        onPrepareDialogBuilder(i2);
