...
public final class Data {
    ...
    private static final String f12166b = Logger.f("Data");

    /* renamed from: c  reason: collision with root package name */
    public static final Data f12167c = new Builder().a();

    /* renamed from: a  reason: collision with root package name */
    Map<String, Object> f12168a;

    public static final class Builder {

        /* renamed from: a  reason: collision with root package name */
        private Map<String, Object> f12169a = new HashMap();

        public Data a() {
            Data data = new Data((Map<String, ?>) this.f12169a);
            Data.m(data);
            return data;
        }
        ...
        public Builder b(String str, Object obj) {
            if (obj == null) {
                this.f12169a.put(str, (Object) null);
            } else {
                Class<?> cls = obj.getClass();
                if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                    this.f12169a.put(str, obj);
                } else if (cls == boolean[].class) {
                    this.f12169a.put(str, Data.a((boolean[]) obj));
                } else if (cls == byte[].class) {
                    this.f12169a.put(str, Data.b((byte[]) obj));
                } else if (cls == int[].class) {
                    this.f12169a.put(str, Data.e((int[]) obj));
                } else if (cls == long[].class) {
                    this.f12169a.put(str, Data.f((long[]) obj));
                } else if (cls == float[].class) {
                    this.f12169a.put(str, Data.d((float[]) obj));
                } else if (cls == double[].class) {
                    this.f12169a.put(str, Data.c((double[]) obj));
                } else {
        ...
        public Builder e(String str, byte[] bArr) {
            this.f12169a.put(str, Data.b(bArr));
            return this;
        }

        public Builder f(String str, String str2) {
            this.f12169a.put(str, str2);
            return this;
        }
    }
    ...
    public static androidx.work.Data h(byte[] r7) {
        /*
        ...
        L_0x0044:
            ...
            r7 = r6
        L_0x0047:
            java.lang.String r4 = f12166b     // Catch:{ all -> 0x0068 }
        ...
        L_0x0080:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.Data.h(byte[]):androidx.work.Data");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] m(androidx.work.Data r5) {
        /*
            ...
            java.util.Map<java.lang.String, java.lang.Object> r5 = r5.f12168a     // Catch:{ IOException -> 0x0067, all -> 0x0064 }
        ...
        L_0x006c:
            r5 = move-exception
        L_0x006d:
            java.lang.String r3 = f12166b     // Catch:{ all -> 0x006a }
        ...
        L_0x00a3:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.Data.m(androidx.work.Data):byte[]");
    }
    ...
    public boolean equals(Object obj) {
        ...
        Data data = (Data) obj;
        Set<String> keySet = this.f12168a.keySet();
        if (!keySet.equals(data.f12168a.keySet())) {
            return false;
        }
        for (String next : keySet) {
            Object obj2 = this.f12168a.get(next);
            Object obj3 = data.f12168a.get(next);
    ...
    public int hashCode() {
        return this.f12168a.hashCode() * 31;
    }

    public byte[] i(String str) {
        Object obj = this.f12168a.get(str);
    ...
    public Map<String, Object> j() {
        return Collections.unmodifiableMap(this.f12168a);
    }
    ...
    public String toString() {
        ...
        if (!this.f12168a.isEmpty()) {
            for (String next : this.f12168a.keySet()) {
                sb.append(next);
                sb.append(" : ");
                Object obj = this.f12168a.get(next);
    ...
    public Data(Data data) {
        this.f12168a = new HashMap(data.f12168a);
    }

    public Data(Map<String, ?> map) {
        this.f12168a = new HashMap(map);
    }
}
