...
public class BatteryChargingTracker extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    private static final String f12428i = Logger.f("BatteryChrgTracker");
    ...
    public Boolean b() {
        ...
        Logger.c().b(f12428i, "getInitialState - null intent received", new Throwable[0]);
        return null;
    }
}
