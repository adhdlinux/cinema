...
public final class FlacMetadataReader {
    ...
    public static Metadata c(ExtractorInput extractorInput, boolean z2) throws IOException {
        ...
        if (z2) {
            ...
            framePredicate = Id3Decoder.f8323b;
        }
    ...
    public static boolean e(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) throws IOException {
        ...
        extractorInput.m(parsableBitArray.f4688a, 0, 4);
        boolean g2 = parsableBitArray.g();
        int h2 = parsableBitArray.h(7);
        int h3 = parsableBitArray.h(24) + 4;
        if (h2 == 0) {
            flacStreamMetadataHolder.f8016a = h(extractorInput);
        } else {
            FlacStreamMetadata flacStreamMetadata = flacStreamMetadataHolder.f8016a;
            if (flacStreamMetadata == null) {
                throw new IllegalArgumentException();
            } else if (h2 == 3) {
                flacStreamMetadataHolder.f8016a = flacStreamMetadata.b(g(extractorInput, h3));
            } else if (h2 == 4) {
                flacStreamMetadataHolder.f8016a = flacStreamMetadata.c(j(extractorInput, h3));
            } else if (h2 == 6) {
                ParsableByteArray parsableByteArray = new ParsableByteArray(h3);
                extractorInput.readFully(parsableByteArray.e(), 0, h3);
                parsableByteArray.V(4);
                flacStreamMetadataHolder.f8016a = flacStreamMetadata.a(ImmutableList.s(PictureFrame.b(parsableByteArray)));
            } else {
                extractorInput.k(h3);
            }
        }
    ...
    private static List<String> j(ExtractorInput extractorInput, int i2) throws IOException {
        ...
        extractorInput.readFully(parsableByteArray.e(), 0, i2);
        parsableByteArray.V(4);
        return Arrays.asList(VorbisUtil.k(parsableByteArray, false, false).f8102b);
    }
}
