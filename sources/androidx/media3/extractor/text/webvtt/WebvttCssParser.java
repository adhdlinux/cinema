...
final class WebvttCssParser {
    ...
    private static final Pattern f9097c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f9098d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");

    /* renamed from: a  reason: collision with root package name */
    private final ParsableByteArray f9099a = new ParsableByteArray();

    /* renamed from: b  reason: collision with root package name */
    private final StringBuilder f9100b = new StringBuilder();

    private void a(WebvttCssStyle webvttCssStyle, String str) {
        if (!"".equals(str)) {
            int indexOf = str.indexOf(91);
            if (indexOf != -1) {
                Matcher matcher = f9097c.matcher(str.substring(indexOf));
                if (matcher.matches()) {
                    webvttCssStyle.z((String) Assertions.f(matcher.group(1)));
                }
            ...
            if (k12.length > 1) {
                webvttCssStyle.w((String[]) Util.V0(k12, 1, k12.length));
            }
        }
    }
    ...
    private static void e(String str, WebvttCssStyle webvttCssStyle) {
        Matcher matcher = f9098d.matcher(Ascii.e(str));
        if (!matcher.matches()) {
            Log.h("WebvttCssParser", "Invalid font-size: '" + str + "'.");
            return;
        }
        String str2 = (String) Assertions.f(matcher.group(2));
        str2.hashCode();
        char c2 = 65535;
        ...
        webvttCssStyle.s(Float.parseFloat((String) Assertions.f(matcher.group(1))));
    }
    ...
    public List<WebvttCssStyle> d(ParsableByteArray parsableByteArray) {
        boolean z2;
        this.f9100b.setLength(0);
        int f2 = parsableByteArray.f();
        m(parsableByteArray);
        this.f9099a.S(parsableByteArray.e(), parsableByteArray.f());
        this.f9099a.U(f2);
        ArrayList arrayList = new ArrayList();
        while (true) {
            String i2 = i(this.f9099a, this.f9100b);
            if (i2 == null || !"{".equals(g(this.f9099a, this.f9100b))) {
                return arrayList;
            }
            ...
            boolean z3 = false;
            while (!z3) {
                int f3 = this.f9099a.f();
                String g2 = g(this.f9099a, this.f9100b);
                ...
                if (!z2) {
                    this.f9099a.U(f3);
                    j(this.f9099a, webvttCssStyle, this.f9100b);
                }
                str = g2;
                z3 = z2;
            }
