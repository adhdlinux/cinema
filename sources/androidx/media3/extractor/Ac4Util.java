...
public final class Ac4Util {
    ...
    private static final int[] f7911a = {2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, 480, 400, 400, 2048};
    ...
    public static Format b(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return new Format.Builder().a0(str).o0("audio/ac4").N(2).p0(i2).U(drmInitData).e0(str2).K();
    }
    ...
    public static int c(ByteBuffer byteBuffer) {
        ...
        return d(new ParsableBitArray(bArr)).f7916e;
    }
