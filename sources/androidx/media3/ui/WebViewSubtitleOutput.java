...
final class WebViewSubtitleOutput extends FrameLayout implements SubtitleView.Output {
    ...
    private final CanvasSubtitleOutput f10170b;

    /* renamed from: c  reason: collision with root package name */
    private final WebView f10171c;

    /* renamed from: d  reason: collision with root package name */
    private List<Cue> f10172d;

    /* renamed from: e  reason: collision with root package name */
    private CaptionStyleCompat f10173e;
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f10178a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f10178a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    private static String c(Layout.Alignment alignment) {
        ...
        int i2 = AnonymousClass2.f10178a[alignment.ordinal()];
        if (i2 == 1) {
    ...
    private static String d(CaptionStyleCompat captionStyleCompat) {
        int i2 = captionStyleCompat.f9770d;
        if (i2 == 1) {
            return Util.G("1px 1px 0 %1$s, 1px -1px 0 %1$s, -1px 1px 0 %1$s, -1px -1px 0 %1$s", HtmlUtils.b(captionStyleCompat.f9771e));
        } else if (i2 == 2) {
            return Util.G("0.1em 0.12em 0.15em %s", HtmlUtils.b(captionStyleCompat.f9771e));
        } else if (i2 == 3) {
            return Util.G("0.06em 0.08em 0.15em %s", HtmlUtils.b(captionStyleCompat.f9771e));
        } else if (i2 != 4) {
            return "unset";
        } else {
            return Util.G("-0.05em -0.05em 0.15em %s", HtmlUtils.b(captionStyleCompat.f9771e));
        }
    }
    ...
    private String e(int i2, float f2) {
        ...
        return Util.G("%.2fpx", Float.valueOf(h2 / getContext().getResources().getDisplayMetrics().density));
    }
    ...
    private static String h(Cue cue) {
        ...
        return Util.G("%s(%.2fdeg)", str, Float.valueOf(f2));
    }
    ...
    private void i() {
        /*
            ...
            androidx.media3.ui.CaptionStyleCompat r4 = r0.f10173e
            int r4 = r4.f9767a
            java.lang.String r4 = androidx.media3.ui.HtmlUtils.b(r4)
            r5 = 0
            r3[r5] = r4
            int r4 = r0.f10175g
            float r6 = r0.f10174f
            ...
            r8 = 2
            r3[r8] = r7
            androidx.media3.ui.CaptionStyleCompat r7 = r0.f10173e
            ...
            java.lang.String r3 = androidx.media3.common.util.Util.G(r7, r3)
            r1.append(r3)
            java.util.HashMap r3 = new java.util.HashMap
            r3.<init>()
            java.lang.String r7 = "default_bg"
            java.lang.String r10 = androidx.media3.ui.HtmlUtils.a(r7)
            java.lang.Object[] r11 = new java.lang.Object[r6]
            androidx.media3.ui.CaptionStyleCompat r12 = r0.f10173e
            int r12 = r12.f9768b
            java.lang.String r12 = androidx.media3.ui.HtmlUtils.b(r12)
            r11[r5] = r12
            java.lang.String r12 = "background-color:%s;"
            java.lang.String r11 = androidx.media3.common.util.Util.G(r12, r11)
            r3.put(r10, r11)
            r10 = 0
        L_0x005d:
            java.util.List<androidx.media3.common.text.Cue> r11 = r0.f10172d
            int r11 = r11.size()
            if (r10 >= r11) goto L_0x025c
            java.util.List<androidx.media3.common.text.Cue> r11 = r0.f10172d
            java.lang.Object r11 = r11.get(r10)
            androidx.media3.common.text.Cue r11 = (androidx.media3.common.text.Cue) r11
            float r12 = r11.f4565h
        ...
        L_0x007d:
            ...
            r8[r5] = r2
            java.lang.String r2 = androidx.media3.common.util.Util.G(r9, r8)
            int r8 = r11.f4573p
        ...
        L_0x00b2:
            ...
            java.lang.Float r2 = java.lang.Float.valueOf(r2)
            r8[r5] = r2
            java.lang.String r2 = androidx.media3.common.util.Util.G(r13, r8)
            r8 = 0
            goto L_0x00f1
        L_0x00c9:
            java.lang.Object[] r8 = new java.lang.Object[r6]
        ...
        L_0x00dd:
            ...
            r2[r5] = r8
            java.lang.String r2 = androidx.media3.common.util.Util.G(r9, r2)
            r8 = -100
        L_0x00f1:
            r13 = 0
        L_0x00f2:
            ...
            r14 = 0
            r5[r14] = r4
            java.lang.String r4 = androidx.media3.common.util.Util.G(r9, r5)
            goto L_0x010d
        L_0x010b:
            java.lang.String r4 = "fit-content"
        L_0x010d:
            android.text.Layout$Alignment r5 = r11.f4559b
            ...
            boolean r14 = r11.f4569l
            if (r14 == 0) goto L_0x0128
            int r14 = r11.f4570m
            goto L_0x012c
        L_0x0128:
            androidx.media3.ui.CaptionStyleCompat r14 = r0.f10173e
            int r14 = r14.f9769c
        L_0x012c:
            java.lang.String r14 = androidx.media3.ui.HtmlUtils.b(r14)
            r20 = r8
            int r8 = r11.f4573p
        ...
        L_0x015f:
            ...
            r20 = r24
        L_0x0165:
            java.lang.CharSequence r13 = r11.f4558a
        ...
        L_0x01b9:
            ...
            java.lang.String r0 = androidx.media3.common.util.Util.G(r2, r0)
            r1.append(r0)
            r0 = 1
            ...
            java.lang.String r2 = androidx.media3.common.util.Util.G(r5, r2)
            r1.append(r2)
            android.text.Layout$Alignment r2 = r11.f4560c
            ...
            java.lang.String r0 = androidx.media3.common.util.Util.G(r0, r6)
            r1.append(r0)
            r0 = r25
        ...
        L_0x0296:
            ...
            r1.insert(r2, r0)
            r0 = r26
            android.webkit.WebView r2 = r0.f10171c
    ...
    public void a(List<Cue> list, CaptionStyleCompat captionStyleCompat, float f2, int i2, float f3) {
        this.f10173e = captionStyleCompat;
        this.f10174f = f2;
        this.f10175g = i2;
        this.f10176h = f3;
        ...
        if (!this.f10172d.isEmpty() || !arrayList2.isEmpty()) {
            this.f10172d = arrayList2;
            i();
        }
        this.f10170b.a(arrayList, captionStyleCompat, f2, i2, f3);
        invalidate();
    }

    public void g() {
        this.f10171c.destroy();
    }

    /* access modifiers changed from: protected */
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        super.onLayout(z2, i2, i3, i4, i5);
        if (z2 && !this.f10172d.isEmpty()) {
            i();
        }
    }
    ...
    public WebViewSubtitleOutput(Context context, AttributeSet attributeSet) {
        ...
        this.f10173e = CaptionStyleCompat.f9766g;
        this.f10174f = 0.0533f;
        this.f10175g = 0;
        this.f10176h = 0.08f;
        CanvasSubtitleOutput canvasSubtitleOutput = new CanvasSubtitleOutput(context, attributeSet);
        this.f10170b = canvasSubtitleOutput;
