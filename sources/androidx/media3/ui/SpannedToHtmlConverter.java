...
final class SpannedToHtmlConverter {
    ...
    private static final Pattern f10107a = Pattern.compile("(&#13;)?&#10;");
    ...
    public static class HtmlAndCss {
        ...
        public final Map<String, String> f10109b;
    ...
    private static final class SpanInfo {
        ...
        public static final Comparator<SpanInfo> f10110e = new u();
        /* access modifiers changed from: private */

        /* renamed from: f  reason: collision with root package name */
        public static final Comparator<SpanInfo> f10111f = new v();
        ...
        public static /* synthetic */ int e(SpanInfo spanInfo, SpanInfo spanInfo2) {
            int compare = Integer.compare(spanInfo2.f10113b, spanInfo.f10113b);
            if (compare != 0) {
                return compare;
            }
            int compareTo = spanInfo.f10114c.compareTo(spanInfo2.f10114c);
            if (compareTo != 0) {
                return compareTo;
            }
            return spanInfo.f10115d.compareTo(spanInfo2.f10115d);
        }

        /* access modifiers changed from: private */
        public static /* synthetic */ int f(SpanInfo spanInfo, SpanInfo spanInfo2) {
            int compare = Integer.compare(spanInfo2.f10112a, spanInfo.f10112a);
            if (compare != 0) {
                return compare;
            }
            int compareTo = spanInfo2.f10114c.compareTo(spanInfo.f10114c);
            if (compareTo != 0) {
                return compareTo;
            }
            return spanInfo2.f10115d.compareTo(spanInfo.f10115d);
        }
    ...
    private static final class Transition {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final List<SpanInfo> f10116a = new ArrayList();
        /* access modifiers changed from: private */

        /* renamed from: b  reason: collision with root package name */
        public final List<SpanInfo> f10117b = new ArrayList();
    }
    ...
    public static HtmlAndCss a(CharSequence charSequence, float f2) {
        ...
        for (Integer intValue : hashSet) {
            ...
            hashMap.put(HtmlUtils.a("bg_" + intValue2), Util.G("background-color:%s;", HtmlUtils.b(intValue2)));
        }
        ...
        while (i2 < c2.size()) {
            ...
            Collections.sort(transition.f10117b, SpanInfo.f10111f);
            for (SpanInfo spanInfo : transition.f10117b) {
                sb.append(spanInfo.f10115d);
            }
            Collections.sort(transition.f10116a, SpanInfo.f10110e);
            for (SpanInfo spanInfo2 : transition.f10116a) {
                sb.append(spanInfo2.f10114c);
            }
            i2++;
            i3 = keyAt;
        }
    ...
    private static String b(CharSequence charSequence) {
        return f10107a.matcher(Html.escapeHtml(charSequence)).replaceAll("<br>");
    }
    ...
    private static SparseArray<Transition> c(Spanned spanned, float f2) {
        ...
        for (Object obj : spanned.getSpans(0, spanned.length(), Object.class)) {
            ...
            if (e2 != null) {
                ...
                f(sparseArray, spanStart).f10116a.add(spanInfo);
                f(sparseArray, spanEnd).f10117b.add(spanInfo);
            }
        }
        return sparseArray;
    }
    ...
    private static String d(Object obj) {
        ...
        if (!(obj instanceof TypefaceSpan)) {
            if (obj instanceof StyleSpan) {
                ...
                return "<rt>" + b(((RubySpan) obj).f4604a) + "</rt></ruby>";
    ...
    private static String e(Object obj, float f2) {
        ...
        if (obj instanceof ForegroundColorSpan) {
            return Util.G("<span style='color:%s;'>", HtmlUtils.b(((ForegroundColorSpan) obj).getForegroundColor()));
        } else if (obj instanceof BackgroundColorSpan) {
            return Util.G("<span class='bg_%s'>", Integer.valueOf(((BackgroundColorSpan) obj).getBackgroundColor()));
            ...
            if (obj instanceof AbsoluteSizeSpan) {
                ...
                return Util.G("<span style='font-size:%.2fpx;'>", Float.valueOf(f3));
            } else if (obj instanceof RelativeSizeSpan) {
                return Util.G("<span style='font-size:%.2f%%;'>", Float.valueOf(((RelativeSizeSpan) obj).getSizeChange() * 100.0f));
            } else if (obj instanceof TypefaceSpan) {
                String family = ((TypefaceSpan) obj).getFamily();
                if (family == null) {
                    return null;
                }
                return Util.G("<span style='font-family:\"%s\";'>", family);
                ...
                return Util.G("<span style='-webkit-text-emphasis-style:%1$s;text-emphasis-style:%1$s;-webkit-text-emphasis-position:%2$s;text-emphasis-position:%2$s;display:inline-block;'>", h(textEmphasisSpan.f4609a, textEmphasisSpan.f4610b), g(textEmphasisSpan.f4611c));
            }
        }
    }
