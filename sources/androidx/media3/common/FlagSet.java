...
public final class FlagSet {
    ...
    public static final class Builder {
        ...
        public Builder a(int i2) {
            Assertions.h(!this.f3981b);
            this.f3980a.append(i2, true);
            return this;
        }
        ...
        public FlagSet e() {
            Assertions.h(!this.f3981b);
            this.f3981b = true;
            return new FlagSet(this.f3980a);
        }
    }

    public boolean a(int i2) {
        return this.f3979a.get(i2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Util.f4714a >= 24) {
            return this.f3979a.equals(flagSet.f3979a);
        }
        if (d() != flagSet.d()) {
            return false;
        }
