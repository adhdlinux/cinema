...
public final class ParsableByteArray {
    ...
    private static final char[] f4692d = {13, 10};

    /* renamed from: e  reason: collision with root package name */
    private static final char[] f4693e = {10};

    /* renamed from: f  reason: collision with root package name */
    private static final ImmutableSet<Charset> f4694f = ImmutableSet.u(Charsets.US_ASCII, Charsets.UTF_8, Charsets.UTF_16, Charsets.UTF_16BE, Charsets.UTF_16LE);
    ...
    public ParsableByteArray() {
        this.f4695a = Util.f4719f;
    }

    private void W(Charset charset) {
        if (m(charset, f4692d) == 13) {
            m(charset, f4693e);
        }
    }
    ...
    private int d(Charset charset) {
        ...
        while (true) {
            ...
            if ((charset.equals(Charsets.UTF_8) || charset.equals(Charsets.US_ASCII)) && Util.H0(this.f4695a[i3])) {
                return i3;
            }
            if (charset.equals(Charsets.UTF_16) || charset.equals(Charsets.UTF_16BE)) {
                byte[] bArr = this.f4695a;
                if (bArr[i3] == 0 && Util.H0(bArr[i3 + 1])) {
                    return i3;
                }
            }
            if (charset.equals(Charsets.UTF_16LE)) {
                byte[] bArr2 = this.f4695a;
                if (bArr2[i3 + 1] == 0 && Util.H0(bArr2[i3])) {
                    return i3;
                }
            }
            i3 += i2;
    ...
    private int i(Charset charset) {
        ...
        if ((charset.equals(Charsets.UTF_8) || charset.equals(Charsets.US_ASCII)) && a() >= 1) {
            b2 = (byte) Chars.a((long) UnsignedBytes.b(this.f4695a[this.f4696b]));
        } else {
    ...
    public String C(int i2) {
        ...
        int i4 = this.f4696b;
        int i5 = (i4 + i2) - 1;
        if (i5 >= this.f4697c || this.f4695a[i5] != 0) {
            i3 = i2;
        } else {
            i3 = i2 - 1;
        }
        String I = Util.I(this.f4695a, i4, i3);
        this.f4696b += i2;
        return I;
    }
    ...
    public String F(int i2, Charset charset) {
        String str = new String(this.f4695a, this.f4696b, i2, charset);
        this.f4696b += i2;
        return str;
    }
    ...
    public long O() {
        int i2;
        int i3;
        long j2 = (long) this.f4695a[this.f4696b];
        int i4 = 7;
        while (true) {
            i2 = 1;
            if (i4 < 0) {
        ...
        if (i3 != 0) {
            while (i2 < i3) {
                byte b2 = this.f4695a[this.f4696b + i2];
                if ((b2 & 192) == 128) {
                    j2 = (j2 << 6) | ((long) (b2 & 63));
                    i2++;
                } else {
    ...
    public void Q(int i2) {
        S(b() < i2 ? new byte[i2] : this.f4695a, i2);
    }
    ...
    public void c(int i2) {
        if (i2 > b()) {
            this.f4695a = Arrays.copyOf(this.f4695a, i2);
        }
    }
    ...
    public char h(Charset charset) {
        boolean contains = f4694f.contains(charset);
        Assertions.b(contains, "Unsupported charset: " + charset);
        return (char) (i(charset) >> 16);
    }

    public int j() {
        return this.f4695a[this.f4696b] & 255;
    }

    public void k(ParsableBitArray parsableBitArray, int i2) {
        l(parsableBitArray.f4688a, 0, i2);
        parsableBitArray.p(0);
    }

    public void l(byte[] bArr, int i2, int i3) {
        System.arraycopy(this.f4695a, this.f4696b, bArr, i2, i3);
        this.f4696b += i3;
    }
    ...
    public String n(char c2) {
        ...
        int i2 = this.f4696b;
        while (i2 < this.f4697c && this.f4695a[i2] != c2) {
            i2++;
        }
        byte[] bArr = this.f4695a;
        int i3 = this.f4696b;
        String I = Util.I(bArr, i3, i2 - i3);
        this.f4696b = i2;
        if (i2 < this.f4697c) {
            this.f4696b = i2 + 1;
        }
    ...
    public String t(Charset charset) {
        ...
        String F = F(d(charset) - this.f4696b, charset);
        if (this.f4696b == this.f4697c) {
            return F;
        }
        W(charset);
        return F;
