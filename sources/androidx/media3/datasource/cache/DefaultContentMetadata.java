...
public final class DefaultContentMetadata implements ContentMetadata {
    ...
    public static final DefaultContentMetadata f5009c = new DefaultContentMetadata(Collections.emptyMap());

    /* renamed from: a  reason: collision with root package name */
    private int f5010a;

    /* renamed from: b  reason: collision with root package name */
    private final Map<String, byte[]> f5011b;
    ...
    public DefaultContentMetadata e(ContentMetadataMutations contentMetadataMutations) {
        Map<String, byte[]> d2 = d(this.f5011b, contentMetadataMutations);
        if (h(this.f5011b, d2)) {
            return this;
        }
    ...
    public boolean equals(Object obj) {
        ...
        return h(this.f5011b, ((DefaultContentMetadata) obj).f5011b);
    }

    public Set<Map.Entry<String, byte[]>> f() {
        return this.f5011b.entrySet();
    }

    public int hashCode() {
        if (this.f5010a == 0) {
            int i2 = 0;
            for (Map.Entry next : this.f5011b.entrySet()) {
