...
public final class HttpUtil {
    ...
    private static final Pattern f4898a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f4899b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L_0x000f:
            ...
            androidx.media3.common.util.Log.c(r2, r0)
        L_0x0026:
            r3 = -1
        L_0x0028:
            boolean r0 = android.text.TextUtils.isEmpty(r10)
            if (r0 != 0) goto L_0x00a4
            java.util.regex.Pattern r0 = f4898a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto L_0x00a4
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch:{ NumberFormatException -> 0x008d }
            java.lang.Object r5 = androidx.media3.common.util.Assertions.f(r5)     // Catch:{ NumberFormatException -> 0x008d }
            ...
            java.lang.Object r0 = androidx.media3.common.util.Assertions.f(r0)     // Catch:{ NumberFormatException -> 0x008d }
        ...
        L_0x0064:
            ...
            androidx.media3.common.util.Log.h(r2, r9)     // Catch:{ NumberFormatException -> 0x008d }
        ...
        L_0x008d:
            ...
            androidx.media3.common.util.Log.c(r2, r9)
        L_0x00a4:
            return r3
        */
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f4899b.matcher(str);
        if (matcher.matches()) {
