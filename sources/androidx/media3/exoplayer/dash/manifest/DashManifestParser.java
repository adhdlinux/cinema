...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    private static final Pattern f6062b = Pattern.compile("(\\d+)(?:/(\\d+))?");

    /* renamed from: c  reason: collision with root package name */
    private static final Pattern f6063c = Pattern.compile("CC([1-4])=.*");

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f6064d = Pattern.compile("([1-9]|[1-5][0-9]|6[0-3])=.*");

    /* renamed from: e  reason: collision with root package name */
    private static final int[] f6065e = {-1, 1, 2, 3, 4, 5, 6, 8, 2, 3, 4, 7, 8, 24, 8, 12, 10, 12, 14, 12, 14};

    /* renamed from: a  reason: collision with root package name */
    private final XmlPullParserFactory f6066a;

    protected static final class RepresentationInfo {

        /* renamed from: a  reason: collision with root package name */
        public final Format f6067a;

        /* renamed from: b  reason: collision with root package name */
        public final ImmutableList<BaseUrl> f6068b;

        /* renamed from: c  reason: collision with root package name */
        public final SegmentBase f6069c;

        /* renamed from: d  reason: collision with root package name */
        public final String f6070d;

        /* renamed from: e  reason: collision with root package name */
        public final ArrayList<DrmInitData.SchemeData> f6071e;

        /* renamed from: f  reason: collision with root package name */
        public final ArrayList<Descriptor> f6072f;

        /* renamed from: g  reason: collision with root package name */
        public final long f6073g;

        /* renamed from: h  reason: collision with root package name */
        public final List<Descriptor> f6074h;

        /* renamed from: i  reason: collision with root package name */
        public final List<Descriptor> f6075i;
        ...
        public RepresentationInfo(Format format, List<BaseUrl> list, SegmentBase segmentBase, String str, ArrayList<DrmInitData.SchemeData> arrayList, ArrayList<Descriptor> arrayList2, List<Descriptor> list2, List<Descriptor> list3, long j2) {
            this.f6067a = format;
            this.f6068b = ImmutableList.n(list);
            this.f6069c = segmentBase;
            this.f6070d = str;
            this.f6071e = arrayList;
            this.f6072f = arrayList2;
            this.f6074h = list2;
            this.f6075i = list3;
            this.f6073g = j2;
        }
    ...
    public DashManifestParser() {
        try {
            this.f6066a = XmlPullParserFactory.newInstance();
    ...
    protected static int D(List<Descriptor> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.f6076a) && (str = descriptor.f6077b) != null) {
                Matcher matcher = f6063c.matcher(str);
                if (matcher.matches()) {
                    return Integer.parseInt(matcher.group(1));
                }
                Log.h("MpdParser", "Unable to parse CEA-608 channel number from: " + descriptor.f6077b);
            }
        }
        return -1;
    }
    ...
    protected static int E(List<Descriptor> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            Descriptor descriptor = list.get(i2);
            if ("urn:scte:dash:cc:cea-708:2015".equals(descriptor.f6076a) && (str = descriptor.f6077b) != null) {
                Matcher matcher = f6064d.matcher(str);
                if (matcher.matches()) {
                    return Integer.parseInt(matcher.group(1));
                }
                Log.h("MpdParser", "Unable to parse CEA-708 service block number from: " + descriptor.f6077b);
            }
        }
        return -1;
    }
    ...
    protected static long M(XmlPullParser xmlPullParser, String str, long j2) {
        ...
        return Util.X0(attributeValue);
    }

    protected static String N(List<Descriptor> list) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            Descriptor descriptor = list.get(i2);
            String str = descriptor.f6076a;
            if ("tag:dolby.com,2018:dash:EC3_ExtensionType:2018".equals(str) && "JOC".equals(descriptor.f6077b)) {
                return "audio/eac3-joc";
            }
            if ("tag:dolby.com,2014:dash:DolbyDigitalPlusExtensionType:2014".equals(str) && "ec+3".equals(descriptor.f6077b)) {
                return "audio/eac3-joc";
            }
        }
        return "audio/eac3";
    ...
    protected static float S(XmlPullParser xmlPullParser, float f2) {
        ...
        Matcher matcher = f6062b.matcher(attributeValue);
        if (!matcher.matches()) {
            return f2;
        }
    ...
    protected static long W(List<Descriptor> list) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            Descriptor descriptor = list.get(i2);
            if (Ascii.a("http://dashif.org/guidelines/last-segment-number", descriptor.f6076a)) {
                return Long.parseLong(descriptor.f6077b);
            }
        }
        return -1;
    }
    ...
    private static void r(ArrayList<DrmInitData.SchemeData> arrayList) {
        ...
        while (true) {
            ...
            if (C.f3932c.equals(schemeData.f3975c) && (str = schemeData.f3976d) != null) {
                arrayList.remove(i2);
                break;
            }
            i2++;
        ...
        if (str != null) {
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                ...
                if (C.f3931b.equals(schemeData2.f3975c) && schemeData2.f3976d == null) {
                    arrayList.set(i3, new DrmInitData.SchemeData(C.f3932c, str, schemeData2.f3977e, schemeData2.f3978f));
                }
            }
        }
    }
    ...
    public List<BaseUrl> C(XmlPullParser xmlPullParser, List<BaseUrl> list, boolean z2) throws XmlPullParserException, IOException {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            String e2 = UriUtil.e(baseUrl.f6045a, s02);
            if (attributeValue3 == null) {
                str = e2;
            } else {
                str = attributeValue3;
            ...
            arrayList.add(new BaseUrl(e2, str, i2, i3));
        }
        return arrayList;
    }
    ...
    public android.util.Pair<java.lang.String, androidx.media3.common.DrmInitData.SchemeData> F(org.xmlpull.v1.XmlPullParser r12) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x004b:
            ...
            java.lang.String r4 = androidx.media3.common.util.XmlPullParserUtil.b(r12, r4)
        ...
        L_0x006f:
            ...
            goto L_0x006f
        L_0x007d:
            java.util.UUID r4 = androidx.media3.common.C.f3931b
            byte[] r5 = androidx.media3.extractor.mp4.PsshAtomUtil.b(r4, r5, r1)
            r6 = r1
            goto L_0x009b
        L_0x0085:
            ...
            androidx.media3.common.util.Log.h(r2, r4)
            r4 = r1
            goto L_0x0099
        L_0x008c:
            java.util.UUID r4 = androidx.media3.common.C.f3933d
            goto L_0x0091
        L_0x008f:
            java.util.UUID r4 = androidx.media3.common.C.f3934e
        L_0x0091:
            r0 = r1
            r5 = r0
            goto L_0x009a
        L_0x0094:
            java.util.UUID r4 = androidx.media3.common.C.f3932c
            goto L_0x0091
        L_0x0097:
            r0 = r1
            r4 = r0
        ...
        L_0x00c9:
            ...
            java.util.UUID r5 = androidx.media3.extractor.mp4.PsshAtomUtil.f(r4)
        ...
        L_0x00f3:
            ...
            java.util.UUID r7 = androidx.media3.common.C.f3934e
    ...
    public Pair<Long, EventMessage> O(XmlPullParser xmlPullParser, String str, String str2, long j2, long j3, ByteArrayOutputStream byteArrayOutputStream) throws IOException, XmlPullParserException {
        ...
        long c12 = Util.c1(X2, 1000, j2);
        long c13 = Util.c1(X3 - j3, 1000000, j2);
    ...
    public androidx.media3.exoplayer.dash.manifest.DashManifest Y(org.xmlpull.v1.XmlPullParser r47, android.net.Uri r48) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x00e8:
            ...
            android.net.Uri r0 = androidx.media3.common.util.UriUtil.f(r0, r1)
            r36 = r0
            goto L_0x00cd
        L_0x00ff:
        ...
        L_0x014e:
            ...
            androidx.media3.common.ParserException r0 = androidx.media3.common.ParserException.c(r0, r14)
            throw r0
        L_0x0168:
    ...
    public Format f(String str, String str2, int i2, int i3, float f2, int i4, int i5, int i6, String str3, List<Descriptor> list, List<Descriptor> list2, String str4, List<Descriptor> list3, List<Descriptor> list4) {
        ...
        String str7 = str;
        Format.Builder e02 = new Format.Builder().a0(str).Q(str2).o0(u2).O(str6).j0(i6).q0(p02).m0(i02).e0(str3);
        int i11 = -1;
        if (t02 != null) {
        ...
        Format.Builder t03 = e02.t0(i7);
        if (t02 != null) {
            i8 = ((Integer) t02.second).intValue();
        } else {
            i8 = -1;
        }
        Format.Builder u02 = t03.u0(i8);
        if (MimeTypes.s(u2)) {
            u02.v0(i2).Y(i10).X(f2);
    ...
    public int f0(List<Descriptor> list) {
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            if (Ascii.a("urn:mpeg:dash:role:2011", descriptor.f6076a)) {
                u02 = g0(descriptor.f6077b);
            } else if (Ascii.a("urn:tva:metadata:cs:AudioPurposeCS:2007", descriptor.f6076a)) {
                u02 = u0(descriptor.f6077b);
            }
            i2 |= u02;
        }
        return i2;
    ...
    public int h0(List<Descriptor> list) {
        int i2 = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            if (Ascii.a("http://dashif.org/guidelines/trickmode", list.get(i3).f6076a)) {
    ...
    /* access modifiers changed from: protected */
    public Representation j(RepresentationInfo representationInfo, String str, List<Label> list, String str2, ArrayList<DrmInitData.SchemeData> arrayList, ArrayList<Descriptor> arrayList2) {
        RepresentationInfo representationInfo2 = representationInfo;
        String str3 = str;
        Format.Builder a2 = representationInfo2.f6067a.a();
        if (str3 == null || !list.isEmpty()) {
            a2.d0(list);
        } else {
            a2.c0(str3);
        }
        String str4 = representationInfo2.f6070d;
        if (str4 == null) {
            str4 = str2;
        }
        ArrayList<DrmInitData.SchemeData> arrayList3 = representationInfo2.f6071e;
        arrayList3.addAll(arrayList);
        if (!arrayList3.isEmpty()) {
            r(arrayList3);
            s(arrayList3);
            a2.U(new DrmInitData(str4, (List<DrmInitData.SchemeData>) arrayList3));
        }
        ArrayList<Descriptor> arrayList4 = representationInfo2.f6072f;
        arrayList4.addAll(arrayList2);
        return Representation.o(representationInfo2.f6073g, a2.K(), representationInfo2.f6068b, representationInfo2.f6069c, arrayList4, representationInfo2.f6074h, representationInfo2.f6075i, (String) null);
    }
    ...
    public SegmentBase.SingleSegmentBase j0(XmlPullParser xmlPullParser, SegmentBase.SingleSegmentBase singleSegmentBase) throws XmlPullParserException, IOException {
        ...
        long j7 = 0;
        if (singleSegmentBase2 != null) {
            j3 = singleSegmentBase2.f6114c;
        } else {
            j3 = 0;
        }
        long X2 = X(xmlPullParser2, "presentationTimeOffset", j3);
        if (singleSegmentBase2 != null) {
            j4 = singleSegmentBase2.f6127d;
        } else {
            j4 = 0;
        }
        if (singleSegmentBase2 != null) {
            j7 = singleSegmentBase2.f6128e;
        }
        ...
        if (singleSegmentBase2 != null) {
            rangedUri = singleSegmentBase2.f6112a;
        }
        do {
            xmlPullParser.next();
    ...
    public SegmentBase.SegmentList k0(XmlPullParser xmlPullParser, SegmentBase.SegmentList segmentList, long j2, long j3, long j4, long j5, long j6) throws XmlPullParserException, IOException {
        ...
        if (segmentList2 != null) {
            if (rangedUri == null) {
                rangedUri = segmentList2.f6112a;
            }
            if (list == null) {
                list = segmentList2.f6117f;
            }
            if (list2 == null) {
                list2 = segmentList2.f6121j;
            }
        }
    ...
    public SegmentBase.SegmentTemplate l0(XmlPullParser xmlPullParser, SegmentBase.SegmentTemplate segmentTemplate, List<Descriptor> list, long j2, long j3, long j4, long j5, long j6) throws XmlPullParserException, IOException {
        ...
        if (segmentTemplate2 != null) {
            j7 = segmentTemplate2.f6113b;
        } else {
            j7 = 1;
        }
        long X = X(xmlPullParser2, "timescale", j7);
        if (segmentTemplate2 != null) {
            j8 = segmentTemplate2.f6114c;
        } else {
            j8 = 0;
        }
        long X2 = X(xmlPullParser2, "presentationTimeOffset", j8);
        if (segmentTemplate2 != null) {
            j9 = segmentTemplate2.f6116e;
        } else {
            j9 = -9223372036854775807L;
        }
        long X3 = X(xmlPullParser2, "duration", j9);
        if (segmentTemplate2 != null) {
            j10 = segmentTemplate2.f6115d;
        }
        long X4 = X(xmlPullParser2, "startNumber", j10);
        long W = W(list);
        long t2 = t(j4, j5);
        ...
        if (segmentTemplate2 != null) {
            urlTemplate = segmentTemplate2.f6123k;
        } else {
            urlTemplate = null;
        }
        UrlTemplate v02 = v0(xmlPullParser2, "media", urlTemplate);
        if (segmentTemplate2 != null) {
            urlTemplate2 = segmentTemplate2.f6122j;
        } else {
            urlTemplate2 = null;
        }
        ...
        if (segmentTemplate2 != null) {
            if (rangedUri == null) {
                rangedUri = segmentTemplate2.f6112a;
            }
            if (list2 == null) {
                list2 = segmentTemplate2.f6117f;
            }
        }
    ...
    public List<SegmentBase.SegmentTimelineElement> m0(XmlPullParser xmlPullParser, long j2, long j3) throws XmlPullParserException, IOException {
        ...
        if (z2) {
            b(arrayList, j4, j5, i2, Util.c1(j3, j2, 1000));
        }
        return arrayList;
    }
    ...
    public Pair<Integer, Integer> t0(List<Descriptor> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            Descriptor descriptor = list.get(i2);
            if ((Ascii.a("http://dashif.org/thumbnail_tile", descriptor.f6076a) || Ascii.a("http://dashif.org/guidelines/thumbnail_tile", descriptor.f6076a)) && (str = descriptor.f6077b) != null) {
    ...
    public DashManifest a(Uri uri, InputStream inputStream) throws IOException {
        try {
            XmlPullParser newPullParser = this.f6066a.newPullParser();
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public androidx.media3.exoplayer.dash.manifest.AdaptationSet y(org.xmlpull.v1.XmlPullParser r57, java.util.List<androidx.media3.exoplayer.dash.manifest.BaseUrl> r58, androidx.media3.exoplayer.dash.manifest.SegmentBase r59, long r60, long r62, long r64, long r66, long r68, boolean r70) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r56 = this;
            r15 = r56
            r14 = r57
        ...
        L_0x01c7:
            ...
            androidx.media3.common.Format r1 = r0.f6067a
            java.lang.String r1 = r1.f4015n
            int r1 = androidx.media3.common.MimeTypes.k(r1)
            r14 = r44
            int r1 = p(r14, r1)
            r15 = r45
            r15.add(r0)
