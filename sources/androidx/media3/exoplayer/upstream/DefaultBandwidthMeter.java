...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> f7494p = ImmutableList.v(4300000L, 3200000L, 2400000L, 1700000L, 860000L);

    /* renamed from: q  reason: collision with root package name */
    public static final ImmutableList<Long> f7495q = ImmutableList.v(1500000L, 980000L, 750000L, 520000L, 290000L);

    /* renamed from: r  reason: collision with root package name */
    public static final ImmutableList<Long> f7496r = ImmutableList.v(2000000L, 1300000L, 1000000L, 860000L, 610000L);

    /* renamed from: s  reason: collision with root package name */
    public static final ImmutableList<Long> f7497s = ImmutableList.v(2500000L, 1700000L, 1200000L, 970000L, 680000L);

    /* renamed from: t  reason: collision with root package name */
    public static final ImmutableList<Long> f7498t = ImmutableList.v(4700000L, 2800000L, 2100000L, 1700000L, 980000L);

    /* renamed from: u  reason: collision with root package name */
    public static final ImmutableList<Long> f7499u = ImmutableList.v(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);

    /* renamed from: v  reason: collision with root package name */
    private static DefaultBandwidthMeter f7500v;

    /* renamed from: a  reason: collision with root package name */
    private final ImmutableMap<Integer, Long> f7501a;

    /* renamed from: b  reason: collision with root package name */
    private final BandwidthMeter.EventListener.EventDispatcher f7502b;

    /* renamed from: c  reason: collision with root package name */
    private final Clock f7503c;

    /* renamed from: d  reason: collision with root package name */
    private final boolean f7504d;

    /* renamed from: e  reason: collision with root package name */
    private final SlidingPercentile f7505e;
    ...
    public static final class Builder {
        ...
        /* renamed from: b  reason: collision with root package name */
        private Map<Integer, Long> f7517b;

        /* renamed from: c  reason: collision with root package name */
        private int f7518c;

        /* renamed from: d  reason: collision with root package name */
        private Clock f7519d;
        ...
        public Builder(Context context) {
            ...
            this.f7516a = context2;
            this.f7517b = b(Util.R(context));
            this.f7518c = 2000;
            this.f7519d = Clock.f4616a;
            this.f7520e = true;
        }
        ...
        private static Map<Integer, Long> b(String str) {
            ...
            ImmutableList<Long> immutableList = DefaultBandwidthMeter.f7494p;
            hashMap.put(2, immutableList.get(k2[0]));
            hashMap.put(3, DefaultBandwidthMeter.f7495q.get(k2[1]));
            hashMap.put(4, DefaultBandwidthMeter.f7496r.get(k2[2]));
            hashMap.put(5, DefaultBandwidthMeter.f7497s.get(k2[3]));
            hashMap.put(10, DefaultBandwidthMeter.f7498t.get(k2[4]));
            hashMap.put(9, DefaultBandwidthMeter.f7499u.get(k2[5]));
            hashMap.put(7, immutableList.get(k2[0]));
            return hashMap;
        }

        public DefaultBandwidthMeter a() {
            return new DefaultBandwidthMeter(this.f7516a, this.f7517b, this.f7518c, this.f7519d, this.f7520e);
        }
    }
    ...
    private long m(int i2) {
        Long l2 = this.f7501a.get(Integer.valueOf(i2));
        if (l2 == null) {
            l2 = this.f7501a.get(0);
        }
        if (l2 == null) {
            l2 = 1000000L;
        }
    ...
    public static synchronized DefaultBandwidthMeter n(Context context) {
        ...
        synchronized (DefaultBandwidthMeter.class) {
            if (f7500v == null) {
                f7500v = new Builder(context).a();
            }
            defaultBandwidthMeter = f7500v;
        }
    ...
    private void p(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.f7512l) {
            this.f7512l = j3;
            this.f7502b.c(i2, j2, j3);
        }
    }
    ...
    public synchronized void q(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f7513m     // Catch:{ all -> 0x0055 }
            if (r0 == 0) goto L_0x000b
            boolean r1 = r8.f7504d     // Catch:{ all -> 0x0055 }
            if (r1 != 0) goto L_0x000b
            monitor-exit(r8)
            return
        L_0x000b:
            boolean r1 = r8.f7514n     // Catch:{ all -> 0x0055 }
            if (r1 == 0) goto L_0x0011
            int r9 = r8.f7515o     // Catch:{ all -> 0x0055 }
        L_0x0011:
            if (r0 != r9) goto L_0x0015
            monitor-exit(r8)
            return
        L_0x0015:
            r8.f7513m = r9     // Catch:{ all -> 0x0055 }
            r0 = 1
        ...
        L_0x0021:
            ...
            r8.f7511k = r0     // Catch:{ all -> 0x0055 }
            androidx.media3.common.util.Clock r9 = r8.f7503c     // Catch:{ all -> 0x0055 }
            long r0 = r9.elapsedRealtime()     // Catch:{ all -> 0x0055 }
            int r9 = r8.f7506f     // Catch:{ all -> 0x0055 }
            if (r9 <= 0) goto L_0x0038
            long r2 = r8.f7507g     // Catch:{ all -> 0x0055 }
            long r2 = r0 - r2
        ...
        L_0x0038:
            ...
            r3 = 0
        L_0x003a:
            long r4 = r8.f7508h     // Catch:{ all -> 0x0055 }
            long r6 = r8.f7511k     // Catch:{ all -> 0x0055 }
            r2 = r8
            r2.p(r3, r4, r6)     // Catch:{ all -> 0x0055 }
            r8.f7507g = r0     // Catch:{ all -> 0x0055 }
            r0 = 0
            r8.f7508h = r0     // Catch:{ all -> 0x0055 }
            r8.f7510j = r0     // Catch:{ all -> 0x0055 }
            r8.f7509i = r0     // Catch:{ all -> 0x0055 }
            androidx.media3.exoplayer.upstream.SlidingPercentile r9 = r8.f7505e     // Catch:{ all -> 0x0055 }
        ...
        L_0x0055:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media3.exoplayer.upstream.DefaultBandwidthMeter.q(int):void");
    }
    ...
    public synchronized void g(DataSource dataSource, DataSpec dataSpec, boolean z2) {
        if (o(dataSpec, z2)) {
            if (this.f7506f == 0) {
                this.f7507g = this.f7503c.elapsedRealtime();
            }
            this.f7506f++;
        }
    }
    ...
    public synchronized void h(DataSource dataSource, DataSpec dataSpec, boolean z2) {
        ...
        if (o(dataSpec, z2)) {
            ...
            Assertions.h(z3);
            long elapsedRealtime = this.f7503c.elapsedRealtime();
            int i2 = (int) (elapsedRealtime - this.f7507g);
            this.f7509i += (long) i2;
            long j2 = this.f7510j;
            long j3 = this.f7508h;
            this.f7510j = j2 + j3;
            if (i2 > 0) {
                this.f7505e.c((int) Math.sqrt((double) j3), (((float) j3) * 8000.0f) / ((float) i2));
                if (this.f7509i >= 2000 || this.f7510j >= PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED) {
                    this.f7511k = (long) this.f7505e.f(0.5f);
                }
                p(i2, this.f7508h, this.f7511k);
                this.f7507g = elapsedRealtime;
                this.f7508h = 0;
            }
            this.f7506f--;
        }
    ...
    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int i2, Clock clock, boolean z2) {
        this.f7501a = ImmutableMap.d(map);
        this.f7502b = new BandwidthMeter.EventListener.EventDispatcher();
        this.f7505e = new SlidingPercentile(i2);
        this.f7503c = clock;
        this.f7504d = z2;
        if (context != null) {
