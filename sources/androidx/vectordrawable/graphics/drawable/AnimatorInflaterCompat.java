...
public class AnimatorInflaterCompat {
    ...
    private static class PathDataEvaluator implements TypeEvaluator<PathParser.PathDataNode[]> {
        ...
        private PathParser.PathDataNode[] f11854a;
        ...
        public PathParser.PathDataNode[] evaluate(float f2, PathParser.PathDataNode[] pathDataNodeArr, PathParser.PathDataNode[] pathDataNodeArr2) {
            if (PathParser.b(pathDataNodeArr, pathDataNodeArr2)) {
                if (!PathParser.b(this.f11854a, pathDataNodeArr)) {
                    this.f11854a = PathParser.f(pathDataNodeArr);
                }
                for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                    this.f11854a[i2].d(pathDataNodeArr[i2], pathDataNodeArr2[i2], f2);
                }
                return this.f11854a;
            }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.AndroidResources.f11836h
            r7 = r22
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x0054:
            ...
            boolean r3 = androidx.core.graphics.PathParser.b(r13, r14)
        ...
        L_0x0167:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        boolean z2;
        TypedArray s2 = TypedArrayUtils.s(resources, theme, attributeSet, AndroidResources.f11838j);
        int i2 = 0;
        TypedValue t2 = TypedArrayUtils.t(s2, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0);
        if (t2 != null) {
            z2 = true;
        } else {
            z2 = false;
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray s2 = TypedArrayUtils.s(resources, theme, attributeSet, AndroidResources.f11835g);
        TypedArray s3 = TypedArrayUtils.s(resources, theme, attributeSet, AndroidResources.f11839k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, s2, s3, f2, xmlPullParser);
        int l2 = TypedArrayUtils.l(s2, xmlPullParser, "interpolator", 0, 0);
        if (l2 > 0) {
            valueAnimator.setInterpolator(AnimationUtilsCompat.a(context, l2));
        }
        s2.recycle();
        if (s3 != null) {
            s3.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i2, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        Keyframe keyframe;
        TypedArray s2 = TypedArrayUtils.s(resources, theme, attributeSet, AndroidResources.f11838j);
        float j2 = TypedArrayUtils.j(s2, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue t2 = TypedArrayUtils.t(s2, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0);
        if (t2 != null) {
            z2 = true;
        } else {
        ...
        if (z2) {
            if (i2 == 0) {
                keyframe = Keyframe.ofFloat(j2, TypedArrayUtils.j(s2, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0, 0.0f));
            } else if (i2 == 1 || i2 == 3) {
                keyframe = Keyframe.ofInt(j2, TypedArrayUtils.k(s2, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i2 == 0) {
            keyframe = Keyframe.ofFloat(j2);
        } else {
            keyframe = Keyframe.ofInt(j2);
        }
        int l2 = TypedArrayUtils.l(s2, xmlPullParser, "interpolator", 1, 0);
        if (l2 > 0) {
            keyframe.setInterpolator(AnimationUtilsCompat.a(context, l2));
        }
        s2.recycle();
        return keyframe;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r0 = 0
            r1 = r0
        L_0x0002:
        ...
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.o(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }

    /* JADX WARNING: Removed duplicated region for block: B:21:0x006f  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r6 = r20
            r7 = 0
            r8 = r7
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.AndroidResources.f11837i
            r11 = r18
            r12 = r19
            r13 = r21
        ...
        L_0x0082:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat.p(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long k2 = (long) TypedArrayUtils.k(typedArray, xmlPullParser, "duration", 1, 300);
        ...
        if (TypedArrayUtils.r(xmlPullParser, "valueFrom") && TypedArrayUtils.r(xmlPullParser, "valueTo")) {
            ...
            PropertyValuesHolder e2 = e(typedArray, k4, 5, 6, "");
            if (e2 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f2, XmlPullParser xmlPullParser) {
        ...
        if (m2 != null) {
            ...
            s(PathParser.e(m2), objectAnimator, f2 * 0.5f, m3, m4);
            return;
        }
