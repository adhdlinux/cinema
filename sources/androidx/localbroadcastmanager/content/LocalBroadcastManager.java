...
public final class LocalBroadcastManager {
    ...
    private static final Object f3819f = new Object();

    /* renamed from: g  reason: collision with root package name */
    private static LocalBroadcastManager f3820g;

    /* renamed from: a  reason: collision with root package name */
    private final Context f3821a;

    /* renamed from: b  reason: collision with root package name */
    private final HashMap<BroadcastReceiver, ArrayList<ReceiverRecord>> f3822b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private final HashMap<String, ArrayList<ReceiverRecord>> f3823c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private final ArrayList<BroadcastRecord> f3824d = new ArrayList<>();
    ...
    private static final class BroadcastRecord {
        ...
        /* renamed from: b  reason: collision with root package name */
        final ArrayList<ReceiverRecord> f3828b;
    ...
    private static final class ReceiverRecord {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f3829a;

        /* renamed from: b  reason: collision with root package name */
        final BroadcastReceiver f3830b;
        ...
        ReceiverRecord(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f3829a = intentFilter;
            this.f3830b = broadcastReceiver;
        }
    ...
    private LocalBroadcastManager(Context context) {
        this.f3821a = context;
        this.f3825e = new Handler(context.getMainLooper()) {
    ...
    public static LocalBroadcastManager b(Context context) {
        ...
        synchronized (f3819f) {
            if (f3820g == null) {
                f3820g = new LocalBroadcastManager(context.getApplicationContext());
            }
            localBroadcastManager = f3820g;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0033, code lost:
        if (r7.f3832d != false) goto L_0x003e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0035, code lost:
        r7.f3830b.onReceive(r10.f3821a, r4.f3827a);
     */
    ...
    public void a() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r0 = r10.f3822b
            monitor-enter(r0)
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r1 = r10.f3824d     // Catch:{ all -> 0x0044 }
        ...
        L_0x000d:
            ...
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r10.f3824d     // Catch:{ all -> 0x0044 }
        ...
        L_0x001c:
            if (r3 >= r1) goto L_0x0000
            r4 = r2[r3]
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord> r5 = r4.f3828b
            int r5 = r5.size()
            r6 = 0
        L_0x0027:
            if (r6 >= r5) goto L_0x0041
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord> r7 = r4.f3828b
            ...
            boolean r8 = r7.f3832d
            if (r8 != 0) goto L_0x003e
            android.content.BroadcastReceiver r7 = r7.f3830b
            android.content.Context r8 = r10.f3821a
            android.content.Intent r9 = r4.f3827a
            r7.onReceive(r8, r9)
        L_0x003e:
            int r6 = r6 + 1
            goto L_0x0027
    ...
    public void c(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f3822b) {
            ...
            ArrayList arrayList = this.f3822b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f3822b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(receiverRecord);
            for (int i2 = 0; i2 < intentFilter.countActions(); i2++) {
                String action = intentFilter.getAction(i2);
                ArrayList arrayList2 = this.f3823c.get(action);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList(1);
                    this.f3823c.put(action, arrayList2);
                }
    ...
    public boolean d(android.content.Intent r22) {
        /*
            ...
            r1 = r21
            r0 = r22
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r2 = r1.f3822b
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0175 }
            android.content.Context r3 = r1.f3821a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.f3823c     // Catch:{ all -> 0x0175 }
        ...
        L_0x0080:
            ...
            android.content.IntentFilter r9 = r5.f3829a     // Catch:{ all -> 0x0175 }
            r4.append(r9)     // Catch:{ all -> 0x0175 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0175 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0175 }
        L_0x00a7:
            boolean r3 = r5.f3831c     // Catch:{ all -> 0x0175 }
        ...
        L_0x00b4:
            ...
            goto L_0x0137
        L_0x00c0:
            android.content.IntentFilter r3 = r5.f3829a     // Catch:{ all -> 0x0175 }
        ...
        L_0x00ff:
            ...
            r15.f3831c = r11     // Catch:{ all -> 0x0175 }
            goto L_0x0138
        L_0x0105:
        ...
        L_0x0147:
            ...
            r5 = 0
            r4.f3831c = r5     // Catch:{ all -> 0x0175 }
            int r3 = r3 + 1
            goto L_0x0147
        L_0x0159:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.f3824d     // Catch:{ all -> 0x0175 }
            ...
            android.os.Handler r0 = r1.f3825e     // Catch:{ all -> 0x0175 }
    ...
    public void e(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f3822b) {
            ArrayList remove = this.f3822b.remove(broadcastReceiver);
            if (remove != null) {
                for (int size = remove.size() - 1; size >= 0; size--) {
                    ReceiverRecord receiverRecord = (ReceiverRecord) remove.get(size);
                    receiverRecord.f3832d = true;
                    for (int i2 = 0; i2 < receiverRecord.f3829a.countActions(); i2++) {
                        String action = receiverRecord.f3829a.getAction(i2);
                        ArrayList arrayList = this.f3823c.get(action);
                        if (arrayList != null) {
                            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                                ReceiverRecord receiverRecord2 = (ReceiverRecord) arrayList.get(size2);
                                if (receiverRecord2.f3830b == broadcastReceiver) {
                                    receiverRecord2.f3832d = true;
                                    arrayList.remove(size2);
                                }
                            }
                            if (arrayList.size() <= 0) {
                                this.f3823c.remove(action);
                            }
                        }
                    }
                }
