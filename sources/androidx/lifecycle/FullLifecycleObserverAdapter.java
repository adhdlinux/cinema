...
class FullLifecycleObserverAdapter implements LifecycleEventObserver {
    ...
    private final FullLifecycleObserver f3657b;

    /* renamed from: c  reason: collision with root package name */
    private final LifecycleEventObserver f3658c;
    ...
    FullLifecycleObserverAdapter(FullLifecycleObserver fullLifecycleObserver, LifecycleEventObserver lifecycleEventObserver) {
        this.f3657b = fullLifecycleObserver;
        this.f3658c = lifecycleEventObserver;
    }

    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        switch (AnonymousClass1.f3659a[event.ordinal()]) {
            case 1:
                this.f3657b.a(lifecycleOwner);
                break;
            case 2:
                this.f3657b.f(lifecycleOwner);
                break;
            case 3:
                this.f3657b.b(lifecycleOwner);
                break;
            case 4:
                this.f3657b.c(lifecycleOwner);
                break;
            case 5:
                this.f3657b.d(lifecycleOwner);
                break;
            case 6:
                this.f3657b.e(lifecycleOwner);
                break;
            case 7:
                throw new IllegalArgumentException("ON_ANY must not been send by anybody");
        }
        LifecycleEventObserver lifecycleEventObserver = this.f3658c;
