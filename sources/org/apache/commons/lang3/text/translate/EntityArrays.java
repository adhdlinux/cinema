...
public class EntityArrays {
    ...
    private static final String[][] f41442a;

    /* renamed from: b  reason: collision with root package name */
    private static final String[][] f41443b;

    /* renamed from: c  reason: collision with root package name */
    private static final String[][] f41444c;

    /* renamed from: d  reason: collision with root package name */
    private static final String[][] f41445d;

    /* renamed from: e  reason: collision with root package name */
    private static final String[][] f41446e;

    /* renamed from: f  reason: collision with root package name */
    private static final String[][] f41447f;

    /* renamed from: g  reason: collision with root package name */
    private static final String[][] f41448g;

    /* renamed from: h  reason: collision with root package name */
    private static final String[][] f41449h;

    /* renamed from: i  reason: collision with root package name */
    private static final String[][] f41450i;

    /* renamed from: j  reason: collision with root package name */
    private static final String[][] f41451j;
    ...
    static {
        ...
        f41448g = strArr4;
        f41449h = k(strArr4);
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{"\r", "\\r"}};
        f41450i = strArr5;
        f41451j = k(strArr5);
    }

    public static String[][] a() {
        return (String[][]) f41448g.clone();
    }

    public static String[][] b() {
        return (String[][]) f41449h.clone();
    }

    public static String[][] c() {
        return (String[][]) f41446e.clone();
    }

    public static String[][] d() {
        return (String[][]) f41447f.clone();
    }

    public static String[][] e() {
        return (String[][]) f41444c.clone();
    }

    public static String[][] f() {
        return (String[][]) f41445d.clone();
    }

    public static String[][] g() {
        return (String[][]) f41442a.clone();
    }

    public static String[][] h() {
        return (String[][]) f41443b.clone();
    }

    public static String[][] i() {
        return (String[][]) f41450i.clone();
    }

    public static String[][] j() {
        return (String[][]) f41451j.clone();
    }
