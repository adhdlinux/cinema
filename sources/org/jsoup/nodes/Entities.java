...
public class Entities {
    ...
    private static final char[] f41581a = {',', ';'};

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap<String, String> f41582b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private static final Document.OutputSettings f41583c = new Document.OutputSettings();
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f41584a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public enum EscapeMode {
        ...
        public int i(String str) {
            int binarySearch = Arrays.binarySearch(this.f41593b, str);
            if (binarySearch >= 0) {
                return this.f41594c[binarySearch];
            }
            return -1;
        }
        ...
        public String j(int i2) {
            int binarySearch = Arrays.binarySearch(this.f41595d, i2);
            if (binarySearch < 0) {
                return "";
            }
            String[] strArr = this.f41596e;
            if (binarySearch < strArr.length - 1) {
                int i3 = binarySearch + 1;
                if (this.f41595d[i3] == i2) {
                    return strArr[i3];
                }
            }
    ...
    private static boolean c(CoreCharset coreCharset, char c2, CharsetEncoder charsetEncoder) {
        int i2 = AnonymousClass1.f41584a[coreCharset.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
    ...
    static void e(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z2, boolean z3, boolean z4) throws IOException {
        EscapeMode e2 = outputSettings.e();
        CharsetEncoder charsetEncoder = outputSettings.f41558d;
        if (charsetEncoder == null) {
            charsetEncoder = outputSettings.h();
        }
        CoreCharset coreCharset = outputSettings.f41559e;
            ...
            if (codePointAt < 65536) {
                ...
                if (c2 != '\"') {
                    if (c2 == '&') {
                        ...
                        if (c2 != '>') {
                            if (c2 != 160) {
                                if (c(coreCharset, c2, charsetEncoder)) {
                    ...
                    } else if (!z2 || e2 == EscapeMode.xhtml) {
                        appendable.append("&lt;");
                    } else {
                        appendable.append(c2);
                    }
    ...
    public static boolean f(String str) {
        return EscapeMode.f41590g.i(str) != -1;
    }
    ...
    public static void h(EscapeMode escapeMode, String str, int i2) {
        int i3;
        String[] unused = escapeMode.f41593b = new String[i2];
        int[] unused2 = escapeMode.f41594c = new int[i2];
        int[] unused3 = escapeMode.f41595d = new int[i2];
        String[] unused4 = escapeMode.f41596e = new String[i2];
        ...
        while (!characterReader.r()) {
            ...
            characterReader.a();
            int parseInt = Integer.parseInt(characterReader.m(f41581a), 36);
            char q2 = characterReader.q();
            characterReader.a();
            if (q2 == ',') {
                i3 = Integer.parseInt(characterReader.k(';'), 36);
                characterReader.a();
            } else {
                i3 = -1;
            }
            int parseInt2 = Integer.parseInt(characterReader.k('&'), 36);
            characterReader.a();
            escapeMode.f41593b[i4] = k2;
            escapeMode.f41594c[i4] = parseInt;
            escapeMode.f41595d[parseInt2] = parseInt;
            escapeMode.f41596e[parseInt2] = k2;
            if (i3 != -1) {
                f41582b.put(k2, new String(new int[]{parseInt, i3}, 0, 2));
            }
            i4++;
        }
        if (i4 == i2) {
        ...
        Validate.e(z2, "Unexpected count of entities loaded");
    }
}
