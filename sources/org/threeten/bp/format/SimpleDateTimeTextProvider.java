...
final class SimpleDateTimeTextProvider extends DateTimeTextProvider {
    ...
    static final class LocaleStore {
        ...
        public String getText(long j2, TextStyle textStyle) {
    ...
    private String narrowDayOfWeek(int i2, String str, Locale locale) {
    ...
    private String narrowMonth(int i2, String str, Locale locale) {
        if (locale.getLanguage().equals("zh") && locale.getCountry().equals("CN")) {
            switch (i2) {
                case 1:
                    return "一";
    ...
    public String getText(TemporalField temporalField, long j2, TextStyle textStyle, Locale locale) {
        ...
        if (findStore instanceof LocaleStore) {
            return ((LocaleStore) findStore).getText(j2, textStyle);
        }
        return null;
    }
