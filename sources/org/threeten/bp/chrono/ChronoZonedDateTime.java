...
public abstract class ChronoZonedDateTime<D extends ChronoLocalDate> extends DefaultInterfaceTemporal implements Comparable<ChronoZonedDateTime<?>> {
    ...
    public boolean isAfter(ChronoZonedDateTime<?> chronoZonedDateTime) {
        int i2 = (toEpochSecond() > chronoZonedDateTime.toEpochSecond() ? 1 : (toEpochSecond() == chronoZonedDateTime.toEpochSecond() ? 0 : -1));
        if (i2 > 0 || (i2 == 0 && toLocalTime().getNano() > chronoZonedDateTime.toLocalTime().getNano())) {
            return true;
        }
        return false;
    }
    ...
    public abstract ChronoZonedDateTime<D> plus(long j2, TemporalUnit temporalUnit);
    ...
    public abstract ChronoZonedDateTime<D> with(TemporalField temporalField, long j2);
    ...
    public ChronoZonedDateTime<D> minus(long j2, TemporalUnit temporalUnit) {
        return toLocalDate().getChronology().ensureChronoZonedDateTime(super.minus(j2, temporalUnit));
    }
}
