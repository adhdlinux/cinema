...
public abstract class ChronoLocalDateTime<D extends ChronoLocalDate> extends DefaultInterfaceTemporal implements TemporalAdjuster, Comparable<ChronoLocalDateTime<?>> {
    ...
    public abstract ChronoLocalDateTime<D> plus(long j2, TemporalUnit temporalUnit);
    ...
    public abstract ChronoLocalDateTime<D> with(TemporalField temporalField, long j2);
    ...
    public ChronoLocalDateTime<D> minus(long j2, TemporalUnit temporalUnit) {
        return toLocalDate().getChronology().ensureChronoLocalDateTime(super.minus(j2, temporalUnit));
    }
}
