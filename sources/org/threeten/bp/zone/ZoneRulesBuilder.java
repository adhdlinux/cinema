...
class ZoneRulesBuilder {
    ...
    class TZRule implements Comparable<TZRule> {
        ...
        TZRule(int i2, Month month2, int i3, DayOfWeek dayOfWeek2, LocalTime localTime, int i4, ZoneOffsetTransitionRule.TimeDefinition timeDefinition2, int i5) {
            this.year = i2;
            this.month = month2;
        ...
        private LocalDate toLocalDate() {
            ...
            if (dayOfWeek3 != null) {
                return of2.with(TemporalAdjusters.nextOrSame(dayOfWeek3));
            }
            return of2;
        }

        /* access modifiers changed from: package-private */
        public ZoneOffsetTransition toTransition(ZoneOffset zoneOffset, int i2) {
        ...
        /* access modifiers changed from: package-private */
        public ZoneOffsetTransitionRule toTransitionRule(ZoneOffset zoneOffset, int i2) {
            Month month2;
    ...
    class TZWindow {
        ...
        /* access modifiers changed from: package-private */
        public void addRule(int i2, int i3, Month month, int i4, DayOfWeek dayOfWeek, LocalTime localTime, int i5, ZoneOffsetTransitionRule.TimeDefinition timeDefinition2, int i6) {
            boolean z2;
            if (this.fixedSavingAmountSecs != null) {
                ...
                for (int i8 = i2; i8 <= i7; i8++) {
                    TZRule tZRule = new TZRule(i8, month, i4, dayOfWeek, localTime, i5, timeDefinition2, i6);
                    if (z2) {
        ...
        /* access modifiers changed from: package-private */
        public long createDateTimeEpochSecond(int i2) {
        ...
        /* access modifiers changed from: package-private */
        public ZoneOffset createWallOffset(int i2) {
            return ZoneOffset.ofTotalSeconds(this.standardOffset.getTotalSeconds() + i2);
        }

        /* access modifiers changed from: package-private */
        public boolean isSingleWindowStandardOffset() {
            if (!this.windowEnd.equals(LocalDateTime.MAX) || this.timeDefinition != ZoneOffsetTransitionRule.TimeDefinition.WALL || this.fixedSavingAmountSecs != null || !this.lastRuleList.isEmpty() || !this.ruleList.isEmpty()) {
                return false;
            }
            return true;
        }
        ...
        /* access modifiers changed from: package-private */
        public void setFixedSavings(int i2) {
    ...
    public ZoneRulesBuilder setFixedSavingsToWindow(int i2) {
        if (!this.windowList.isEmpty()) {
            List<TZWindow> list = this.windowList;
            list.get(list.size() - 1).setFixedSavings(i2);
            return this;
        }
    ...
    public ZoneRulesBuilder addRuleToWindow(int i2, int i3, Month month, int i4, DayOfWeek dayOfWeek, LocalTime localTime, boolean z2, ZoneOffsetTransitionRule.TimeDefinition timeDefinition, int i5) {
        ...
        chronoField.checkValidValue((long) i2);
        chronoField.checkValidValue((long) i3);
        if (i6 < -28 || i6 > 31 || i6 == 0) {
            throw new IllegalArgumentException("Day of month indicator must be between -28 and 31 inclusive excluding zero");
        } else if (z2 && !localTime2.equals(LocalTime.MIDNIGHT)) {
            throw new IllegalArgumentException("Time must be midnight when end of day flag is true");
        } else if (!this.windowList.isEmpty()) {
            List<TZWindow> list = this.windowList;
            list.get(list.size() - 1).addRule(i2, i3, month, i4, dayOfWeek, localTime, z2 ? 1 : 0, timeDefinition, i5);
            return this;
        } else {
    ...
    /* access modifiers changed from: package-private */
    public ZoneRulesBuilder addRuleToWindow(int i2, int i3, Month month, int i4, DayOfWeek dayOfWeek, LocalTime localTime, int i5, ZoneOffsetTransitionRule.TimeDefinition timeDefinition, int i6) {
        int i7 = i4;
        Month month2 = month;
        Jdk8Methods.requireNonNull(month, "month");
        Jdk8Methods.requireNonNull(timeDefinition, "timeDefinition");
        ...
        if (i7 < -28 || i7 > 31 || i7 == 0) {
            ...
            List<TZWindow> list = this.windowList;
            list.get(list.size() - 1).addRule(i2, i3, month, i4, dayOfWeek, localTime, i5, timeDefinition, i6);
            return this;
        } else {
            throw new IllegalStateException("Must add a window before adding a rule");
        }
