...
public final class YearMonth extends BasePartial {
    ...
    public YearMonth withField(DateTimeFieldType dateTimeFieldType, int i2) {
        ...
        return new YearMonth(this, getField(indexOfSupported).set(this, indexOfSupported, getValues(), i2));
    }
    ...
    public YearMonth withFieldAdded(DurationFieldType durationFieldType, int i2) {
        ...
        return new YearMonth(this, getField(indexOfSupported).add(this, indexOfSupported, getValues(), i2));
    }
