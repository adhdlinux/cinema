...
public final class DateTime extends BaseDateTime {
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public DateTime withMaximumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e2)) {
                    return new DateTime(getChronology().getZone().previousTransition(getMillis() + SignalManager.TWENTY_FOUR_HOURS_MILLIS), getChronology());
                }
                throw e2;
            }
        }
        ...
        public DateTime withMinimumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e2)) {
                    return new DateTime(getChronology().getZone().nextTransition(getMillis() - SignalManager.TWENTY_FOUR_HOURS_MILLIS), getChronology());
                }
                throw e2;
            }
        }
    ...
    public DateTime minusDays(int i2) {
        ...
        return withMillis(getChronology().days().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusHours(int i2) {
        ...
        return withMillis(getChronology().hours().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusMillis(int i2) {
        ...
        return withMillis(getChronology().millis().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusMinutes(int i2) {
        ...
        return withMillis(getChronology().minutes().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusMonths(int i2) {
        ...
        return withMillis(getChronology().months().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusSeconds(int i2) {
        ...
        return withMillis(getChronology().seconds().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusWeeks(int i2) {
        ...
        return withMillis(getChronology().weeks().subtract(getMillis(), i2));
    }
    ...
    public DateTime minusYears(int i2) {
        ...
        return withMillis(getChronology().years().subtract(getMillis(), i2));
    }
    ...
    public DateTime plusDays(int i2) {
        ...
        return withMillis(getChronology().days().add(getMillis(), i2));
    }
    ...
    public DateTime plusHours(int i2) {
        ...
        return withMillis(getChronology().hours().add(getMillis(), i2));
    }
    ...
    public DateTime plusMillis(int i2) {
        ...
        return withMillis(getChronology().millis().add(getMillis(), i2));
    }
    ...
    public DateTime plusMinutes(int i2) {
        ...
        return withMillis(getChronology().minutes().add(getMillis(), i2));
    }
    ...
    public DateTime plusMonths(int i2) {
        ...
        return withMillis(getChronology().months().add(getMillis(), i2));
    }
    ...
    public DateTime plusSeconds(int i2) {
        ...
        return withMillis(getChronology().seconds().add(getMillis(), i2));
    }
    ...
    public DateTime plusWeeks(int i2) {
        ...
        return withMillis(getChronology().weeks().add(getMillis(), i2));
    }
    ...
    public DateTime plusYears(int i2) {
        ...
        return withMillis(getChronology().years().add(getMillis(), i2));
    }
    ...
    public DateTime withFieldAdded(DurationFieldType durationFieldType, int i2) {
        if (durationFieldType == null) {
            ...
            return withMillis(durationFieldType.getField(getChronology()).add(getMillis(), i2));
        }
    }
    ...
    public DateTime withPeriodAdded(ReadablePeriod readablePeriod, int i2) {
        ...
        return withMillis(getChronology().add(readablePeriod, getMillis(), i2));
    }
