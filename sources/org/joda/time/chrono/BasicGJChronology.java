...
abstract class BasicGJChronology extends BasicChronology {
    ...
    static {
        ...
        int i2 = 0;
        while (i2 < 11) {
            j2 += ((long) MIN_DAYS_PER_MONTH_ARRAY[i2]) * SignalManager.TWENTY_FOUR_HOURS_MILLIS;
            int i3 = i2 + 1;
            MIN_TOTAL_MILLIS_BY_MONTH_ARRAY[i3] = j2;
            j3 += ((long) MAX_DAYS_PER_MONTH_ARRAY[i2]) * SignalManager.TWENTY_FOUR_HOURS_MILLIS;
    ...
    public int getDaysInYearMonth(int i2, int i3) {
        if (isLeapYear(i2)) {
            return MAX_DAYS_PER_MONTH_ARRAY[i3 - 1];
        }
        return MIN_DAYS_PER_MONTH_ARRAY[i3 - 1];
    }
    ...
    public long getTotalMillisByYearMonth(int i2, int i3) {
        if (isLeapYear(i2)) {
            return MAX_TOTAL_MILLIS_BY_MONTH_ARRAY[i3 - 1];
        }
        return MIN_TOTAL_MILLIS_BY_MONTH_ARRAY[i3 - 1];
    }
    ...
    public boolean isLeapDay(long j2) {
        return dayOfMonth().get(j2) == 29 && monthOfYear().isLeap(j2);
    }
