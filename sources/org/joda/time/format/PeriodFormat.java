...
public class PeriodFormat {
    ...
    static class DynamicWordBased implements PeriodPrinter, PeriodParser {
        ...
        public int countFieldsToPrint(ReadablePeriod readablePeriod, int i2, Locale locale) {
            return getPrinter(locale).countFieldsToPrint(readablePeriod, i2, locale);
        }

        public int parseInto(ReadWritablePeriod readWritablePeriod, String str, int i2, Locale locale) {
            return getParser(locale).parseInto(readWritablePeriod, str, i2, locale);
        }
    ...
    public static PeriodFormatter wordBased(Locale locale) {
        ...
        PeriodFormatter periodFormatter2 = new PeriodFormatter(dynamicWordBased, dynamicWordBased, locale, (PeriodType) null);
