...
public class ISODateTimeFormat {
    ...
    static final class Constants {
        ...
        public static final DateTimeFormatter f41485t = time();
        /* access modifiers changed from: private */
        ...
        private static DateTimeFormatter time() {
            DateTimeFormatter dateTimeFormatter = f41485t;
            if (dateTimeFormatter == null) {
    ...
    private static void time(DateTimeFormatterBuilder dateTimeFormatterBuilder, Collection<DateTimeFieldType> collection, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        if (remove || remove2 || remove3 || remove4) {
            ...
            if ((!remove || !remove2 || !remove3) && (!remove || remove3 || remove4)) {
                ...
                } else if ((remove || ((!remove2 || !remove3) && ((!remove2 || remove4) && !remove3))) && z3) {
                    throw new IllegalArgumentException("No valid ISO8601 format for fields: " + collection);
                }
            }
            if (remove) {
