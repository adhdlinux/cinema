...
public abstract class DateTimeFieldType implements Serializable {
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType ERA_TYPE = new StandardDateTimeFieldType("era", ERA, DurationFieldType.eras(), (DurationFieldType) null);
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType WEEKYEAR_OF_CENTURY_TYPE = new StandardDateTimeFieldType("weekyearOfCentury", WEEKYEAR_OF_CENTURY, DurationFieldType.weekyears(), DurationFieldType.centuries());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType WEEKYEAR_TYPE = new StandardDateTimeFieldType("weekyear", WEEKYEAR, DurationFieldType.weekyears(), (DurationFieldType) null);
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType YEAR_OF_ERA_TYPE = new StandardDateTimeFieldType("yearOfEra", YEAR_OF_ERA, DurationFieldType.years(), DurationFieldType.eras());
    /* access modifiers changed from: private */
    public static final DateTimeFieldType YEAR_TYPE = new StandardDateTimeFieldType("year", YEAR, DurationFieldType.years(), (DurationFieldType) null);
