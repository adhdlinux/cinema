...
public final class MonthDay extends BasePartial {
    ...
    public MonthDay withField(DateTimeFieldType dateTimeFieldType, int i2) {
        ...
        return new MonthDay(this, getField(indexOfSupported).set(this, indexOfSupported, getValues(), i2));
    }
    ...
    public MonthDay withFieldAdded(DurationFieldType durationFieldType, int i2) {
        ...
        return new MonthDay(this, getField(indexOfSupported).add(this, indexOfSupported, getValues(), i2));
    }
