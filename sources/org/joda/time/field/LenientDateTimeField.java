...
public class LenientDateTimeField extends DelegatedDateTimeField {
    ...
    public long set(long j2, int i2) {
        return this.iBase.getZone().convertLocalToUTC(getType().getField(this.iBase.withUTC()).add(this.iBase.getZone().convertUTCToLocal(j2), FieldUtils.safeSubtract((long) i2, (long) get(j2))), false, j2);
    }
}
