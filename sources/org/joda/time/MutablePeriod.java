...
public class MutablePeriod extends BasePeriod implements ReadWritablePeriod, Cloneable {
    ...
    public void add(long j2) {
        add((ReadablePeriod) new Period(j2, getPeriodType()));
    }
    ...
    public void add(long j2, Chronology chronology) {
        add((ReadablePeriod) new Period(j2, getPeriodType(), chronology));
    }
    ...
    public void setPeriod(long j2, long j3) {
        setPeriod(j2, j3, (Chronology) null);
    }
    ...
    public void setPeriod(long j2, Chronology chronology) {
        setValues(DateTimeUtils.getChronology(chronology).get((ReadablePeriod) this, j2));
    }
