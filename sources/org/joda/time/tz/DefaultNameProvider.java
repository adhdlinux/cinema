...
public class DefaultNameProvider implements NameProvider {
    ...
    public String getName(Locale locale, String str, String str2, boolean z2) {
        String[] nameSet = getNameSet(locale, str, str2, z2);
        if (nameSet == null) {
            return null;
        }
        return nameSet[1];
    ...
    public String getShortName(Locale locale, String str, String str2, boolean z2) {
        String[] nameSet = getNameSet(locale, str, str2, z2);
        if (nameSet == null) {
            return null;
        }
